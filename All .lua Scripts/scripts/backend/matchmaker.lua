...
function Matchmaker:_get_xbox_live_sandbox_id()
...
function Matchmaker:_get_common_queue_ticket_data(matchmaker_type, alias_type, dedicated_alias_parameter)
...
function Matchmaker:fetch_queue_ticket_hub()
...
function Matchmaker:fetch_queue_ticket_mission(mission_id, character_id, private_session)
	local type = "mission"
...
function Matchmaker:fetch_queue_ticket_mission_hotjoin(matched_game_session_id, character_id)
...
function Matchmaker:fetch_queue_ticket_single_player(mission_id, character_id)
...
function Matchmaker:start(queue_tickets)
	local data = {
