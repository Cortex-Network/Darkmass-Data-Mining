...
function BotSynchronizerHost:init(network_delegate)
...
function BotSynchronizerHost:destroy()
...
function BotSynchronizerHost:update()
...
function BotSynchronizerHost:add_bot(local_player_id, player_profile)
...
function BotSynchronizerHost:active_bot_ids()
	return self._bots
end

function BotSynchronizerHost:remove_bot_safe(local_player_id)
	local player_manager = Managers.player
...
function BotSynchronizerHost:remove_bot(local_player_id)
	local player_manager = Managers.player
...
function BotSynchronizerHost:handle_queued_bot_removals()
...
function BotSynchronizerHost:spawn_group_contains(local_player_id)
...
function BotSynchronizerHost:num_bots()
	return table.size(self._bots)
end

function BotSynchronizerHost:add_peer(channel_id)
...
function BotSynchronizerHost:remove_peer(channel_id)
