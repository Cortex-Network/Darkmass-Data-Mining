...
function AmmoBelt:editor_init(unit)
...
function AmmoBelt:enable(unit)
	self:_update_ammo_representation(unit, false)
end

function AmmoBelt:disable(unit)
end

function AmmoBelt:destroy(unit)
end

function AmmoBelt:_update_ammo_representation(unit, is_animated)
...
function AmmoBelt:set_ammo(unit, ammo, max_ammo)
