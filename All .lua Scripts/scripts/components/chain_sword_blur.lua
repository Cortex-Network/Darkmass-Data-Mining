...
function ChainSwordBlur:init(unit)
	self:enable(unit)
...
function ChainSwordBlur:_set_speed(speed)
...
function ChainSwordBlur:_set_visibility(visibility)
...
function ChainSwordBlur:enable(unit)
end

function ChainSwordBlur:disable(unit)
end

function ChainSwordBlur:destroy(unit)
end

function ChainSwordBlur:update(unit, dt, t)
end

function ChainSwordBlur:changed(unit)
end

function ChainSwordBlur.events:set_speed(speed)
