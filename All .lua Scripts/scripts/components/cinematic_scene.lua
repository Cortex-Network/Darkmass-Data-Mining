...
function CinematicScene:init(unit)
	self:enable(unit)
...
function CinematicScene:enable(unit)
end

function CinematicScene:disable(unit)
end

function CinematicScene:destroy(unit)
end

function CinematicScene:editor_init(unit)
end

function CinematicScene:editor_destroy(unit)
end

function CinematicScene:unit_type()
	return self._unit_type
end

function CinematicScene:cinematic_category()
	return self._cinematic_category
end

function CinematicScene:cinematic_name()
	return self._cinematic_name
end

function CinematicScene:origin_level_name()
	if self._unit_type == "destination" and self._origin_level_name ~= "" then
...
function CinematicScene:play_cutscene()
