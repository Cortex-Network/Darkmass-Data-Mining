...
function component(component_name, super_name, ...)
	...
	if not component_table then
		...
		function component_table:new(guid, network_index, unit, is_server, ...)
			local object = {}
		...
		function component_table:delete(...)
			self:destroy(...)
		...
		function component_table:get_data(unit, ...)
