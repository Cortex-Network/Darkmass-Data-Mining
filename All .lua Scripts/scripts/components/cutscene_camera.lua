...
function CutsceneCamera:init(unit)
	self._data = {
...
function CutsceneCamera:editor_world_transform_modified(unit)
...
function CutsceneCamera:enable(unit)
end

function CutsceneCamera:disable(unit)
end

function CutsceneCamera:destroy(unit)
end

function CutsceneCamera:cinematic_category()
