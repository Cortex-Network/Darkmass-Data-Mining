...
function CutsceneCharacter:enable(unit)
end

function CutsceneCharacter:disable(unit)
end

function CutsceneCharacter:destroy(unit)
end

function CutsceneCharacter:cinematic_name()
	return self._cinematic_name
end

function CutsceneCharacter:character_type()
	return self._character_type
end

function CutsceneCharacter:breed_name()
	return self._breed_name
end

function CutsceneCharacter:start_weapon_specific_walk_animation()
...
function CutsceneCharacter:start_inventory_specific_walk_animation()
	local cutscene_character_extension = ScriptUnit.extension(self._unit, "cutscene_character_system")
