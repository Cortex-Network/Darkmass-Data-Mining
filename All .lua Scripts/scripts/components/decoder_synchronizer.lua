...
function DecoderSynchronizer:init(unit, is_server)
	self:enable(unit)
...
function DecoderSynchronizer:editor_init(unit)
end

function DecoderSynchronizer:editor_update(unit, dt, t)
end

function DecoderSynchronizer:enable(unit)
end

function DecoderSynchronizer:disable(unit)
end

function DecoderSynchronizer:destroy(unit)
end

function DecoderSynchronizer:start_decoding_event()
