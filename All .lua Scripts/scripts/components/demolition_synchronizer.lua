...
function DemolitionSynchronizer:init(unit, is_server)
	self._unit = unit
...
function DemolitionSynchronizer:start_demolition_event()
	if self._demolition_synchronizer_extension then
		self._demolition_synchronizer_extension:start_event()
	end
end

function DemolitionSynchronizer:editor_init(unit)
end

function DemolitionSynchronizer:enable(unit)
end

function DemolitionSynchronizer:disable(unit)
end

function DemolitionSynchronizer:destroy(unit)
end
