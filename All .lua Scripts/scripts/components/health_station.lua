...
function HealthStation:init(unit, is_server)
	self._unit = unit
...
function HealthStation:disable(unit)
end

function HealthStation:destroy(unit)
end

function HealthStation:spawn_battery(unit)
	if self._health_station_extension then
		self._health_station_extension:spawn_battery()
	end
end

function HealthStation:unspawn_battery(unit)
	if self._health_station_extension then
