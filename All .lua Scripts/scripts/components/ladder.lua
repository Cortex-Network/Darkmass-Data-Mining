...
function Ladder:enable(unit)
end

function Ladder:disable(unit)
end

function Ladder:editor_init(unit)
...
function Ladder:editor_update(unit)
	if not rawget(_G, "LevelEditor") then
		return
	end
...
function Ladder:_editor_debug_draw(unit)
...
function Ladder:editor_toggle_debug_draw(enable)
	if not rawget(_G, "LevelEditor") then
		return
	end
