...
function MissionObjectiveTarget:init(unit)
...
function MissionObjectiveTarget:_retrieve_objective_name(unit)
...
function MissionObjectiveTarget.events:interactable_enable()
...
function MissionObjectiveTarget.events:interactable_disable()
	local mission_objective_target_extension = self._mission_objective_target_extension
...
function MissionObjectiveTarget.events:interaction_success()
	local mission_objective_target_extension = self._mission_objective_target_extension
...
function MissionObjectiveTarget.events:destructible_enable()
	local mission_objective_target_extension = self._mission_objective_target_extension
...
function MissionObjectiveTarget.events:destructible_destroyed()
	local mission_objective_target_extension = self._mission_objective_target_extension
...
function MissionObjectiveTarget:editor_init(unit)
end

function MissionObjectiveTarget:editor_update(unit, dt)
end

function MissionObjectiveTarget:enable(unit)
end

function MissionObjectiveTarget:disable(unit)
end

function MissionObjectiveTarget:destroy(unit)
end

function MissionObjectiveTarget:objective_marker_enable()
	local mission_objective_target_extension = self._mission_objective_target_extension

	mission_objective_target_extension:add_unit_marker()
end

function MissionObjectiveTarget:objective_marker_disable()
	local mission_objective_target_extension = self._mission_objective_target_extension
