...
function MissionObjectiveZone:init(unit)
...
function MissionObjectiveZone:editor_init(unit)
end

function MissionObjectiveZone:enable(unit)
end

function MissionObjectiveZone:disable(unit)
end

function MissionObjectiveZone:destroy(unit)
end
