...
function NpcAnimation:init(unit)
...
function NpcAnimation:enable(unit)
end

function NpcAnimation:disable(unit)
end

function NpcAnimation:destroy(unit)
...
function NpcAnimation:_override_animation(unit)
