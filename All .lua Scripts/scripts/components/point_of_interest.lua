...
function PointOfInterest:init(unit, is_server)
...
function PointOfInterest:editor_init(unit)
end

function PointOfInterest:enable(unit)
end

function PointOfInterest:disable(unit)
	local point_of_interest_extension = ScriptUnit.fetch_component_extension(unit, "point_of_interest_system")

	point_of_interest_extension:set_disabled()
end

function PointOfInterest:destroy(unit)
end
