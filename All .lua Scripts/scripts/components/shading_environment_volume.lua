...
function ShadingEnvironmentVolume:init(unit)
	self:enable(unit)
end

function ShadingEnvironmentVolume:enable(unit)
...
function ShadingEnvironmentVolume:disable(unit)
end

function ShadingEnvironmentVolume:destroy(unit)
end

function ShadingEnvironmentVolume:editor_init(unit)
	if LevelEditor then
...
function ShadingEnvironmentVolume:enable_environment()
...
function ShadingEnvironmentVolume:disable_environment()
	local extension = self._extension
...
function ShadingEnvironmentVolume:editor_destroy(unit)
