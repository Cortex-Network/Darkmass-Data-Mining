...
function MinionMultiTeleporterQueries.generate_smart_object(unit, nav_world, destination_teleporter_unit)
...
function MinionMultiTeleporterQueries.generate_smart_objects(unit, nav_world, teleporter_units)
