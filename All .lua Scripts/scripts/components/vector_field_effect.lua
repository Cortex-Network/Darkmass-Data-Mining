...
function VectorFieldEffect:init(unit)
...
function VectorFieldEffect:enable(unit)
...
function VectorFieldEffect:disable(unit)
	self:remove(unit)
end

function VectorFieldEffect:destroy(unit)
	self:remove(unit)
end

function VectorFieldEffect:changed(unit)
...
function VectorFieldEffect:remove(unit)
	local vector_field_id = Unit.get_data(unit, "vector_field_id")
...
function VectorFieldEffect:create_paramaters(unit, effect, speed)
