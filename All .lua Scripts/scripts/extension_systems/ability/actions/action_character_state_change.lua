...
function ActionCharacterStateChange:init(action_context, action_params, action_settings)
...
function ActionCharacterStateChange:start(action_settings, t, time_scale, action_start_params)
...
function ActionCharacterStateChange:wanted_character_state_transition()
	return self._wanted_state_name, self._wanted_state_params
end

function ActionCharacterStateChange:fixed_update(dt, t, time_in_action)
...
function ActionCharacterStateChange:finish(reason, data, t, time_in_action)
	local current_state = self._character_sate_component.state_name
	local wanted_state = self._wanted_state_name
