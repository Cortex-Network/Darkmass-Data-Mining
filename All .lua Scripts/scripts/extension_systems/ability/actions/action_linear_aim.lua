...
function ActionLinearAim:init(action_context, ...)
...
function ActionLinearAim:start(action_settings, t, time_scale, action_start_params)
...
function ActionLinearAim:finish(reason, data, t, time_in_action)
...
function ActionLinearAim:get_lunge_template()
