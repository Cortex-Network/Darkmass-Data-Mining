...
function ActionProximityTag:init(action_context, action_params, action_settings)
...
function ActionProximityTag:start(action_settings, t, time_scale, action_start_params)
