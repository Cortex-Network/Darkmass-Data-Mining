...
function ActionPsykerShout:init(action_context, action_params, action_settings)
...
function ActionPsykerShout:start(action_settings, t, time_scale, action_start_params)
...
function ActionPsykerShout:fixed_update(dt, t, time_in_action)
...
function ActionPsykerShout:finish(reason, data, t, time_in_action, action_settings)
...
function ActionPsykerShout:_handle_enemies(action_settings, side, t, specialization_extension)
