...
function EquippedAbilityEffectScripts.destroy(equiped_ability_effect_scripts)
...
function EquippedAbilityEffectScripts.update(equiped_ability_effect_scripts, unit, dt, t)
	local num_scripts = #equiped_ability_effect_scripts
...
function EquippedAbilityEffectScripts.fixed_update(equiped_ability_effect_scripts, unit, dt, t)
	local num_scripts = #equiped_ability_effect_scripts
...
function EquippedAbilityEffectScripts.post_update(equiped_ability_effect_scripts, unit, dt, t)
	local num_scripts = #equiped_ability_effect_scripts
