...
function TargetedDashEffects:init(equiped_ability_effect_scripts_context, ability_template)
...
function TargetedDashEffects:destroy()
	self:_destroy_effects()
end

function TargetedDashEffects:update(unit, dt, t)
...
function TargetedDashEffects:_spawn_effects()
...
function TargetedDashEffects:_destroy_effects()
	local world = self._world
...
function TargetedDashEffects:_update_effect_positions(target_position, effect_id)
