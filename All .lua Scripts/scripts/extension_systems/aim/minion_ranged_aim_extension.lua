...
function MinionRangedAimExtension:init(extension_init_context, unit, extension_init_data, game_object_data)
...
function MinionRangedAimExtension:_init_blackboard_components(blackboard)
...
function MinionRangedAimExtension:game_object_initialized(session, object_id)
	self._game_session = session
	self._game_object_id = object_id
end

function MinionRangedAimExtension:extensions_ready(world, unit)
...
function MinionRangedAimExtension:update(unit, dt, t)
