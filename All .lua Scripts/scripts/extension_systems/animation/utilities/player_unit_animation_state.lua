...
function PlayerUnitAnimationState.set_anim_state_machine(player_unit, first_person_unit, weapon_template, is_local_unit, anim_variables_3p, anim_variables_1p)
...
function PlayerUnitAnimationState.cache_anim_variable_ids(player_unit, first_person_unit, anim_variables_3p, anim_variables_1p, state_machine_3p_or_nil, state_machine_1p_or_nil)
...
function PlayerUnitAnimationState.should_override_animation_state(animation_state_component, simulated_animation_state_component)
...
function PlayerUnitAnimationState.record_animation_state(animation_state_component, player_unit, first_person_unit)
...
function PlayerUnitAnimationState.override_animation_state(animation_state_component, player_unit, first_person_unit, simulated_time, override_3p, override_1p)
