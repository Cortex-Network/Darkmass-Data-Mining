...
function PlayerUnitAttackIntensityExtension:init(extension_init_context, unit, extension_init_data)
...
function PlayerUnitAttackIntensityExtension:extensions_ready(world, unit)
...
function PlayerUnitAttackIntensityExtension:_setup_intensities()
...
function PlayerUnitAttackIntensityExtension:update(unit, dt, t, context)
...
function PlayerUnitAttackIntensityExtension:_update_locked_in_melee(dt, t)
...
function PlayerUnitAttackIntensityExtension:_check_locked_in_melee(t)
...
function PlayerUnitAttackIntensityExtension:add_intensity(intensity_type, intensity)
...
function PlayerUnitAttackIntensityExtension:attack_allowed(intensity_type)
...
function PlayerUnitAttackIntensityExtension:set_monster_attacker(attacker_unit)
	self._monster_attacker_unit = attacker_unit
end

function PlayerUnitAttackIntensityExtension:monster_attacker()
	return self._monster_attacker_unit
end

function PlayerUnitAttackIntensityExtension:get_intensity(intensity_type)
	return self._intensity_data[intensity_type].intensity
end

function PlayerUnitAttackIntensityExtension:total_intensity()
...
function PlayerUnitAttackIntensityExtension:locked_in_melee()
	return self._locked_in_melee
end

function PlayerUnitAttackIntensityExtension:add_to_locked_in_melee_timer(time_to_add)
	local t = Managers.time:time("gameplay")
	self._locked_in_melee_timer = t + time_to_add
end

function PlayerUnitAttackIntensityExtension:reset_locked_in_melee_timer()
	self._locked_in_melee_timer = 0
end

function PlayerUnitAttackIntensityExtension:total_intensity_percent()
...
function PlayerUnitAttackIntensityExtension:set_attacked()
	local t = Managers.time:time("gameplay")
...
function PlayerUnitAttackIntensityExtension:recently_attacked()
	local t = Managers.time:time("gameplay")

	return t < self._attack_allowed_timer
end

function PlayerUnitAttackIntensityExtension:set_attacked_melee()
	self._num_attacks_in_melee = self._num_attacks_in_melee + 1
end

function PlayerUnitAttackIntensityExtension:remove_attacked_melee()
	self._num_attacks_in_melee = self._num_attacks_in_melee - 1
end

function PlayerUnitAttackIntensityExtension:num_melee_attackers()
