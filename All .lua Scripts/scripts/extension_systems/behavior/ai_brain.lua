...
function AiBrain:init(unit, breed, blackboard, behavior_tree)
	self._unit = unit
	self._breed = breed
...
function AiBrain:set_active(active)
	self._active = active
end

function AiBrain:active()
	return self._active
end

function AiBrain:set_behavior_tree(behavior_tree)
...
function AiBrain:behavior_tree()
	return self._behavior_tree
end

function AiBrain:shutdown_behavior_tree(t, destroy)
...
function AiBrain:update(unit, dt, t)
...
function AiBrain:running_action()
