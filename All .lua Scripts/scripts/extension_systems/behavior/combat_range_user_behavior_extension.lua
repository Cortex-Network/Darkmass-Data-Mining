...
function CombatRangeUserBehaviorExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function CombatRangeUserBehaviorExtension:_init_blackboard_components(blackboard, breed, ...)
...
function CombatRangeUserBehaviorExtension:game_object_initialized(game_session, game_object_id)
...
function CombatRangeUserBehaviorExtension:update_combat_range(unit, blackboard, dt, t)
...
function CombatRangeUserBehaviorExtension:update_minion_phase(unit, blackboard, dt, t)
...
function CombatRangeUserBehaviorExtension:_get_next_phase(phases, current_phase_name)
...
function CombatRangeUserBehaviorExtension:_switch_phase(t, phases, wanted_phase_name, wanted_combat_range)
