...
function MinionBehaviorExtension:init(extension_init_context, unit, extension_init_data, game_object_data)
...
function MinionBehaviorExtension:override_brain(behavior_tree_name, t)
...
function MinionBehaviorExtension:game_object_initialized(game_session, game_object_id)
...
function MinionBehaviorExtension:update_nearby_units_broadphase(unit, blackboard, dt, t)
...
function MinionBehaviorExtension:update(unit, dt, t, ...)
...
function MinionBehaviorExtension:brain()
	return self._brain
end

function MinionBehaviorExtension:running_action()
