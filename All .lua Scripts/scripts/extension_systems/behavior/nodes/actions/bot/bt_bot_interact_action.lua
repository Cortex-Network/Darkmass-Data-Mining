...
function BtBotInteractAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBotInteractAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
	local behavior_component = scratchpad.behavior_component
	behavior_component.current_interaction_unit = nil
	local interactor_extension = scratchpad.interactor_extension

	interactor_extension:set_bot_interaction_unit(nil, , )
...
function BtBotInteractAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	local behavior_component = scratchpad.behavior_component
