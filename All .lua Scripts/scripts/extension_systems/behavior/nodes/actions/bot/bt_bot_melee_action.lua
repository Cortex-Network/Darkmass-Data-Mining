...
function BtBotMeleeAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBotMeleeAction:init_values(blackboard)
...
function BtBotMeleeAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtBotMeleeAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtBotMeleeAction:_update_melee(unit, scratchpad, action_data, t)
...
function BtBotMeleeAction:_can_start_attack(attack_meta_data, weapon_extension)
...
function BtBotMeleeAction:_update_attack(scratchpad, t)
...
function BtBotMeleeAction:_aim_position(target_unit, target_breed)
...
function BtBotMeleeAction:_choose_attack(target_unit, target_breed, scratchpad)
...
function BtBotMeleeAction:_calculate_melee_range(target_breed, attack_meta_data)
...
function BtBotMeleeAction:_target_velocity(target_unit, target_breed)
...
function BtBotMeleeAction:_is_in_melee_range(self_position, aim_position, melee_range, self_velocitiy, target_velocity, scratchpad, t)
...
function BtBotMeleeAction:_time_to_next_attack(scratchpad, t)
...
function BtBotMeleeAction:_should_defend(unit, target_unit, scratchpad)
...
function BtBotMeleeAction:_update_start_defend(scratchpad, defense_meta_data)
...
function BtBotMeleeAction:_start_defend(action_input, scratchpad)
	local action_input_extension = scratchpad.action_input_extension
	local raw_input = nil
	scratchpad.start_defend_request_id = action_input_extension:bot_queue_action_input("weapon_action", action_input, raw_input)
end

function BtBotMeleeAction:_stop_defend(scratchpad, defense_meta_data)
	local action_input_extension = scratchpad.action_input_extension
...
function BtBotMeleeAction:_update_defend(unit, should_defend, defense_meta_data, scratchpad, in_melee_range, target_unit, target_breed, fixed_t, t)
	local action_input_extension = scratchpad.action_input_extension
...
function BtBotMeleeAction:_should_push(defense_meta_data, scratchpad, in_melee_range, target_unit, target_breed, fixed_t)
	local num_enemies = scratchpad.num_enemies_in_proximity
...
function BtBotMeleeAction:_update_dodge(unit, scratchpad, target_unit, t)
...
function BtBotMeleeAction:_is_attacking_me(self_unit, enemy_unit)
...
function BtBotMeleeAction:_clear_pending_attack(scratchpad)
	local action_input_extension = scratchpad.action_input_extension
...
function BtBotMeleeAction:_start_attack(attack_meta_data, scratchpad, t)
...
function BtBotMeleeAction:_is_in_engage_range(self_position, target_position, action_data, follow_position)
...
function BtBotMeleeAction:_target_unit_position(self_position, target_unit, action_data, nav_world, traverse_logic)
...
function BtBotMeleeAction:_allow_engage(self_unit, target_unit, target_position, target_breed, scratchpad, action_data, already_engaged, aim_position, follow_position)
...
function BtBotMeleeAction:_is_targeting_me(self_unit, enemy_unit)
	local target_blackboard = BLACKBOARDS[enemy_unit]
...
function BtBotMeleeAction:_engage(scratchpad, t)
	scratchpad.engaging = true
	scratchpad.engage_change_time = t
end

function BtBotMeleeAction:_disengage(scratchpad, t)
	scratchpad.engaging = false
	scratchpad.engage_change_time = t
...
function BtBotMeleeAction:_update_engage_position(unit, self_position, target_unit, target_unit_position, target_velocity, target_breed, scratchpad, t, melee_range, nav_world, traverse_logic)
...
function BtBotMeleeAction:_evaluation_timer(scratchpad, t, timer_value)
