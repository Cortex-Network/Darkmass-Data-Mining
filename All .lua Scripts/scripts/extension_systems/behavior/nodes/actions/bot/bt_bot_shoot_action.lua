...
function BtBotShootAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBotShootAction:_set_new_aim_target(t, target_unit, scratchpad, action_data)
...
function BtBotShootAction:_should_aim(t, scratchpad, action_data)
...
function BtBotShootAction:_start_aiming(t, scratchpad)
...
function BtBotShootAction:_stop_aiming(scratchpad)
...
function BtBotShootAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtBotShootAction:_clear_pending_attack(scratchpad)
	local action_input_extension = scratchpad.action_input_extension
...
function BtBotShootAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtBotShootAction:_update_aim(unit, scratchpad, action_data, dt, t)
...
function BtBotShootAction:_aim_position(self_unit, scratchpad, dt, current_position, current_rotation, target_unit)
...
function BtBotShootAction:_wanted_aim_rotation(self_unit, target_unit, target_breed, current_position, projectile_template, aim_at_node)
...
function BtBotShootAction:_target_velocity(target_unit, target_breed)
...
function BtBotShootAction:_calculate_aim_speed(dt, current_yaw, current_pitch, wanted_yaw, wanted_pitch, current_yaw_speed)
...
function BtBotShootAction:_reevaluate_obstruction(self_unit, scratchpad, action_data, t, ray_from, wanted_aim_rotation, actual_aim_position, target_unit)
...
function BtBotShootAction:_update_collision_filter(target_unit, scratchpad)
	local perception_component = scratchpad.perception_component
...
function BtBotShootAction:_is_shot_obstructed(self_unit, scratchpad, collision_filter, from, direction, target_unit, actual_aim_position, ignore_allies, ignore_enemies)
...
function BtBotShootAction:_should_charge(scratchpad, range_squared, target_unit, t)
...
function BtBotShootAction:_charge_shot(scratchpad, action_data, bot_unit_input, t)
...
function BtBotShootAction:_aim_good_enough(unit, dt, t, scratchpad, yaw_offset, pitch_offset)
...
function BtBotShootAction:_may_fire(unit, scratchpad, range_squared, t)
...
function BtBotShootAction:_fire(scratchpad, action_data, bot_unit_input, t)
