...
function BtBeastOfNurgleConsumeAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBeastOfNurgleConsumeAction:init_values(blackboard)
...
function BtBeastOfNurgleConsumeAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtBeastOfNurgleConsumeAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtBeastOfNurgleConsumeAction:_start_consuming(unit, scratchpad, action_data, t)
...
function BtBeastOfNurgleConsumeAction:_update_consuming(unit, scratchpad, action_data, t, dt)
	local target_unit = scratchpad.perception_component.target_unit
...
function BtBeastOfNurgleConsumeAction:_start_throwing_target(unit, scratchpad, action_data, t)
...
function BtBeastOfNurgleConsumeAction:_align_throwing(unit, scratchpad, action_data)
...
function BtBeastOfNurgleConsumeAction:_update_throwing(unit, scratchpad, action_data, breed, t)
...
function BtBeastOfNurgleConsumeAction:_test_throw_trajectory(unit, scratchpad, action_data, test_direction, to)
...
function BtBeastOfNurgleConsumeAction:_consume_target(unit, target_unit, scratchpad, action_data, t)
...
function BtBeastOfNurgleConsumeAction:_calculate_randomized_throw_directions(action_data)
...
function BtBeastOfNurgleConsumeAction:_add_threat_to_other_targets(unit, breed, scratchpad, excluded_target)
...
function BtBeastOfNurgleConsumeAction:_rotate_towards_target_unit(unit, scratchpad)
...
function BtBeastOfNurgleConsumeAction:_ray_cast(physics_world, from, to)
