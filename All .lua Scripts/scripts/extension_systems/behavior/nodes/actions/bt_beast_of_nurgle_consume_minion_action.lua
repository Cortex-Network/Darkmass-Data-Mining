...
function BtBeastOfNurgleConsumeMinionAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBeastOfNurgleConsumeMinionAction:init_values(blackboard)
	local behavior_component = Blackboard.write_component(blackboard, "behavior")
	behavior_component.consume_minion_cooldown = 0
end

function BtBeastOfNurgleConsumeMinionAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtBeastOfNurgleConsumeMinionAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtBeastOfNurgleConsumeMinionAction:_get_target(unit, scratchpad, action_data)
...
function BtBeastOfNurgleConsumeMinionAction:_start_tongue_out(unit, scratchpad, action_data, t)
	local target_unit = scratchpad.target_unit
...
function BtBeastOfNurgleConsumeMinionAction:_update_tongue_out(unit, scratchpad, action_data, t)
...
function BtBeastOfNurgleConsumeMinionAction:_start_tongue_in(unit, scratchpad, action_data, t)
	local target_unit = scratchpad.target_unit
...
function BtBeastOfNurgleConsumeMinionAction:_update_tongue_in(unit, scratchpad, action_data, t)
...
function BtBeastOfNurgleConsumeMinionAction:_start_consuming(unit, scratchpad, action_data, t)
	local target_unit = scratchpad.target_unit
...
function BtBeastOfNurgleConsumeMinionAction:_update_consuming(unit, scratchpad, action_data, t)
...
function BtBeastOfNurgleConsumeMinionAction:_heal(unit, action_data)
...
function BtBeastOfNurgleConsumeMinionAction:_rotate_towards_target_unit(unit, scratchpad, action_data)
	local target_unit = scratchpad.target_unit
...
function BtBeastOfNurgleConsumeMinionAction:_start_effect_template(unit, scratchpad, action_data)
...
function BtBeastOfNurgleConsumeMinionAction:_stop_effect_template(scratchpad)
