...
function BtBeastOfNurgleMovementAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBeastOfNurgleMovementAction:init_values(blackboard)
	local behavior_component = Blackboard.write_component(blackboard, "behavior")
	behavior_component.movement_liquid_paint_id = 0
	behavior_component.vomit_liquid_paint_id = 0
end

function BtBeastOfNurgleMovementAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtBeastOfNurgleMovementAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtBeastOfNurgleMovementAction:_start_move_anim(unit, breed, t, scratchpad, action_data, optional_moving_direction_name)
...
function BtBeastOfNurgleMovementAction:_update_anim_driven_start_rotation(unit, scratchpad, action_data, t)
...
function BtBeastOfNurgleMovementAction:_set_anim_driven(unit, scratchpad, set_anim_driven)
...
function BtBeastOfNurgleMovementAction:_move_to_target(unit, t, scratchpad, action_data, navigation_extension, target_position)
	local nav_world = navigation_extension:nav_world()
...
function BtBeastOfNurgleMovementAction:_calculate_randomized_move_to_directions(unit, action_data, scratchpad, randomized_directions)
...
function BtBeastOfNurgleMovementAction:_paint_liquid(unit, scratchpad, action_data)
