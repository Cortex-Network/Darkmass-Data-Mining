...
function BtBeastOfNurgleSpitOutAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBeastOfNurgleSpitOutAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtBeastOfNurgleSpitOutAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtBeastOfNurgleSpitOutAction:_start_aligning(unit, scratchpad, action_data, t)
...
function BtBeastOfNurgleSpitOutAction:_align_throwing(unit, scratchpad, action_data)
...
function BtBeastOfNurgleSpitOutAction:_update_aligning(unit, scratchpad, action_data, breed, t)
...
function BtBeastOfNurgleSpitOutAction:_start_throwing(unit, scratchpad, action_data, t)
...
function BtBeastOfNurgleSpitOutAction:_update_throwing(unit, scratchpad, action_data, breed, t)
	local throw_direction = scratchpad.throw_direction:unbox()
	local locomotion_extension = scratchpad.locomotion_extension
...
function BtBeastOfNurgleSpitOutAction:_test_throw_trajectory(unit, scratchpad, action_data, test_direction, to)
...
function BtBeastOfNurgleSpitOutAction:_calculate_randomized_throw_directions(action_data)
...
function BtBeastOfNurgleSpitOutAction:_add_threat_to_other_targets(unit, breed, scratchpad, excluded_target)
...
function BtBeastOfNurgleSpitOutAction:_rotate_towards_target_unit(unit, scratchpad)
...
function BtBeastOfNurgleSpitOutAction:_ray_cast(physics_world, from, to)
