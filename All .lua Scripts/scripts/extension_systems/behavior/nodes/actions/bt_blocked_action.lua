...
function BtBlockedAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtBlockedAction:init_values(blackboard)
	local blocked_component = Blackboard.write_component(blackboard, "blocked")
	blocked_component.is_blocked = false
end

function BtBlockedAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtBlockedAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	local locomotion_extension = scratchpad.locomotion_extension
