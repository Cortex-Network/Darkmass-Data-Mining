...
function BtChaosDaemonhostPassiveAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtChaosDaemonhostPassiveAction:init_values(blackboard, action_data, node_data)
	local statistics_component = Blackboard.write_component(blackboard, "statistics")
	statistics_component.valid_targets_on_aggro = 0
end

function BtChaosDaemonhostPassiveAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtChaosDaemonhostPassiveAction:_switch_stage(unit, breed, scratchpad, action_data, stage, t)
...
function BtChaosDaemonhostPassiveAction:_enter_flashed(unit, scratchpad, action_data, t)
...
function BtChaosDaemonhostPassiveAction:_exit_flashed(scratchpad)
	local locomotion_extension = scratchpad.locomotion_extension
...
function BtChaosDaemonhostPassiveAction:_update_flashlights(unit, position, valid_enemy_player_units, scratchpad, action_data, t)
	local anger_flat = 0
	local anger_tick = 0
...
function BtChaosDaemonhostPassiveAction:_update_distances(unit, position, valid_enemy_player_units, scratchpad, action_data)
	local perception_extension = scratchpad.perception_extension
...
function BtChaosDaemonhostPassiveAction:_update_health(scratchpad, action_data)
	local anger_flat = 0
	local anger_settings = action_data.anger_settings
	local health_extension = scratchpad.health_extension
	local current_health_percent = health_extension:current_health_percent()
...
function BtChaosDaemonhostPassiveAction:_update_suppression(scratchpad, action_data)
	local anger_flat = 0
	local anger_settings = action_data.anger_settings
...
function BtChaosDaemonhostPassiveAction:_update(unit, breed, blackboard, scratchpad, action_data, t)
	local anger_settings = action_data.anger_settings
...
function BtChaosDaemonhostPassiveAction:_check_flashlight(from, target_unit, flashlight_settings, perception_extension)
...
function BtChaosDaemonhostPassiveAction:_get_stage(scratchpad, action_data)
	local anger_settings = action_data.anger_settings
...
function BtChaosDaemonhostPassiveAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtChaosDaemonhostPassiveAction:_update_looping_vo(unit, breed, scratchpad, action_data, stage, t)
	local stage_settings = action_data.stage_settings[stage]
...
function BtChaosDaemonhostPassiveAction:_get_switch_stage_reason(scratchpad, distance_flat, health_flat, flashlight_flat, suppression_flat, distance_tick, flashlight_tick)
...
function BtChaosDaemonhostPassiveAction:_get_wanted_aggro_target(unit, scratchpad, switch_reason)
