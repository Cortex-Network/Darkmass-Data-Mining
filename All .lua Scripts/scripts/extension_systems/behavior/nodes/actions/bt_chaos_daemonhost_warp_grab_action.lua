...
function BtChaosDaemonhostWarpGrabAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtChaosDaemonhostWarpGrabAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtChaosDaemonhostWarpGrabAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtChaosDaemonhostWarpGrabAction:_start_charging_projectile(scratchpad, action_data, t)
...
function BtChaosDaemonhostWarpGrabAction:_update_charging_projectile(unit, t, scratchpad, action_data)
	...
	if scratchpad.fire_timing < t then
		self:_start_channeling(unit, t, scratchpad, action_data, target_unit)
	end
end

function BtChaosDaemonhostWarpGrabAction:_start_channeling(unit, t, scratchpad, action_data, hit_unit)
...
function BtChaosDaemonhostWarpGrabAction:_update_channeling(unit, t, scratchpad, action_data)
...
function BtChaosDaemonhostWarpGrabAction:_start_executing(t, scratchpad, action_data)
...
function BtChaosDaemonhostWarpGrabAction:_update_executing(unit, t, scratchpad, action_data)
	...
	if scratchpad.execute_duration <= t then
		scratchpad.state = "done"
	end
end

function BtChaosDaemonhostWarpGrabAction:_execute(scratchpad, unit, action_data)
	...
	fx_extension:trigger_wwise_events_local_and_husk(local_event_name, husk_event_name, nil, , , hit_position, nil, , , , )
end

function BtChaosDaemonhostWarpGrabAction:_start_effect_template(unit, scratchpad, action_data)
...
function BtChaosDaemonhostWarpGrabAction:_stop_effect_template(scratchpad)
