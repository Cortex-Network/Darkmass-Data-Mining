...
function BtChaosHoundApproachAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtChaosHoundApproachAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtChaosHoundApproachAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	...
	if NUM_FAILED_ATTEMPTS_TO_MANUAL_MOVE <= find_move_position_attempts then
		...
		MinionMovement.update_move_to_ranged_position(unit, t, scratchpad, action_data, target_unit, nil, , , force_move)
	end
...
function BtChaosHoundApproachAction:_can_start_leap(unit, scratchpad, action_data, perception_component, t)
...
function BtChaosHoundApproachAction:_line_of_sight_check(from, to, physics_world)
...
function BtChaosHoundApproachAction:_start_move_anim(unit, scratchpad, action_data, t)
...
function BtChaosHoundApproachAction:_move_to_target(scratchpad)
	local navigation_extension = scratchpad.navigation_extension
	local nav_world = navigation_extension:nav_world()
	local traverse_logic = navigation_extension:traverse_logic()
...
function BtChaosHoundApproachAction:_update_anim_lean_variable(unit, scratchpad, action_data, dt)
...
function BtChaosHoundApproachAction:_update_ground_normal_rotation(unit, target_unit, scratchpad, towards_target)
...
function BtChaosHoundApproachAction:_ray_cast(physics_world, from, to)
...
function BtChaosHoundApproachAction:_set_pounce_cooldown(unit, breed, scratchpad, target_unit, blackboard, t)
...
function BtChaosHoundApproachAction:_add_threat_to_other_targets(unit, breed, scratchpad, excluded_target)
