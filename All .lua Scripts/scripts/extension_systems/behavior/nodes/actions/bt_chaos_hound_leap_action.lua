...
function BtChaosHoundLeapAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtChaosHoundLeapAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtChaosHoundLeapAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtChaosHoundLeapAction:_try_start_leap(unit, t, scratchpad, action_data)
...
function BtChaosHoundLeapAction:_calculate_wanted_velocity(unit, t, scratchpad, action_data)
...
function BtChaosHoundLeapAction:_leap(scratchpad, blackboard, action_data, t, unit)
...
function BtChaosHoundLeapAction:_start_landing(scratchpad, action_data, current_velocity, t)
...
function BtChaosHoundLeapAction:_start_wall_jump(unit, scratchpad, action_data, wall_normal)
...
function BtChaosHoundLeapAction:_check_wall_collision(unit, scratchpad, action_data)
...
function BtChaosHoundLeapAction:_check_colliding_players(unit, scratchpad, action_data, ignore_dot_check)
...
function BtChaosHoundLeapAction:_update_ground_normal_rotation(unit, target_unit, scratchpad, towards_target)
	local physics_world = scratchpad.physics_world
...
function BtChaosHoundLeapAction:_ray_cast(physics_world, from, to)
...
function BtChaosHoundLeapAction:_set_pounce_cooldown(blackboard, t)
