...
function BtChaosHoundSkulkAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtChaosHoundSkulkAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtChaosHoundSkulkAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtChaosHoundSkulkAction:_line_of_sight_check(from, to, physics_world)
...
function BtChaosHoundSkulkAction:_start_move_anim(unit, scratchpad, action_data, t)
	local behavior_component = scratchpad.behavior_component
...
function BtChaosHoundSkulkAction:_move_to_combat_vector(scratchpad, combat_vector_component, navigation_extension)
	local wanted_position = combat_vector_component.position:unbox()
...
function BtChaosHoundSkulkAction:_update_anim_lean_variable(unit, scratchpad, action_data)
...
function BtChaosHoundSkulkAction:_update_ground_normal_rotation(unit, scratchpad)
...
function BtChaosHoundSkulkAction:_ray_cast(physics_world, from, to)
