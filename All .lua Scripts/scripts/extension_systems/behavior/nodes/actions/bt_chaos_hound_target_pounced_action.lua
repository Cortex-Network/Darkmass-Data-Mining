...
function BtChaosHoundTargetPouncedAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtChaosHoundTargetPouncedAction:_pounce_achieved(scratchpad, action_data, t)
...
function BtChaosHoundTargetPouncedAction:init_values(blackboard)
	local pounce_component = Blackboard.write_component(blackboard, "pounce")
...
function BtChaosHoundTargetPouncedAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtChaosHoundTargetPouncedAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtChaosHoundTargetPouncedAction:_target_incapacitated(scratchpad)
	local pounce_target = scratchpad.pounce_target
...
function BtChaosHoundTargetPouncedAction:_damage_target(scratchpad, unit, action_data, power_level_table)
	local pounce_target = scratchpad.pounce_target
