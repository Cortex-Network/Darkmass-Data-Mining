...
function BtChaosPoxwalkerExplodeAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtChaosPoxwalkerExplodeAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	return "done"
end
