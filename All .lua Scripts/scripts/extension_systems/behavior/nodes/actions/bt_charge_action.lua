...
function BtChargeAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtChargeAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtChargeAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtChargeAction:_start_buildup(unit, scratchpad, action_data, t)
...
function BtChargeAction:_start_charging(unit, scratchpad, action_data, t)
...
function BtChargeAction:_start_navigating(scratchpad, action_data, t)
	local navigation_extension = scratchpad.navigation_extension
	local speed = scratchpad.current_charge_speed or action_data.charge_speed_min
...
function BtChargeAction:_update_charging(unit, scratchpad, action_data, t, dt)
...
function BtChargeAction:_update_navigating(unit, scratchpad, action_data, t)
...
function BtChargeAction:_update_charged_past(unit, scratchpad, action_data, t, dt)
...
function BtChargeAction:_update_ray_can_go(unit, scratchpad)
	local navigation_extension = scratchpad.navigation_extension
...
function BtChargeAction:_update_attacking(unit, scratchpad, action_data, t, dt)
	...
	if not scratchpad.has_dealt_damage and attack_damage_t < t then
		...
		ImpactEffect.play(hit_target, nil, damage, damage_type, nil, result, hit_world_position, nil, direction, unit, nil, , , damage_efficiency, damage_profile)
...
function BtChargeAction:_move_to_position(scratchpad, target_position)
	local navigation_extension = scratchpad.navigation_extension
	local nav_world = navigation_extension:nav_world()
	local traverse_logic = navigation_extension:traverse_logic()
...
function BtChargeAction:_check_wall_collision(unit, scratchpad, action_data)
...
function BtChargeAction:_check_colliding_players(unit, scratchpad, action_data)
...
function BtChargeAction:_hit_target(unit, hit_unit, scratchpad, action_data, t)
...
function BtChargeAction:_get_turn_slowdown_percentage(unit, direction, action_data)
	local current_rotation = Unit.local_rotation(unit, 1)
...
function BtChargeAction:_update_charge_buildup(unit, scratchpad, action_data, t, dt)
...
function BtChargeAction:_start_charge_direction_anim(unit, scratchpad, action_data, t)
...
function BtChargeAction:_start_charge_anim(unit, scratchpad, action_data, t)
	scratchpad.locomotion_extension = ScriptUnit.extension(unit, "locomotion_system")
...
function BtChargeAction:_update_anim_lean_variable(unit, scratchpad, action_data, dt, target_position)
