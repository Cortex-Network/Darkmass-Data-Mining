...
function BtClimbAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtClimbAction:_calculate_jump(navigation_extension, nav_smart_object_component, scratchpad)
...
function BtClimbAction:_start_jump(unit, breed, action_data, t, scratchpad, locomotion_extension, entrance_position, exit_position, ledge_position)
...
function BtClimbAction:_jump_anim_event(unit, jump_height, anim_thresholds, jump_type, scratchpad)
...
function BtClimbAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtClimbAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtClimbAction:_is_unit_on_navmesh(unit, navigation_extension)
...
function BtClimbAction:_update_climbing(unit, breed, scratchpad, action_data, t)
...
function BtClimbAction:_update_falling(unit, scratchpad, action_data, dt, t)
	if scratchpad.units_catapulted ~= nil then
		self:_catapult_units(unit, scratchpad, action_data)
	end
...
function BtClimbAction:_update_landing(scratchpad, t)
...
function BtClimbAction:_catapult_units(unit, scratchpad, action_data)
