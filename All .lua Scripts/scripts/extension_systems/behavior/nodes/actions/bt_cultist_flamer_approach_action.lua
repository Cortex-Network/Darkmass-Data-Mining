...
function BtCultistFlamerApproachAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtCultistFlamerApproachAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtCultistFlamerApproachAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtCultistFlamerApproachAction:_start_move_anim(unit, t, behavior_component, scratchpad, action_data)
...
function BtCultistFlamerApproachAction:_rotate_towards_target_unit(unit, scratchpad, target_unit)
