...
function BtDieAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtDieAction:init_values(blackboard)
	local death_component = Blackboard.write_component(blackboard, "death")
...
function BtDieAction:_set_dead(unit, scratchpad, breed, action_data, blackboard)
...
function BtDieAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtDieAction:_check_if_need_to_ragdoll(unit)
