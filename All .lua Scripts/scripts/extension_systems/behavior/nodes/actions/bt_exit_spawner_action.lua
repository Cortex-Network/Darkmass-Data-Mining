...
function BtExitSpawnerAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtExitSpawnerAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtExitSpawnerAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
