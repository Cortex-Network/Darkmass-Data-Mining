...
function BtGrenadierFollowAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtGrenadierFollowAction:init_values(blackboard)
...
function BtGrenadierFollowAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtGrenadierFollowAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtGrenadierFollowAction:_check_grenade_trajectory(unit, blackboard, scratchpad, action_data)
	local target_unit = scratchpad.perception_component.target_unit
...
function BtGrenadierFollowAction:_get_throw_position(target_position, scratchpad, action_data)
...
function BtGrenadierFollowAction:_ray_cast(physics_world, from, to)
...
function BtGrenadierFollowAction:_move(scratchpad, combat_vector_component, navigation_extension)
...
function BtGrenadierFollowAction:_start_move_anim(unit, t, behavior_component, scratchpad, action_data)
...
function BtGrenadierFollowAction:_calculate_throw_directions(randomized_directions)
