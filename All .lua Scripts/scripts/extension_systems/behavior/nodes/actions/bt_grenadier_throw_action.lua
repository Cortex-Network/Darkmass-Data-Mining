...
function BtGrenadierThrowAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtGrenadierThrowAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtGrenadierThrowAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	if scratchpad.throw_timing then
...
function BtGrenadierThrowAction:_start_aiming(unit, t, scratchpad, action_data)
...
function BtGrenadierThrowAction:_update_grenade_throwing(unit, t, blackboard, scratchpad, action_data)
...
function BtGrenadierThrowAction:_throw_grenade(unit, scratchpad, action_data, throw_type, throw_position, throw_direction, blackboard, t, optional_owner_velocity)
	local throw_config = action_data.throw_config
...
function BtGrenadierThrowAction:_aim_at_target(scratchpad)
...
function BtGrenadierThrowAction:_stop_effect_template(scratchpad)
