...
function BtInCoverAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtInCoverAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtInCoverAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtInCoverAction:_enter_cover(unit, breed, scratchpad, action_data, cover_component, t)
...
function BtInCoverAction:_update_entering(unit, scratchpad, action_data, t, cover_component)
...
function BtInCoverAction:_start_suppressed(unit, scratchpad, action_data, t, delayed_suppresed_anim, teleport)
...
function BtInCoverAction:_update_suppressed(unit, scratchpad, action_data, t, cover_component, is_suppressed)
...
function BtInCoverAction:_get_peek_identifier(unit, scratchpad, cover_component)
...
function BtInCoverAction:_start_peeking(unit, scratchpad, action_data, cover_component, peek_identifier, t)
...
function BtInCoverAction:_update_peeking(unit, scratchpad, action_data, t, cover_component, perception_component, is_suppressed)
...
function BtInCoverAction:_has_clear_shot_from_aiming_when_peeking(unit, scratchpad, action_data, perception_component, target_unit)
...
function BtInCoverAction:_start_aiming(unit, scratchpad, action_data, t)
...
function BtInCoverAction:_update_aiming(unit, breed, scratchpad, blackboard, action_data, t, cover_component)
...
function BtInCoverAction:_aim_at_target(unit, t, action_data, scratchpad, blackboard)
	local perception_component = scratchpad.perception_component
...
function BtInCoverAction:_start_shooting(unit, scratchpad, action_data, t)
...
function BtInCoverAction:_update_shooting(unit, breed, scratchpad, blackboard, action_data, t, cover_component, perception_component, is_suppressed)
	if is_suppressed then
		MinionAttack.stop_shooting(unit, scratchpad)
