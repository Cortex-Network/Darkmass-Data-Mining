...
function BtMeleeFollowTargetAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtMeleeFollowTargetAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtMeleeFollowTargetAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtMeleeFollowTargetAction:_start_move_anim(unit, breed, t, scratchpad, action_data)
	local navigation_extension = scratchpad.navigation_extension
...
function BtMeleeFollowTargetAction:_update_walking(unit, breed, t, dt, scratchpad, action_data, target_unit)
	self:_rotate_towards_target_unit(unit, target_unit, scratchpad)
...
function BtMeleeFollowTargetAction:_update_running(unit, breed, dt, scratchpad, action_data, target_unit)
	local enter_walk_distance = action_data.enter_walk_distance
...
function BtMeleeFollowTargetAction:_start_walk_anim(scratchpad, action_data, optional_moving_direction_name)
...
function BtMeleeFollowTargetAction:_change_state(unit, breed, scratchpad, action_data, wanted_state)
...
function BtMeleeFollowTargetAction:_set_state_max_speed(breed, scratchpad, action_data)
	local state = scratchpad.state
	local new_speed = nil
...
function BtMeleeFollowTargetAction:_update_effect_template(unit, scratchpad, action_data, target_unit)
	local self_position = POSITION_LOOKUP[unit]
	local target_position = POSITION_LOOKUP[target_unit]
...
function BtMeleeFollowTargetAction:_rotate_towards_target_unit(unit, target_unit, scratchpad)
...
function BtMeleeFollowTargetAction:_update_anim_lean_variable(unit, scratchpad, action_data, lean_variable_name, dt)
