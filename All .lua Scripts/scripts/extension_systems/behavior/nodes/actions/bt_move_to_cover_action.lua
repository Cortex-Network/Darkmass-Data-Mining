...
function BtMoveToCoverAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtMoveToCoverAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtMoveToCoverAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtMoveToCoverAction:_start_move_anim(unit, t, behavior_component, scratchpad, action_data, move_type)
...
function BtMoveToCoverAction:_get_move_type(scratchpad, action_data)
