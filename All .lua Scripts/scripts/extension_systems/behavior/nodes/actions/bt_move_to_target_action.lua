...
function BtMoveToTargetAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtMoveToTargetAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtMoveToTargetAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtMoveToTargetAction:_update_move_to_target_position(scratchpad, navigation_extension, wanted_position)
...
function BtMoveToTargetAction:_start_move_anim(scratchpad, behavior_component, action_data)
