...
function BtMutantChargerChargeAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtMutantChargerChargeAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtMutantChargerChargeAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	self:_update_ray_can_go(unit, scratchpad)
...
function BtMutantChargerChargeAction:_start_charging(unit, scratchpad, action_data, t)
...
function BtMutantChargerChargeAction:_start_navigating(unit, scratchpad, action_data, t)
	local navigation_extension = scratchpad.navigation_extension
...
function BtMutantChargerChargeAction:_start_throwing_target(unit, scratchpad, action_data, t)
...
function BtMutantChargerChargeAction:_update_charging(unit, breed, scratchpad, action_data, t, dt)
	if not scratchpad.navmesh_ray_can_go then
		self:_start_navigating(unit, scratchpad, action_data, t)
	...
	if scratchpad.anim_move_speed_duration then
		if t < scratchpad.anim_move_speed_duration then
			wanted_charge_speed = MinionMovement.get_animation_wanted_movement_speed(unit, dt, action_data.charge_speed_max)
		else
	...
	if scratchpad.start_colliding_with_players_timing and scratchpad.start_colliding_with_players_timing <= t then
...
function BtMutantChargerChargeAction:_update_navigating(unit, scratchpad, action_data, t, dt, breed)
	...
	if scratchpad.anim_move_speed_duration then
		if t < scratchpad.anim_move_speed_duration then
			max_speed = MinionMovement.get_animation_wanted_movement_speed(unit, dt, action_data.charge_speed_max)
		else
			scratchpad.anim_move_speed_duration = nil
		end
	end
...
function BtMutantChargerChargeAction:_update_charged_past(unit, scratchpad, action_data, t, dt)
...
function BtMutantChargerChargeAction:_update_grabbed_target(unit, scratchpad, action_data, t, dt)
	...
	if scratchpad.next_damage_t and scratchpad.next_damage_t < t then
		...
		ImpactEffect.play(target, nil, damage, damage_type, nil, result, hit_position, nil, attack_direction, unit, nil, , , damage_efficiency, damage_profile)
...
function BtMutantChargerChargeAction:_align_throwing(unit, scratchpad, action_data)
...
function BtMutantChargerChargeAction:_play_smash_anim(scratchpad, action_data, t)
...
function BtMutantChargerChargeAction:_update_throwing(unit, scratchpad, action_data, breed, t)
...
function BtMutantChargerChargeAction:_update_ray_can_go(unit, scratchpad)
	local navigation_extension = scratchpad.navigation_extension
	local traverse_logic = navigation_extension:traverse_logic()
	local nav_world = scratchpad.nav_world
	local target_unit = scratchpad.perception_component.target_unit
...
function BtMutantChargerChargeAction:_test_throw_trajectory(unit, scratchpad, action_data, test_direction, to)
...
function BtMutantChargerChargeAction:_move_to_position(scratchpad, target_position)
	local navigation_extension = scratchpad.navigation_extension
	local nav_world = scratchpad.nav_world
	local traverse_logic = navigation_extension:traverse_logic()
...
function BtMutantChargerChargeAction:_check_wall_collision(unit, scratchpad, action_data)
...
function BtMutantChargerChargeAction:_check_colliding_players(unit, scratchpad, action_data)
...
function BtMutantChargerChargeAction:_hit_target(unit, hit_unit, scratchpad, action_data, t)
...
function BtMutantChargerChargeAction:_ray_cast(physics_world, from, to)
...
function BtMutantChargerChargeAction:_calculate_randomized_throw_directions(action_data)
...
function BtMutantChargerChargeAction:_push_friendly_minions(unit, action_data, scratchpad, t)
...
function BtMutantChargerChargeAction:_get_turn_slowdown_percentage(unit, direction, action_data)
	local current_rotation = Unit.local_rotation(unit, 1)
...
function BtMutantChargerChargeAction:_start_effect_template(unit, scratchpad, action_data)
...
function BtMutantChargerChargeAction:_stop_effect_template(scratchpad)
...
function BtMutantChargerChargeAction:_allow_gibbing(unit, action_data, allowed)
...
function BtMutantChargerChargeAction:_add_threat_to_other_targets(unit, breed, scratchpad, excluded_target)
	local side_system = scratchpad.side_system
	local side = side_system.side_by_unit[unit]
