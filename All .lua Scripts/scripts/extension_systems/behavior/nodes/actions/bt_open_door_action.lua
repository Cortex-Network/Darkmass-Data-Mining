...
function BtOpenDoorAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtOpenDoorAction:_start_rotate_towards_exit(unit, scratchpad, action_data, t, entrance_position, exit_position)
...
function BtOpenDoorAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtOpenDoorAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
