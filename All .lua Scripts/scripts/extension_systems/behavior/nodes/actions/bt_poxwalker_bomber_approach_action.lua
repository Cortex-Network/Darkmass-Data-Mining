...
function BtPoxwalkerBomberApproachAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtPoxwalkerBomberApproachAction:init_values(blackboard)
...
function BtPoxwalkerBomberApproachAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtPoxwalkerBomberApproachAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtPoxwalkerBomberApproachAction:_start_move_anim(unit, breed, t, scratchpad, action_data)
	local navigation_extension = scratchpad.navigation_extension
...
function BtPoxwalkerBomberApproachAction:_update_walking(unit, breed, dt, scratchpad, action_data, target_unit)
	self:_rotate_towards_target_unit(unit, target_unit, scratchpad)
...
function BtPoxwalkerBomberApproachAction:_update_running(unit, breed, dt, scratchpad, action_data, target_unit)
	local enter_walk_distance = action_data.enter_walk_distance
...
function BtPoxwalkerBomberApproachAction:_start_walk_anim(scratchpad, action_data, optional_moving_direction_name)
...
function BtPoxwalkerBomberApproachAction:_change_state(unit, breed, scratchpad, action_data, wanted_state)
...
function BtPoxwalkerBomberApproachAction:_set_state_max_speed(breed, scratchpad, action_data)
	local state = scratchpad.state
	local new_speed = nil
...
function BtPoxwalkerBomberApproachAction:_update_effect_template(unit, scratchpad, action_data, target_unit)
	local self_position = POSITION_LOOKUP[unit]
...
function BtPoxwalkerBomberApproachAction:_rotate_towards_target_unit(unit, target_unit, scratchpad)
...
function BtPoxwalkerBomberApproachAction:_update_move_to(t, scratchpad, action_data, target_unit)
	local navigation_extension = scratchpad.navigation_extension
...
function BtPoxwalkerBomberApproachAction:_start_lunge(unit, scratchpad, action_data, target_unit, t)
...
function BtPoxwalkerBomberApproachAction:_update_lunge(unit, scratchpad, action_data, dt, t, blackboard, breed)
	local navigation_extension = scratchpad.navigation_extension
