...
function BtQuickGrenadeThrowAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtQuickGrenadeThrowAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtQuickGrenadeThrowAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	if scratchpad.aim_duration then
...
function BtQuickGrenadeThrowAction:_start_aiming(unit, t, scratchpad, action_data)
...
function BtQuickGrenadeThrowAction:_update_aiming(unit, t, blackboard, scratchpad, action_data)
...
function BtQuickGrenadeThrowAction:_throw_position_and_direction(unit, scratchpad, action_data)
...
function BtQuickGrenadeThrowAction:_throw_grenade(unit, action_data, throw_type, throw_position, throw_direction, blackboard, t, optional_owner_velocity)
	local throw_config = action_data.throw_config
	local projectile_template = throw_config.projectile_template
	local locomotion_template = projectile_template.locomotion_template
	...
	Managers.state.unit_spawner:spawn_network_unit(grenade_unit_name, "item_projectile", throw_position, nil, , item, projectile_template, locomotion_state, throw_direction, speed, angular_velocity, unit)
...
function BtQuickGrenadeThrowAction:_aim_at_target(unit, scratchpad)
...
function BtQuickGrenadeThrowAction:_stop_effect_template(scratchpad)
