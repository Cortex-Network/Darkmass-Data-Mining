...
function BtRenegadeNetgunnerApproachAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtRenegadeNetgunnerApproachAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtRenegadeNetgunnerApproachAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtRenegadeNetgunnerApproachAction:_start_move_anim(scratchpad, action_data)
...
function BtRenegadeNetgunnerApproachAction:_move_to_target(scratchpad, target_unit)
