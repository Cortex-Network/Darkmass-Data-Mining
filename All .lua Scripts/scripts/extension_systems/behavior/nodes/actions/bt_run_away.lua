...
function BtRunAwayAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtRunAwayAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtRunAwayAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtRunAwayAction:_get_wanted_position(unit, scratchpad, action_data)
...
function BtRunAwayAction:_get_main_path_position(unit, action_data)
...
function BtRunAwayAction:_get_combat_vector_position(unit, scratchpad)
...
function BtRunAwayAction:_move_to_position(scratchpad, wanted_position, navigation_extension)
	navigation_extension:move_to(wanted_position)
	scratchpad.current_move_to_position:store(wanted_position)
end

function BtRunAwayAction:_start_move_anim(unit, t, behavior_component, scratchpad, action_data)
...
function BtRunAwayAction:_start_effect_template(unit, scratchpad, action_data)
...
function BtRunAwayAction:_stop_effect_template(scratchpad)
