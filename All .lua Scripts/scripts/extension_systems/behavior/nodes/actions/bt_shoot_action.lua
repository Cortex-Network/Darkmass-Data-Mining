...
function BtShootAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtShootAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtShootAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	local state = scratchpad.state
...
function BtShootAction:_start_aiming(unit, t, scratchpad, action_data)
...
function BtShootAction:_update_aim_turning(unit, scratchpad, aim_dot, flat_to_target, aim_rotation_anims)
...
function BtShootAction:_update_aiming(unit, t, scratchpad, action_data)
...
function BtShootAction:_start_shooting(unit, t, scratchpad, action_data)
...
function BtShootAction:_update_shooting(unit, t, scratchpad, action_data)
...
function BtShootAction:_try_start_strafe_shooting(unit, t, scratchpad, action_data, breed)
...
function BtShootAction:_update_trying_to_strafe_shoot(unit, t, scratchpad, action_data)
	local navigation_extension = scratchpad.navigation_extension
...
function BtShootAction:_update_strafe_shooting(unit, t, scratchpad, action_data)
	local navigation_extension = scratchpad.navigation_extension
	local is_following_path = navigation_extension:is_following_path()
...
function BtShootAction:_stop_strafe_shooting(unit, t, scratchpad, action_data)
	scratchpad.navigation_extension:set_enabled(false)
...
function BtShootAction:_start_cooldown(unit, t, scratchpad, action_data, optional_cooldown_duration)
	local cooldown_range = action_data.shoot_cooldown
...
function BtShootAction:_update_cooldown(unit, t, scratchpad, action_data, breed)
	local target_unit = scratchpad.perception_component.target_unit
...
function BtShootAction:_has_clear_shot(unit, scratchpad, action_data)
	local perception_component = scratchpad.perception_component
	local target_unit = perception_component.target_unit
