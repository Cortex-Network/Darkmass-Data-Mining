...
function BtShootLiquidBeamAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtShootLiquidBeamAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtShootLiquidBeamAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtShootLiquidBeamAction:_start_aiming(unit, t, scratchpad, action_data)
...
function BtShootLiquidBeamAction:_update_aim_turning(unit, scratchpad, action_data, aim_dot, flat_to_target, aim_rotation_anims)
	if not aim_dot then
		return false
	end
...
function BtShootLiquidBeamAction:_rotate_towards_target_unit(unit, scratchpad)
	local target_unit = scratchpad.perception_component.target_unit
...
function BtShootLiquidBeamAction:_update_aiming(unit, t, dt, scratchpad, action_data)
...
function BtShootLiquidBeamAction:_start_shooting(unit, t, scratchpad, action_data)
...
function BtShootLiquidBeamAction:_update_shooting(unit, t, dt, scratchpad, action_data)
...
function BtShootLiquidBeamAction:_update_shooting_liquid_beam(unit, t, dt, scratchpad, action_data)
...
function BtShootLiquidBeamAction:_update_liquid_beam_positions(dt, scratchpad, action_data, from_position, to_position)
...
function BtShootLiquidBeamAction:_start_effect_template(unit, scratchpad, action_data)
...
function BtShootLiquidBeamAction:_stop_effect_template(scratchpad)
...
function BtShootLiquidBeamAction:_set_game_object_field(scratchpad, key, value)
...
function BtShootLiquidBeamAction:_get_from_shoot_pos(unit, scratchpad, action_data)
	local nav_world = scratchpad.nav_world
...
function BtShootLiquidBeamAction:_get_to_shoot_pos(unit, scratchpad, action_data)
...
function BtShootLiquidBeamAction:_ray_cast(physics_world, from, direction, distance, action_data)
...
function BtShootLiquidBeamAction:_shoot_sphere_cast(unit, t, shoot_position, scratchpad, action_data)
	...
	HitScan.process_hits(true, world, physics_world, unit, shoot_template, hits, from_position, shoot_direction, power_level, charge_level, IMPACT_FX_DATA, distance, nil, , , , , )
...
function BtShootLiquidBeamAction:_try_get_trajectory(scratchpad, action_data, from_position, to_position)
...
function BtShootLiquidBeamAction:_get_from_position(unit, scratchpad, action_data)
...
function BtShootLiquidBeamAction:_calculate_control_points(scratchpad, segments, total_length, dt)
...
function BtShootLiquidBeamAction:_stop_liquid_beam(unit, scratchpad, blackboard)
