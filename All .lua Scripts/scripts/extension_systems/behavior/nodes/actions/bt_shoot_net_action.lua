...
function BtShootNetAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtShootNetAction:init_values(blackboard, action_data, node_data)
	local behavior_component = Blackboard.write_component(blackboard, "behavior")
...
function BtShootNetAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtShootNetAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtShootNetAction:_start_aiming(t, scratchpad, action_data)
...
function BtShootNetAction:_update_aiming(unit, t, scratchpad, action_data)
...
function BtShootNetAction:_start_shooting(unit, scratchpad, action_data)
	local target_unit = scratchpad.perception_component.target_unit
...
function BtShootNetAction:_update_shooting(unit, breed, dt, t, scratchpad, action_data)
...
function BtShootNetAction:_evaluate_collision(action_data, hit_unit, new_sweep_position)
...
function BtShootNetAction:_start_dragging(unit, t, scratchpad, action_data, hit_unit)
...
function BtShootNetAction:_update_dragging(unit, t, scratchpad, action_data)
...
function BtShootNetAction:_play_wwise_event(event, scratchpad, action_data)
...
function BtShootNetAction:_start_effect_template(unit, scratchpad, action_data)
...
function BtShootNetAction:_stop_effect_template(scratchpad)
...
function BtShootNetAction:_get_lag_compensation(hit_unit)
	local lag_t = 0
