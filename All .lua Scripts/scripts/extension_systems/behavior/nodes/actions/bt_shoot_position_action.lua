...
function BtShootPositionAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtShootPositionAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtShootPositionAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	local state = scratchpad.state
...
function BtShootPositionAction:_start_aiming(unit, t, scratchpad, action_data)
...
function BtShootPositionAction:_update_aim_turning(unit, scratchpad, aim_dot, flat_to_target, aim_rotation_anims)
...
function BtShootPositionAction:_update_aiming(unit, t, scratchpad, action_data)
	local target_position = scratchpad.perception_component.target_position:unbox()
...
function BtShootPositionAction:_start_shooting(unit, t, scratchpad, action_data)
...
function BtShootPositionAction:_update_shooting(unit, t, scratchpad, action_data)
	local target_position = scratchpad.perception_component.target_position:unbox()
