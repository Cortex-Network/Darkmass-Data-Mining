...
function BtSmashObstacleAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtSmashObstacleAction:_start_rotate_towards_exit(unit, scratchpad, action_data, t)
...
function BtSmashObstacleAction:_start_attack_anim(unit, blackboard, scratchpad, action_data, t)
...
function BtSmashObstacleAction:_hit_target(unit, breed, target_unit, action_data)
...
function BtSmashObstacleAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtSmashObstacleAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
