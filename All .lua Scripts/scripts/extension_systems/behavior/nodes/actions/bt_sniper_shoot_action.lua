...
function BtSniperShootAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtSniperShootAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtSniperShootAction:init_values(blackboard, action_data, node_data)
	local perception_component = Blackboard.write_component(blackboard, "perception")
	perception_component.has_good_last_los_position = false
end

function BtSniperShootAction:_calculate_aim_animation_type(unit, scratchpad, action_data)
...
function BtSniperShootAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtSniperShootAction:_start_aiming(unit, t, scratchpad, action_data)
...
function BtSniperShootAction:_update_aiming(unit, t, dt, scratchpad, action_data)
...
function BtSniperShootAction:_aim(unit, t, dt, scratchpad, action_data)
	local target_unit = scratchpad.perception_component.target_unit
	local perception_extension = scratchpad.perception_extension
...
function BtSniperShootAction:_ray_cast(scratchpad, from, to, distance)
	local target_unit = scratchpad.perception_component.target_unit
...
function BtSniperShootAction:_start_shooting(unit, t, scratchpad, action_data)
...
function BtSniperShootAction:_update_shooting(unit, t, dt, scratchpad, action_data)
...
function BtSniperShootAction:_start_cooldown(unit, t, scratchpad, action_data)
	MinionPerception.set_target_lock(unit, scratchpad.perception_component, false)
...
function BtSniperShootAction:_update_cooldown(unit, t, dt, scratchpad, action_data)
	self:_aim(unit, t, dt, scratchpad, action_data)
...
function BtSniperShootAction:_create_bot_threat(unit, target_unit)
