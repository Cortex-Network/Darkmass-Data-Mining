...
function BtStaggerAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtStaggerAction:init_values(blackboard)
...
function BtStaggerAction:_select_stagger_anim_and_rotation(unit, impact_vector, stagger_anims, blackboard, action_data)
...
function BtStaggerAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtStaggerAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
	local stagger_component = blackboard.stagger
	local num_triggered_staggers = stagger_component.num_triggered_staggers
