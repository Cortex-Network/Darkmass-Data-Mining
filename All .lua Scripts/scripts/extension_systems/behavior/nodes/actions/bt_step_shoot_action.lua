...
function BtStepShootAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtStepShootAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
function BtStepShootAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtStepShootAction:_start_stepping(unit, t, scratchpad, action_data, blackboard)
	local navigation_extension = scratchpad.navigation_extension
...
function BtStepShootAction:_update_shooting(unit, t, scratchpad, action_data)
...
function BtStepShootAction:_aim_at_target(unit, scratchpad)
