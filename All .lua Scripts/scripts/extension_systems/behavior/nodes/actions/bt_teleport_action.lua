...
function BtTeleportAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtTeleportAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
	if not scratchpad.failed_to_use_smart_object then
		scratchpad.navigation_extension:use_smart_object(false)
	end
end

function BtTeleportAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
