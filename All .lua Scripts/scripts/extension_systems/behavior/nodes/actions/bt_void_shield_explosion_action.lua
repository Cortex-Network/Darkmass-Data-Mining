...
function BtVoidShieldExplosionAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtVoidShieldExplosionAction:leave(unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
	self:_stop_effect_template(scratchpad)
end

function BtVoidShieldExplosionAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtVoidShieldExplosionAction:_start_attack(t, unit, scratchpad, action_data)
...
function BtVoidShieldExplosionAction:_update_attacking(t, unit, scratchpad, action_data)
...
function BtVoidShieldExplosionAction:_deal_damage(t, unit, action_data)
...
function BtVoidShieldExplosionAction:_start_effect_template(unit, scratchpad, action_data)
...
function BtVoidShieldExplosionAction:_stop_effect_template(scratchpad)
