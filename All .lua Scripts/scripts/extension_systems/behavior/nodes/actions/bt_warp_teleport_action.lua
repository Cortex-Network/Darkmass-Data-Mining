...
function BtWarpTeleportAction:enter(unit, breed, blackboard, scratchpad, action_data, t)
...
function BtWarpTeleportAction:run(unit, breed, blackboard, scratchpad, action_data, dt, t)
...
function BtWarpTeleportAction:_calculate_randomized_teleport_directions(action_data)
...
function BtWarpTeleportAction:_find_teleport_position(unit, scratchpad, action_data)
...
function BtWarpTeleportAction:_teleport(unit, scratchpad, action_data, t)
