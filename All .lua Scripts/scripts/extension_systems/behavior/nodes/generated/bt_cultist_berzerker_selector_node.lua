...
local BtCultistBerzerkerSelectorNode = class("BtCultistBerzerkerSelectorNode", "BtNode")

function BtCultistBerzerkerSelectorNode:init(...)
	BtCultistBerzerkerSelectorNode.super.init(self, ...)

	self._children = {}
end

function BtCultistBerzerkerSelectorNode:init_values(blackboard, action_data, node_data)
	BtCultistBerzerkerSelectorNode.super.init_values(self, blackboard, action_data, node_data)
...
function BtCultistBerzerkerSelectorNode:add_child(node)
	self._children[#self._children + 1] = node
end

function BtCultistBerzerkerSelectorNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
function BtCultistBerzerkerSelectorNode:run(unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtCultistBerzerkerSelectorNode
