...
local BtCultistFlamerSelectorNode = class("BtCultistFlamerSelectorNode", "BtNode")

function BtCultistFlamerSelectorNode:init(...)
	BtCultistFlamerSelectorNode.super.init(self, ...)

	self._children = {}
end

function BtCultistFlamerSelectorNode:init_values(blackboard, action_data, node_data)
	BtCultistFlamerSelectorNode.super.init_values(self, blackboard, action_data, node_data)
...
function BtCultistFlamerSelectorNode:add_child(node)
	self._children[#self._children + 1] = node
end

function BtCultistFlamerSelectorNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
function BtCultistFlamerSelectorNode:run(unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtCultistFlamerSelectorNode
