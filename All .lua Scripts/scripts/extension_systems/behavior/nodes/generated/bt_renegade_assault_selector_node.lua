...
local BtRenegadeAssaultSelectorNode = class("BtRenegadeAssaultSelectorNode", "BtNode")

function BtRenegadeAssaultSelectorNode:init(...)
	BtRenegadeAssaultSelectorNode.super.init(self, ...)

	self._children = {}
end

function BtRenegadeAssaultSelectorNode:init_values(blackboard, action_data, node_data)
	BtRenegadeAssaultSelectorNode.super.init_values(self, blackboard, action_data, node_data)
...
function BtRenegadeAssaultSelectorNode:add_child(node)
	self._children[#self._children + 1] = node
end

function BtRenegadeAssaultSelectorNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	local node_far_combat = children[9]
...
function BtRenegadeAssaultSelectorNode:run(unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtRenegadeAssaultSelectorNode
