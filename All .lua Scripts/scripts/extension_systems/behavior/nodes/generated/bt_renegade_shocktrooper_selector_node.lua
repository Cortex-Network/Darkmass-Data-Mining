...
local BtRenegadeShocktrooperSelectorNode = class("BtRenegadeShocktrooperSelectorNode", "BtNode")

function BtRenegadeShocktrooperSelectorNode:init(...)
	BtRenegadeShocktrooperSelectorNode.super.init(self, ...)

	self._children = {}
end

function BtRenegadeShocktrooperSelectorNode:init_values(blackboard, action_data, node_data)
	BtRenegadeShocktrooperSelectorNode.super.init_values(self, blackboard, action_data, node_data)
...
function BtRenegadeShocktrooperSelectorNode:add_child(node)
	self._children[#self._children + 1] = node
end

function BtRenegadeShocktrooperSelectorNode:evaluate(unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	if condition_result then
		new_running_child_nodes[node_identifier] = node_assault
...
function BtRenegadeShocktrooperSelectorNode:run(unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtRenegadeShocktrooperSelectorNode
