...
function BtEnterHooks.set_scratchpad_value(unit, breed, blackboard, scratchpad, action_data, t, args)
	local field = args.field
	local value = args.value
	scratchpad[field] = value
end

function BtEnterHooks.captain_charge_enter(unit, breed, blackboard, scratchpad, action_data, t, args)
	local phase_component = Blackboard.write_component(blackboard, "phase")
	phase_component.lock = true
end

function BtEnterHooks.captain_grenade_enter(unit, breed, blackboard, scratchpad, action_data, t, args)
	local animation_extension = ScriptUnit.extension(unit, "animation_system")
...
function BtEnterHooks.bulwark_climb_enter(unit, breed, blackboard, scratchpad, action_data, t, args)
	local shield_extension = ScriptUnit.extension(unit, "shield_system")
...
function BtEnterHooks.unwield_slot(unit, breed, blackboard, scratchpad, action_data, t, args)
	local slot_name = args.slot_name
	local visual_loadout_extension = ScriptUnit.extension(unit, "visual_loadout_system")
...
function BtEnterHooks.beast_of_nurgle_stagger_enter(unit, breed, blackboard, scratchpad, action_data, t, args)
