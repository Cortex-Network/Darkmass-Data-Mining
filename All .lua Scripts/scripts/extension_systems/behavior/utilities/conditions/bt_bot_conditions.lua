...
function conditions.can_activate_ability(unit, blackboard, scratchpad, condition_args, action_data, is_running)
...
function conditions.is_disabled(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local unit_data_extension = ScriptUnit.extension(unit, "unit_data_system")
...
function conditions._is_there_threat_to_aid(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
...
function conditions._has_reached_ally_aid_destination(unit, blackboard, scratchpad, condition_args, action_data, is_running)
...
function conditions._has_reached_level_unit_destination(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local navigation_extension = ScriptUnit.extension(unit, "navigation_system")
	local destination = navigation_extension:destination()
	local behavior_component = blackboard.behavior
...
function conditions.can_revive(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
	local behavior_component = blackboard.behavior
...
function conditions.can_remove_net(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
	local behavior_component = blackboard.behavior
	local target_ally = perception_component.target_ally
...
function conditions.can_rescue_hogtied(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
	local behavior_component = blackboard.behavior
	local target_ally = perception_component.target_ally
...
function conditions.can_use_health_station(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
	local behavior_component = blackboard.behavior
...
function conditions.can_rescue_ledge_hanging(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
	local behavior_component = blackboard.behavior
	local target_ally = perception_component.target_ally
...
function conditions.can_loot(unit, blackboard, scratchpad, condition_args, action_data, is_running)
...
function conditions.is_slot_not_wielded(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local unit_data_extension = ScriptUnit.extension(unit, "unit_data_system")
...
function conditions.wrong_slot_for_target_type(unit, blackboard, scratchpad, condition_args, action_data, is_running)
...
function conditions.has_priority_or_urgent_target(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
...
function conditions.bot_in_melee_range(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
	local target_enemy = perception_component.target_enemy
...
function conditions.has_target(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
	local target_enemy = perception_component.target_enemy
...
function conditions.has_target_and_ammo_greater_than(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
	local target_enemy = perception_component.target_enemy
...
function conditions.should_reload(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
	local target_enemy_type = perception_component.target_enemy_type
...
function conditions.should_vent_overheat(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local perception_component = blackboard.perception
	local target_enemy_type = perception_component.target_enemy_type
...
function conditions.cant_reach_ally(unit, blackboard, scratchpad, condition_args, action_data, is_running)
...
function conditions.is_too_far_from_ally(unit, blackboard, scratchpad, condition_args, action_data, is_running)
	local group_extension = ScriptUnit.extension(unit, "group_system")
	local bot_group_data = group_extension:bot_group_data()
	local follow_unit = bot_group_data.follow_unit
	local follow_component = blackboard.follow
