...
function Buff:init(context, template, start_time, instance_id, ...)
...
function Buff:_calculate_template_override_data(template_context)
	local override_data = {}
...
function Buff:_calculate_override_data(override_data, item_slot_name, parent_buff_template_or_nil)
...
function Buff:set_buff_component(buff_component, component_keys, component_index)
	local template = self._template
	local start_time = self._start_time
...
function Buff:remove_buff_component()
...
function Buff:update(dt, t, portable_random)
...
function Buff:refresh_func(t, previous_stack_count)
	local template = self._template
...
function Buff:instance_id()
	return self._instance_id
end

function Buff:component_index()
	return self._component_index
end

function Buff:is_predicted()
	local template = self._template
...
function Buff:force_predicted_proc()
	return false
end

function Buff:stack_count()
	local template_context = self._template_context
...
function Buff:stat_buff_stacking_count()
	local stack_count = self:stack_count()
...
function Buff:visual_stack_count()
	local template = self._template
...
function Buff:set_stack_count(wanted_stack_count)
...
function Buff:duration_progress()
	return self._duration_progress
end

function Buff:template_name()
	local template = self._template

	return template.name
end

function Buff:template()
	local template = self._template

	return template
end

function Buff:start_time()
	return self._start_time
end

function Buff:set_start_time(start_time)
	self._start_time = start_time
...
function Buff:buff_lerp_value()
	return self._template_context.buff_lerp_value
end

function Buff:item_slot_name()
	return self._template_context.item_slot_name
end

function Buff:parent_buff_template()
	return self._template_context.parent_buff_template
end

function Buff:_calculate_stat_buffs(current_stat_buffs, stat_buffs)
...
function Buff:update_stat_buffs(current_stat_buffs, t)
	local template = self._template
...
function Buff:update_keywords(current_key_words, t)
	local template = self._template
...
function Buff:template_context()
