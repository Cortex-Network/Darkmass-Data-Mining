...
function GrimoireBuff:init(context, template, start_time, instance_id, ...)
...
function GrimoireBuff:update(dt, t, portable_random)
...
function GrimoireBuff:_player_has_grimoire_equipped(player)
...
function GrimoireBuff:_damage_player(power_level)
