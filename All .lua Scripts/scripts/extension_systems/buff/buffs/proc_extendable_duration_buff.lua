...
function ProcExtendableDurationBuff:init(context, template, start_time, instance_id, ...)
	ProcExtendableDurationBuff.super.init(self, context, template, start_time, instance_id, ...)
end

function ProcExtendableDurationBuff:update_proc_events(t, proc_events, num_proc_events, portable_random, local_portable_random)
...
function ProcExtendableDurationBuff:duration()
	local template = self._template
