...
function SpecialRulesBasedLerpedStatBuff:init(context, template, start_time, instance_id, ...)
...
function SpecialRulesBasedLerpedStatBuff:update_stat_buffs(current_stat_buffs, t)
