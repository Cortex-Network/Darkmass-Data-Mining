...
function VeteranRangerStanceBuff:init(context, template, start_time, instance_id, ...)
	VeteranRangerStanceBuff.super.init(self, context, template, start_time, instance_id, ...)
end

function VeteranRangerStanceBuff:update_proc_events(t, proc_events, num_proc_events, portable_random, local_portable_random)
...
function VeteranRangerStanceBuff:duration()
	local template_data = self._template_data
...
function VeteranRangerStanceBuff:duration_progress()
	local template_data = self._template_data
