...
function WeaponTraitActivatedParentProcBuff:init(context, template, start_time, instance_id, ...)
	WeaponTraitActivatedParentProcBuff.super.init(self, context, template, start_time, instance_id, ...)

	self._active = false
end

function WeaponTraitActivatedParentProcBuff:update_proc_events(t, proc_events, num_proc_events, portable_random, local_portable_random)
