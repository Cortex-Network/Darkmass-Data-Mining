...
function WeaponTraitParentProcBuff:init(context, template, start_time, ...)
...
function WeaponTraitParentProcBuff:destroy()
...
function WeaponTraitParentProcBuff:update_proc_events(t, proc_events, num_proc_events, portable_random, local_portable_random)
...
function WeaponTraitParentProcBuff:update(dt, t, ...)
...
function WeaponTraitParentProcBuff:_add_child_buff_stack(t, num_children_to_add)
	local buff_extension = self._buff_extension
...
function WeaponTraitParentProcBuff:_remove_child_buff_stack(num_children_to_remove)
	local buff_extension = self._buff_extension
	local child_buff_indicies = self._child_buff_indicies
	local num_child_stacks = self._num_child_stacks
