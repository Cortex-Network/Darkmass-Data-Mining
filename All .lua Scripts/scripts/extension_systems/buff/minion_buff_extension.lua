...
function MinionBuffExtension:init(extension_init_context, unit, extension_init_data, game_object_data_or_game_session, nil_or_game_object_id)
...
function MinionBuffExtension:hot_join_sync(unit, sender, channel)
...
function MinionBuffExtension:update(unit, dt, t)
...
function MinionBuffExtension:request_proc_event_param_table()
...
function MinionBuffExtension:_on_add_buff(buff_instance)
...
function MinionBuffExtension:_on_remove_buff(buff_instance)
...
function MinionBuffExtension:_post_on_remove_buff(buff_instance)
...
function MinionBuffExtension:add_proc_event(event, params)
...
function MinionBuffExtension:add_internally_controlled_buff(template_name, t, ...)
...
function MinionBuffExtension:add_externally_controlled_buff(template_name, t, ...)
...
function MinionBuffExtension:remove_externally_controlled_buff(local_index)
...
function MinionBuffExtension:_remove_internally_controlled_buff(local_index)
	local buff_instance = self._buffs_by_index[local_index]
...
function MinionBuffExtension:_start_fx(index, template)
...
function MinionBuffExtension:_stop_fx(index, template)
	local minion_effects = template.minion_effects
