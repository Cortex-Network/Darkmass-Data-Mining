...
function PlayerUnitCameraExtension:init(extension_init_context, unit, extension_init_data, game_object_data_or_game_session, nil_or_game_object_id)
	self._unit = unit
...
function PlayerUnitCameraExtension:fixed_update(unit, dt, t)
	self:_evaluate_camera_tree()
end
...
function PlayerUnitCameraExtension:_evaluate_camera_tree()
...
function PlayerUnitCameraExtension:camera_tree_node()
	return self._tree, self._node, self._object, self._ignore_offset
end

function PlayerUnitCameraExtension:trigger_camera_shake(event_name, optional_will_be_predicted)
