...
function PlayerCharacterStateBase:init(character_state_init_context, name)
	self.name = name
...
function PlayerCharacterStateBase:extensions_ready(world, unit)
...
function PlayerCharacterStateBase:game_object_initialized(game_session, game_object_id)
...
function PlayerCharacterStateBase:_is_colliding_with_gameplay_collision_box(unit, collision_filter, capsule_radius, vertical_offset, use_world_up)
...
function PlayerCharacterStateBase:_should_climb_ladder(unit, t)
...
function PlayerCharacterStateBase:_should_hang_on_ledge(unit, t)
...
function PlayerCharacterStateBase:_update_move_method(movement_state_component, velocity_current, moving_backwards, wants_move, stopped, anim_extension, previous_frame_state)
