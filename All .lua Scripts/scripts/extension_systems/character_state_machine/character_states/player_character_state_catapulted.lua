...
function PlayerCharacterStateCatapulted:on_enter(unit, dt, t, previous_state, params)
...
function PlayerCharacterStateCatapulted:_trigger_anim_event(direction, reason)
...
function PlayerCharacterStateCatapulted:on_exit(unit, t, next_state)
...
function PlayerCharacterStateCatapulted:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateCatapulted:_check_transition(unit, t, next_state_params)
