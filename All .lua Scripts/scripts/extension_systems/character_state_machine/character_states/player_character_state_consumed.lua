...
function PlayerCharacterStateConsumed:init(character_state_init_context, ...)
...
function PlayerCharacterStateConsumed:on_enter(unit, dt, t, previous_state, params)
...
function PlayerCharacterStateConsumed:_add_buffs(t)
...
function PlayerCharacterStateConsumed:_remove_buffs()
	local buff_extension = self._buff_extension
...
function PlayerCharacterStateConsumed:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateConsumed:_check_transition(unit, t, next_state_params)
