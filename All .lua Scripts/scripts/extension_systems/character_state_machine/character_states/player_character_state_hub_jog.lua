...
function PlayerCharacterStateHubJog:init(character_state_init_context, ...)
...
function PlayerCharacterStateHubJog:_update_move_state(hub_jog_character_state, input_extension, anim_extension, move_speed, wants_to_stop, dt, t)
	local hub_movement_settings = HubMovementLocomotion.fetch_movement_settings(self._unit, self._constants, hub_jog_character_state)
	local shared_movement_settings = hub_movement_settings.shared
...
function PlayerCharacterStateHubJog:_wanted_movement(unit, move_state_movement_settings, shared_movement_settings, input_extension, velocity_current, first_person, hub_jog_character_state, old_move_x, old_move_y, dt, t)
...
function PlayerCharacterStateHubJog:_input_to_move_direction(x, y, first_person_component)
...
function PlayerCharacterStateHubJog:_current_direction(locomotion_component)
...
function PlayerCharacterStateHubJog:_move_direction(wanted_move_direction, current_move_direction, wanted_x, wanted_y, moving, move_state_movement_settings, shared_movement_settings)
...
function PlayerCharacterStateHubJog:_update_move_method(move_state, hub_jog_character_state, locomotion, locomotion_steering, stopping, wants_move, wants_turn_on_spot, anim_extension, velocity_wanted, velocity_current, t)
...
function PlayerCharacterStateHubJog:_update_mini_emotes(input_extension)
end
...
function PlayerCharacterStateHubJog:_update_emotes(input_extension)
...
function PlayerCharacterStateHubJog:_update_camera(unit, dt, t, move_state, move_method, first_person, locomotion)
...
function PlayerCharacterStateHubJog:_check_transition(unit, t, next_state_params, input_source)
end
