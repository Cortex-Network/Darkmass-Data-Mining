...
function PlayerCharacterStateInteracting:init(character_state_init_context, ...)
...
function PlayerCharacterStateInteracting:fixed_update(unit, dt, t, next_state_params, fixed_frame)
	return self:_check_transition(unit, t, next_state_params)
end

function PlayerCharacterStateInteracting:_check_transition(unit, t, next_state_params)
