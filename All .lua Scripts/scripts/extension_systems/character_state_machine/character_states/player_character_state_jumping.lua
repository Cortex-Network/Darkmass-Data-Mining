...
function PlayerCharacterStateJumping:init(...)
...
function PlayerCharacterStateJumping:_play_jump_animation(animation_extension)
...
function PlayerCharacterStateJumping:on_enter(unit, dt, t, previous_state, params)
...
function PlayerCharacterStateJumping:on_exit(unit, t, next_state)
...
function PlayerCharacterStateJumping:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateJumping:_check_transition(unit, t, next_state_params, input_source, velocity_current)
