...
function PlayerCharacterStateKnockedDown:init(character_state_init_context, ...)
...
function PlayerCharacterStateKnockedDown:extensions_ready(world, unit)
...
function PlayerCharacterStateKnockedDown:game_object_initialized(game_session, game_object_id)
...
function PlayerCharacterStateKnockedDown:_check_transition(unit, dt, t, next_state_params, assist_done)
	local unit_data_extension = self._unit_data_extension
...
function PlayerCharacterStateKnockedDown:_init_vo(t)
...
function PlayerCharacterStateKnockedDown:_update_vo(t)
...
function PlayerCharacterStateKnockedDown:_stop_movement(t)
...
function PlayerCharacterStateKnockedDown:_enter_third_person_mode(t)
	local first_person_mode_component = self._first_person_mode_component

	FirstPersonView.exit(t, first_person_mode_component)
end

function PlayerCharacterStateKnockedDown:_exit_third_person_mode(t)
	local unit = self._unit
	local locomotion_force_rotation = self._locomotion_force_rotation_component
...
function PlayerCharacterStateKnockedDown:_add_buffs(t)
...
function PlayerCharacterStateKnockedDown:_remove_buffs()
	local buff_extension = self._buff_extension
