...
function PlayerCharacterStateLadderTopLeaving:fixed_update(unit, dt, t, next_state_params, fixed_frame)
	local ladder_character_state_component = self._ladder_character_state_component
...
function PlayerCharacterStateLadderTopLeaving:_check_transition(t, next_state_params)
