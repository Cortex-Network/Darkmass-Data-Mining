...
function PlayerCharacterStateLedgeHanging:init(character_state_init_context, ...)
...
function PlayerCharacterStateLedgeHanging:extensions_ready(world, unit)
...
function PlayerCharacterStateLedgeHanging:game_object_initialized(game_session, game_object_id)
...
function PlayerCharacterStateLedgeHanging:on_enter(unit, dt, t, previous_state, params)
...
function PlayerCharacterStateLedgeHanging:on_exit(unit, t, next_state)
...
function PlayerCharacterStateLedgeHanging:update(unit, dt, t)
	self:_update_ledge_hanging(unit, t)
	self:_update_hands_ik_state(unit, t)
end

function PlayerCharacterStateLedgeHanging:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateLedgeHanging:_check_transition(unit, t, next_state_params, assist_done)
...
function PlayerCharacterStateLedgeHanging:_initialize_position_transition(unit, hang_ledge_unit, t)
...
function PlayerCharacterStateLedgeHanging:_initialize_rotation_transition(unit, hang_ledge_unit, t)
...
function PlayerCharacterStateLedgeHanging:_initialize_force_rotation(unit, t)
...
function PlayerCharacterStateLedgeHanging:_initialize_hands_ik(unit)
...
function PlayerCharacterStateLedgeHanging:_on_enter_animation(unit, t)
...
function PlayerCharacterStateLedgeHanging:_reset_locomotion()
	local locomotion_steering = self._locomotion_steering_component
...
function PlayerCharacterStateLedgeHanging:_update_ledge_hanging(unit, t)
...
function PlayerCharacterStateLedgeHanging:_update_hands_ik_state(unit, t)
...
function PlayerCharacterStateLedgeHanging:_update_transition_to_hanging(unit, t)
	local ledge_hanging_character_state_component = self._ledge_hanging_character_state_component
