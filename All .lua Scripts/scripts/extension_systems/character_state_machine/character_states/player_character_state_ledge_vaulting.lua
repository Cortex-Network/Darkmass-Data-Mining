...
function PlayerCharacterStateLedgeVaulting:init(character_state_init_context, ...)
...
function PlayerCharacterStateLedgeVaulting:on_enter(unit, dt, t, previous_state, params)
...
function PlayerCharacterStateLedgeVaulting:_play_on_enter_vault_event(ledge_mid_point, ledge_material_or_nil)
	...
	self._fx_extension:trigger_wwise_event_synced(event_name, append_husk_to_event_name, is_predicted, nil, , , ledge_mid_point, nil, , , switch_name, switch_value)
end

function PlayerCharacterStateLedgeVaulting:on_exit(unit, t, next_state)
	local ledge_vaulting = self._ledge_vaulting_character_state_component
	local animation_extension = self._animation_extension
...
function PlayerCharacterStateLedgeVaulting:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateLedgeVaulting:_check_transition(unit, t, next_state_params, passed_by_ledge, weapon_template)
