...
function PlayerCharacterStateMutantCharged:init(character_state_init_context, ...)
...
function PlayerCharacterStateMutantCharged:on_enter(unit, dt, t, previous_state, params)
...
function PlayerCharacterStateMutantCharged:on_exit(unit, t, next_state)
	local locomotion_force_rotation_component = self._locomotion_force_rotation_component
...
function PlayerCharacterStateMutantCharged:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateMutantCharged:_check_transition(unit, t, next_state_params)
