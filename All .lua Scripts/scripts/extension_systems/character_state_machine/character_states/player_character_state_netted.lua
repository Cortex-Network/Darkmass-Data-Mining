...
function PlayerCharacterStateNetted:init(character_state_init_context, ...)
...
function PlayerCharacterStateNetted:extensions_ready(world, unit)
...
function PlayerCharacterStateNetted:game_object_initialized(game_session, game_object_id)
...
function PlayerCharacterStateNetted:on_enter(unit, dt, t, previous_state, params)
...
function PlayerCharacterStateNetted:on_exit(unit, t, next_state)
	local disabled_character_state_component = self._disabled_character_state_component
	local fx_extension = self._fx_extension
...
function PlayerCharacterStateNetted:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateNetted:_update_netted(unit, dt, t)
...
function PlayerCharacterStateNetted:_check_transition(unit, t, next_state_params, assist_done)
...
function PlayerCharacterStateNetted:_init_player_vo(t)
	self._next_vo_trigger_time_t = t + DialogueSettings.netted_vo_start_delay_t
	self._vo_sequence = 1
end

function PlayerCharacterStateNetted:_update_drag(unit, dt, t, target_drag_position)
	local locomotion_component = self._locomotion_component
...
function PlayerCharacterStateNetted:_is_stuck(current_position)
...
function PlayerCharacterStateNetted:_on_drag_completed(t)
	FirstPersonView.exit(t, self._first_person_mode_component)
...
function PlayerCharacterStateNetted:_add_buffs(t)
	local constants = self._constants
...
function PlayerCharacterStateNetted:_remove_buffs()
	local buff_extension = self._buff_extension
...
function PlayerCharacterStateNetted:_update_vo(t)
