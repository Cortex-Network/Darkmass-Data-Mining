...
function PlayerCharacterStateSprinting:init(...)
...
function PlayerCharacterStateSprinting:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateSprinting:_check_transition(unit, t, next_state_params, input_source, decreasing_speed, move_speed, action_move_speed_modifier, sprint_momentum, wants_slide, wants_to_stop, has_input)
...
function PlayerCharacterStateSprinting:_wanted_movement(dt, sprint_character_state_component, input_source, locomotion_steering, locomotion, movement_settings_component, first_person_component, wants_sprint, weapon_extension, stat_buffs, t)
...
function PlayerCharacterStateSprinting:_check_bump_sound(locomotion, locomotion_steering, specialization_sprint_template, constants)
