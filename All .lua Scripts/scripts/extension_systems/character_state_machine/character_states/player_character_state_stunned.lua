...
function PlayerCharacterStateStunned:init(character_state_init_context, ...)
...
function PlayerCharacterStateStunned:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateStunned:_play_end_animation()
...
function PlayerCharacterStateStunned:_check_transition(unit, t, next_state_params, switched_to_melee_while_interrupted)
