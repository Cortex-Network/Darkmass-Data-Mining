...
function PlayerCharacterStateWalking:init(character_state_init_context, ...)
...
function PlayerCharacterStateWalking:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateWalking:_check_transition(unit, t, next_state_params, input_source, wants_slide)
