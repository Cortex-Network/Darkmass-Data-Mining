...
function PlayerCharacterStateWarpGrabbed:init(character_state_init_context, ...)
...
function PlayerCharacterStateWarpGrabbed:fixed_update(unit, dt, t, next_state_params, fixed_frame)
...
function PlayerCharacterStateWarpGrabbed:_check_transition(unit, t, next_state_params)
