...
function Assist:init(anim_settings, is_server, unit, game_session_or_nil, game_object_id_or_nil)
...
function Assist:game_object_initialized(game_session, game_object_id)
	self._game_session = game_session
	self._game_object_id = game_object_id
end

function Assist:update(dt, t)
...
function Assist:_try_assist_start(dt, t, force)
...
function Assist:_update_assist(dt, t)
...
function Assist:_try_start_anim()
	local assisted_state_input_component = self._assisted_state_input_component
...
function Assist:_try_abort_anim()
	local assisted_state_input_component = self._assisted_state_input_component
...
function Assist:in_progress()
	return self._assisted_state_input_component.in_progress
end

function Assist:_synchronize_interaction_duration()
	if self._is_server then
		return
	end
...
function Assist:_update_force_assist(dt)
