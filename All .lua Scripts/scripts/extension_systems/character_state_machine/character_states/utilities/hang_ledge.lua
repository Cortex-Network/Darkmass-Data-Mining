...
function HangLedge.calculate_new_position(hang_ledge_unit, player_position)
...
function HangLedge.calculate_hanging_rotation(hang_ledge_unit)
	local hand_hold_node = Unit.node(hang_ledge_unit, HAND_HOLD_NODE_NAME)
	local hand_hold_rotation = Unit.world_rotation(hang_ledge_unit, hand_hold_node)
...
function HangLedge.calculate_offset_rotation(physics_world, hang_ledge_unit, rotation, target_position)
...
function HangLedge.calculate_falling_start_position(hang_ledge_unit, hanging_unit, distance_from_ledge, player_height)
	local hand_hold_node = Unit.node(hang_ledge_unit, HAND_HOLD_NODE_NAME)
...
function HangLedge.calculate_pull_up_end_position(nav_world, hang_ledge_unit, hanging_unit)
	local hand_hold_node = Unit.node(hang_ledge_unit, HAND_HOLD_NODE_NAME)
	local hand_hold_position = Unit.world_position(hang_ledge_unit, hand_hold_node)
	local hand_hold_rotation = Unit.world_rotation(hang_ledge_unit, hand_hold_node)
	local hanging_unit_position = Unit.local_position(hanging_unit, 1)
