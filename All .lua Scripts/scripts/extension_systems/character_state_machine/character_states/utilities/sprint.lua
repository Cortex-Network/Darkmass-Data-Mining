...
function Sprint.check(t, unit, movement_state_component, sprint_character_state_component, input_source, locomotion_component, weapon_action_component, combat_ability_action_component, alternate_fire_component, weapon_template, player_character_constants)
...
function Sprint.sprint_input(input_source, is_sprinting, sprint_requires_press_to_interrupt)
...
function Sprint.is_sprinting(sprint_character_state_component)
...
function Sprint.is_sprint_dodging(target_unit, attacking_unit, run_away_dodge)
...
function Sprint.requires_press_to_interrupt(action_setting)
...
function Sprint.prevent_sprint(action_setting)
	if not action_setting then
		return false
	end
