...
function UnitCoherencyExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function UnitCoherencyExtension:destroy()
	self._in_coherence_units = {}
	self._num_units_in_coherence = 0
	self._coherency_buff_indexes = {}
...
function UnitCoherencyExtension:update(unit, dt, t)
end

function UnitCoherencyExtension:in_coherence_units()
	return self._in_coherence_units
end

function UnitCoherencyExtension:num_units_in_coherency()
...
function UnitCoherencyExtension:remove_external_buff(index)
	self._free_external_buff_indexes[index] = true
	self._external_buff_template_names[index] = nil
end

function UnitCoherencyExtension:coherency_data()
	return self._coherency_data
end

function UnitCoherencyExtension:coherency_settings()
...
function UnitCoherencyExtension:buff_template_names()
	return self._coherency_settings.buff_template_names
end

function UnitCoherencyExtension:external_buff_template_names()
	return self._external_buff_template_names
end

function UnitCoherencyExtension:base_radius()
	return self._coherency_settings.radius, self._coherency_settings.stickiness_limit
end

function UnitCoherencyExtension:current_radius()
	local modifier = 1
...
function UnitCoherencyExtension:current_stickiness_time()
...
function UnitCoherencyExtension:hot_join_sync(unit, sender, channel_id)
...
function UnitCoherencyExtension:on_coherency_enter(coherency_unit, coherency_extension, t)
...
function UnitCoherencyExtension:on_coherency_exit(coherency_unit, coherency_extension, t)
...
function UnitCoherencyExtension:update_buffs_for_unit(unit, extension)
...
function UnitCoherencyExtension:_calculate_should_be_active_buffs(t)
...
function UnitCoherencyExtension:update_active_buffs(t)
...
function UnitCoherencyExtension:_send_rpc(rpc_name, other_unit)
