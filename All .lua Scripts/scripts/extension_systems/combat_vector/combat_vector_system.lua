...
function CombatVectorSystem:init(...)
...
function CombatVectorSystem:on_gameplay_post_init(level)
...
function CombatVectorSystem:destroy(...)
...
function CombatVectorSystem:update(context, dt, t)
...
function CombatVectorSystem:_reset()
	local nav_mesh_locations = self._nav_mesh_locations
...
function CombatVectorSystem:_update_combat_vector(dt, t)
	local nav_world = self._nav_world
...
function CombatVectorSystem:add_main_aggro_target_score(type, aggro_unit, victim_unit)
	local aggro_unit_scores = self._aggro_unit_scores
...
function CombatVectorSystem:_check_for_locked_in_melee_unit(t)
...
function CombatVectorSystem:get_main_aggro_unit()
	return self._main_aggro_unit
end

function CombatVectorSystem:get_main_aggro_scores()
	return self._aggro_unit_scores
end

function CombatVectorSystem:get_flank_positions()
	return self._flank_positions
end

function CombatVectorSystem:get_flank_direction(vector_type)
	local flank_position = self._flank_positions[vector_type]
...
function CombatVectorSystem:allow_nav_tag_layer(layer_name, layer_allowed)
...
function CombatVectorSystem:is_traverse_logic_initialized()
