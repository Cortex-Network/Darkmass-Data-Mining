...
function CoverUserExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function CoverUserExtension:_init_blackboard_components(blackboard)
...
function CoverUserExtension:extensions_ready(world, unit)
...
function CoverUserExtension:update(unit, dt, t)
...
function CoverUserExtension:_claim_cover_slot(cover_slot)
	local cover_component = self._cover_component
...
function CoverUserExtension:_find_cover_slot(unit, cover_config, target_unit, t)
...
function CoverUserExtension:_validate_cover_slot(cover_slot, cover_config, t)
...
function CoverUserExtension:release_cover_slot(optional_cover_disable_t)
	local current_cover_slot = self._current_cover_slot
...
function CoverUserExtension:cover_slot_id()
	return self._cover_slot_id
end

function CoverUserExtension:has_claimed_cover_slot()
