...
function CutsceneCharacterSystem:init(extension_init_context, system_init_data, ...)
...
function CutsceneCharacterSystem:destroy(...)
...
function CutsceneCharacterSystem:register_cutscene_character(extension)
...
function CutsceneCharacterSystem:unregister_cutscene_character(extension)
...
function CutsceneCharacterSystem:initialize_characters_for_cinematic(cinematic_name)
...
function CutsceneCharacterSystem:uninitialize_characters_for_cinematic(cinematic_name)
...
function CutsceneCharacterSystem:_fetch_players_loadout(cinematic_name)
...
function CutsceneCharacterSystem:_show_player(unique_id)
	local player_manager = Managers.player
...
function CutsceneCharacterSystem:_hide_player_unit(player_unit)
...
function CutsceneCharacterSystem:_on_assign_player_unit_ownership(player, player_unit)
	if self._hide_players then
		self:_hide_player_unit(player_unit)
	end
end

function CutsceneCharacterSystem:_on_player_unit_spawned(player)
	if self._hide_players then
		self:_hide_player_unit(player.player_unit)
	end
end

function CutsceneCharacterSystem:_on_unit_registered(unit)
