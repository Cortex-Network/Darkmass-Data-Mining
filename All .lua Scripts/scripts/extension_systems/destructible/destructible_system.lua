...
function DestructibleSystem:init(extension_system_creation_context, ...)
...
function DestructibleSystem:on_remove_extension(unit, extension_name)
...
function DestructibleSystem:destroy(...)
...
function DestructibleSystem:hot_join_sync(sender, channel)
...
function DestructibleSystem:update_level_props_broadphase()
	local unit_to_extension_map = self._unit_to_extension_map
...
function DestructibleSystem:rpc_sync_destructible(channel_id, unit_id, is_level_unit, destruction_stage, visible, silent_transition)
...
function DestructibleSystem:rpc_destructible_mark_for_deletion(channel_id, level_unit_id)
