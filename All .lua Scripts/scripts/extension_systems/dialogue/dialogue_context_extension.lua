...
function DialogueContextExtension:init(system, unit, extension_init_data, target_context)
...
function DialogueContextExtension:on_remove_extension(unit, extension_name)
end

function DialogueContextExtension:extensions_ready(world, unit)
...
function DialogueContextExtension:update(t)
...
function DialogueContextExtension:_update_player_equipment_context()
...
function DialogueContextExtension:_update_player_unit_status()
	if self._unit then
...
function DialogueContextExtension:_update_extensions_context()
...
function DialogueContextExtension:_update_timed_timers_context(t)
...
function DialogueContextExtension:increase_timed_counter(key, value)
...
function DialogueContextExtension:get_timed_counter(key)
