...
function DialogueExtension:init(dialogue_system, dialogue_system_wwise, extension_per_breed_wwise_voice_index, vo_sources_cache, unit, extension_init_data, wwise_world)
	self.input = self
...
function DialogueExtension:setup_from_component(vo_class, vo_proile_name, use_local_player_voice_profile, dialogue_faction_name, enabled)
...
function DialogueExtension:cleanup()
...
function DialogueExtension:set_voice_source()
...
function DialogueExtension:on_extensions_ready()
...
function DialogueExtension:play_voice_debug(sound_event)
end

function DialogueExtension:trigger_query(event_data)
end
...
function DialogueExtension:stop_currently_playing_vce_event()
...
function DialogueExtension:stop_currently_playing_wwise_event(event_id)
...
function DialogueExtension:play_local_vo_event(rule_name, wwise_route_key, on_play_callback, seed)
...
function DialogueExtension:evaluate_rules(rules, seed)
	local results = {}
...
function DialogueExtension:get_is_incapacitated()
	return self._is_incapacitated
end

function DialogueExtension:get_incapacitate_time()
...
function DialogueExtension:set_faction_breed_name(faction_breed_name)
...
function DialogueExtension:get_status_extension()
	return self._status_extension
end

function DialogueExtension:set_status_extension(status_extension)
...
function DialogueExtension:set_currently_playing_dialogue(currently_playing)
	self._currently_playing_dialogue = currently_playing
end

function DialogueExtension:get_dialogue_timer()
	return self._dialogue_timer
end

function DialogueExtension:set_dialogue_timer(timer)
...
function DialogueExtension:development_temporal_do_not_use_archetype_name()
