...
function DecoderSynchronizerExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function DecoderSynchronizerExtension:setup_from_component(min_time_until_stalling, max_time_until_stalling, num_active_units, stall_once_per_device, objective_name, auto_start, setup_only)
...
function DecoderSynchronizerExtension:destroy()
...
function DecoderSynchronizerExtension:register_connected_units(stage_units)
...
function DecoderSynchronizerExtension:_retrieve_decoder_units(units)
	local decoder_units = {}
...
function DecoderSynchronizerExtension:fixed_update(unit, dt, t)
...
function DecoderSynchronizerExtension:_set_state(state)
	self._current_state = state
end

function DecoderSynchronizerExtension:_get_next_random_stall_time()
...
function DecoderSynchronizerExtension:_get_random_decoding_device()
	local stall_once_per_device = self._stall_once_per_device
...
function DecoderSynchronizerExtension:unblock_decoding_progression()
...
function DecoderSynchronizerExtension:start_event()
...
function DecoderSynchronizerExtension:pause_event()
...
function DecoderSynchronizerExtension:finished_event()
	if self._is_server then
		self._event_active = false
		self._total_active_devices = 0
		self._pause_timer = 0
...
function DecoderSynchronizerExtension:setup_only_finished()
...
function DecoderSynchronizerExtension:_start_network_timer()
	self._networked_timer_extension:start()
end

function DecoderSynchronizerExtension:_pause_network_timer()
	self._networked_timer_extension:pause()
end

function DecoderSynchronizerExtension:is_stuck()
	return not self._networked_timer_extension:is_counting()
end

function DecoderSynchronizerExtension:_network_timer_is_finished()
