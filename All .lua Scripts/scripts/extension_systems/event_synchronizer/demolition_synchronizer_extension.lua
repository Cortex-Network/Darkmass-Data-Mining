...
function DemolitionSynchronizerExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function DemolitionSynchronizerExtension:setup_from_component(objective_name, total_segments, shuffle_segments, lock_last_segment, stage_end_delay, segment_end_delay, auto_start)
...
function DemolitionSynchronizerExtension:hot_join_sync(sender, channel)
...
function DemolitionSynchronizerExtension:_seperate_objective_units(units)
	local target_units = {}
...
function DemolitionSynchronizerExtension:register_connected_units(stage_units, registered_units, stage)
...
function DemolitionSynchronizerExtension:setup_stages(registered_units)
	local segments = {}
...
function DemolitionSynchronizerExtension:_stage_contains_corruptor(stage_units)
...
function DemolitionSynchronizerExtension:start_stage()
...
function DemolitionSynchronizerExtension:finished_stage()
	if self._is_server then
...
function DemolitionSynchronizerExtension:activate_units()
	self._override_objective_markers = nil
...
function DemolitionSynchronizerExtension:override_objective_markers()
	return self._override_objective_markers
end

function DemolitionSynchronizerExtension:set_override_objective_markers(override)
	if override then
...
function DemolitionSynchronizerExtension:active_objective()
	self._mission_objective_system:is_current_active_objective(self._objective_name)
end

function DemolitionSynchronizerExtension:active_stage_unit_num()
	return self._active_stage_unit_num
end

function DemolitionSynchronizerExtension:stage_end_delay(stage)
