...
function LuggableSynchronizerExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function LuggableSynchronizerExtension:fixed_update(unit, dt, t)
...
function LuggableSynchronizerExtension:register_connected_units(stage_units)
...
function LuggableSynchronizerExtension:_check_reset_timer(dt)
...
function LuggableSynchronizerExtension:_check_luggable_to_respawn(dt)
...
function LuggableSynchronizerExtension:_check_luggable_to_consume(dt)
...
function LuggableSynchronizerExtension:_check_sockets()
	local sockets = self._sockets
	local spawner_to_luggable = self._spawner_to_luggable
...
function LuggableSynchronizerExtension:_update_mission_increment(dt, increment)
...
function LuggableSynchronizerExtension:start_event()
	LuggableSynchronizerExtension.super.start_event(self)
end

function LuggableSynchronizerExtension:start_stage()
	if self._is_server then
...
function LuggableSynchronizerExtension:finished_stage()
	table.clear(self._spawners_with_marker_on_start)
end

function LuggableSynchronizerExtension:_configure_spawner_markers()
...
function LuggableSynchronizerExtension:spawn_luggable(spawner_unit)
...
function LuggableSynchronizerExtension:_despawn_luggable(luggable_unit_to_del, respawn_at_spawner)
	local spawner_to_luggable = self._spawner_to_luggable
...
function LuggableSynchronizerExtension:_register_spawned_luggable(luggable_unit, spawner_unit, objective_name, objective_stage)
...
function LuggableSynchronizerExtension:add_marker_on_luggable(spawner_unit)
...
function LuggableSynchronizerExtension:_find_free_random_unit(all_units, reserved_units)
...
function LuggableSynchronizerExtension:_get_free_spawner()
	local spawners = self._spawners
...
function LuggableSynchronizerExtension:get_free_socket()
	return self:_find_free_random_unit(self._sockets, self._socket_to_luggable)
end

function LuggableSynchronizerExtension:sockets_to_fill()
	return math.min(#self._sockets, self._max_socket_target)
end

function LuggableSynchronizerExtension:total_sockets()
	return #self._sockets
end

function LuggableSynchronizerExtension:active_socket_units()
	return self._sockets
end

function LuggableSynchronizerExtension:get_objective_stages()
	return self._objective_stages
end

function LuggableSynchronizerExtension:spawn_single_luggable()
...
function LuggableSynchronizerExtension:_spawn_all_luggables()
...
function LuggableSynchronizerExtension:_enable_sockets_visibility()
	local sockets = self._sockets
...
function LuggableSynchronizerExtension:set_carried_by(luggable_unit, player_unit_or_nil)
...
function LuggableSynchronizerExtension:hide_all_luggables()
...
function LuggableSynchronizerExtension:hide_luggable(luggable_unit)
	Unit.set_unit_visibility(luggable_unit, false, true)
end
