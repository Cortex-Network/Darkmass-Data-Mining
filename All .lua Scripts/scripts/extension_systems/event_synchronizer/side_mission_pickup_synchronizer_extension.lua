...
function SideMissionPickupSynchronizerExtension:_sync_buffs(t)
...
function SideMissionPickupSynchronizerExtension:update_progression(increment, pickup_data)
	if pickup_data then
...
function SideMissionPickupSynchronizerExtension:_update_buff_amount(t, add_buff)
	local player_manager = Managers.player
	local players = player_manager:players()
...
function SideMissionPickupSynchronizerExtension:_add_buff(t, player)
...
function SideMissionPickupSynchronizerExtension:_remove_buff(player)
