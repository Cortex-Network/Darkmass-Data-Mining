...
function BasePlayerOrientation:init(player, orientation)
...
function BasePlayerOrientation:destroy()
	self._player = nil
...
function BasePlayerOrientation:pre_update()
	error("Don't call this on BasePlayerOrientation. Inherit this class and override :pre_update().")
end

function BasePlayerOrientation:orientation()
	return self._orientation.yaw, self._orientation.pitch, self._orientation.roll
end

function BasePlayerOrientation:orientation_offset()
	return 0, 0, 0
end

function BasePlayerOrientation:_fill_look_delta_context(context)
	table.clear(context)
