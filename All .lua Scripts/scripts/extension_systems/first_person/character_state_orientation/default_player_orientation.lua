...
function DefaultPlayerOrientation:init(player, orientation)
...
function DefaultPlayerOrientation:destroy()
...
function DefaultPlayerOrientation:pre_update(main_t, main_dt, input, sensitivity_modifier, rotation_contraints)
...
function DefaultPlayerOrientation:orientation_offset()
