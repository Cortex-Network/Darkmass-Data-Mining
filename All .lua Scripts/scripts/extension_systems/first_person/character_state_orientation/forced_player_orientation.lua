...
function ForcedPlayerOrientation:init(player, orientation)
...
function ForcedPlayerOrientation:destroy()
...
function ForcedPlayerOrientation:pre_update(main_t, main_dt, input, sensitivity_modifier)
