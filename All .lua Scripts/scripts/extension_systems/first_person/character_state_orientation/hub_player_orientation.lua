...
function HubPlayerOrientation:init(player, orientation)
...
function HubPlayerOrientation:destroy()
...
function HubPlayerOrientation:pre_update(main_t, main_dt, input, sensitivity_modifier)
