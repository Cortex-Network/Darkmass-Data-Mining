...
function LedgeHangingPlayerOrientation:init(player, orientation)
...
function LedgeHangingPlayerOrientation:destroy()
...
function LedgeHangingPlayerOrientation:_check_for_parent_reference_transition(player_unit)
...
function LedgeHangingPlayerOrientation:_switch_to_absolute_orientation()
...
function LedgeHangingPlayerOrientation:_switch_to_relative_orientation(parent_unit)
...
function LedgeHangingPlayerOrientation:pre_update(main_t, main_dt, input, sensitivity_modifier)
