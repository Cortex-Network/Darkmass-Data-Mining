...
function SmoothForceViewPlayerOrientation:init(player, orientation)
...
function SmoothForceViewPlayerOrientation:destroy()
...
function SmoothForceViewPlayerOrientation:pre_update(main_t, main_dt, input, sensitivity_modifier, rotation_contraints)
