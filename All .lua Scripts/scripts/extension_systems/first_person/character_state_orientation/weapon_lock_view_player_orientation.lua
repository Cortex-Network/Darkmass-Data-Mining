...
function WeaponLockViewPlayerOrientation:init(player, orientation)
...
function WeaponLockViewPlayerOrientation:destroy()
...
function WeaponLockViewPlayerOrientation:pre_update(main_t, main_dt, input, sensitivity_modifier)
