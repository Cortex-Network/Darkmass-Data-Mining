...
function PlayerHuskFirstPersonExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function PlayerHuskFirstPersonExtension:extensions_ready(world, unit)
...
function PlayerHuskFirstPersonExtension:destroy()
	local unit_spawner_manager = Managers.state.unit_spawner
...
function PlayerHuskFirstPersonExtension:update(unit, dt, t)
...
function PlayerHuskFirstPersonExtension:update_unit_position_and_rotation(position_3p_unit, force_update_unit_and_children)
	local first_person_unit = self._first_person_unit
...
function PlayerHuskFirstPersonExtension:_update_first_person_mode(t)
...
function PlayerHuskFirstPersonExtension:is_in_first_person_mode()
	return self._is_first_person_spectated and self._show_1p_equipment
end

function PlayerHuskFirstPersonExtension:set_camera_follow_target(is_followed, first_person_spectating)
	self._is_camera_follow_target = is_followed
	self._is_first_person_spectated = is_followed and first_person_spectating
end

function PlayerHuskFirstPersonExtension:is_camera_follow_target()
	return self._is_camera_follow_target
end

function PlayerHuskFirstPersonExtension:first_person_unit()
	return self._first_person_unit
end

function PlayerHuskFirstPersonExtension:extrapolated_character_height()
