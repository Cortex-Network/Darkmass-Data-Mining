...
function Effect.update_targeted_by_ranged_minion_wwise_parameters(target_unit_or_nil, wwise_world, source_id, optional_was_camera_follow_target)
...
function Effect.update_targeted_by_special_wwise_parameters(target_unit_or_nil, wwise_world, source_id, optional_was_camera_follow_target, optional_special_unit)
	local is_camera_follow_target = _is_follow_target_unit(target_unit_or_nil)
...
function Effect.update_targeted_in_melee_wwise_parameters(target_unit_or_nil, wwise_world, source_id, optional_was_camera_follow_target)
	local is_camera_follow_target = _is_follow_target_unit(target_unit_or_nil)
