...
function PlayerUnitGadgetExtension:init(extension_init_context, unit, extension_init_data, ...)
	self._unit = unit
...
function PlayerUnitGadgetExtension:extensions_ready(world, unit)
...
function PlayerUnitGadgetExtension:game_object_initialized(session, object_id)
...
function PlayerUnitGadgetExtension:update(unit, dt, t)
end

function PlayerUnitGadgetExtension:on_slot_equipped(item, slot_name)
	self:_add_gadget_buffs(item, slot_name)
end

function PlayerUnitGadgetExtension:on_slot_unequipped(item, slot_name)
	self:_remove_gadget_buffs(item, slot_name)
end

function PlayerUnitGadgetExtension:_add_gadget_buffs(item, slot_name)
	local gadget_buffs = {}
...
function PlayerUnitGadgetExtension:_add_gadget_buff(master_item_id, lerp_value, slot_name)
...
function PlayerUnitGadgetExtension:_remove_gadget_buffs(item, slot_name)
	local gear_id = item.gear_id
	local id = slot_name .. ":" .. gear_id
	local buff_extension = self._buff_extension
