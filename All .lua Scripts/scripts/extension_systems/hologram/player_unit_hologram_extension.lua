...
function PlayerUnitHologramExtension:init(extension_init_context, unit, extension_init_data, game_object_data_or_game_session, nil_or_game_object_id)
...
function PlayerUnitHologramExtension:game_object_initialized(session, object_id)
	self._game_session_id = session
	self._game_object_id = object_id
end

function PlayerUnitHologramExtension:extensions_ready(world, unit)
...
function PlayerUnitHologramExtension:destroy()
...
function PlayerUnitHologramExtension:update(unit, dt, t)
