...
function PlayerUnitPlaceholderHudExtension:init(extension_init_context, unit, extension_init_data, game_session, game_object_id)
	self._unit = unit
...
function PlayerUnitPlaceholderHudExtension:destroy()
	World.destroy_gui(self._world, self._gui)
end

function PlayerUnitPlaceholderHudExtension:_init_components(unit)
...
function PlayerUnitPlaceholderHudExtension:update(unit, dt, t)
...
function PlayerUnitPlaceholderHudExtension:post_update(unit, dt, t)
	local player = self._player
...
function PlayerUnitPlaceholderHudExtension:_update_crosshair(dt)
...
function PlayerUnitPlaceholderHudExtension:_update_weapon_charge()
...
function PlayerUnitPlaceholderHudExtension:_update_overheat()
...
function PlayerUnitPlaceholderHudExtension:_update_warp_charge()
...
function PlayerUnitPlaceholderHudExtension:_update_buff_progressbar()
...
function PlayerUnitPlaceholderHudExtension:_update_scanning_progressbar(t)
...
function PlayerUnitPlaceholderHudExtension:_update_wounds()
...
function PlayerUnitPlaceholderHudExtension:report_hit(hit_weakspot, attack_result, did_damage, hit_world_position)
...
function PlayerUnitPlaceholderHudExtension:_update_hit_indicator(dt, gui, w, h)
	local hit_markers = self._hit_markers
