...
function DecodingInteraction:stop(world, interactor_unit, unit_data_component, t, result, interactor_is_server)
...
function DecodingInteraction:interactor_condition_func(interactor_unit, interactee_unit)
	local can_interact = PlayerUnitStatus.can_interact_with_objective(interactor_unit)

	return can_interact
end

function DecodingInteraction:interactee_condition_func(interactee_unit)
...
function DecodingInteraction:interactee_show_marker_func(interactor_unit, interactee_unit)
