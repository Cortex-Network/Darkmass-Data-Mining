...
function HealthStationInteraction:interactor_condition_func(interactor_unit, interactee_unit)
...
function HealthStationInteraction:stop(world, interactor_unit, unit_data_component, t, result, interactor_is_server)
...
function HealthStationInteraction:interactee_show_marker_func(interactor_unit, interactee_unit)
	local health_station_extension = ScriptUnit.has_extension(interactee_unit, "health_station_system")
	local charge_amount = health_station_extension:charge_amount()
