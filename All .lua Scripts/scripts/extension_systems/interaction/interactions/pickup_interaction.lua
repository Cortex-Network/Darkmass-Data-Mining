...
function PickupInteraction:stop(world, interactor_unit, unit_data_component, t, result, interactor_is_server)
...
function PickupInteraction:interactee_show_marker_func(interactor_unit, interactee_unit)
...
function PickupInteraction:_trigger_sound(interactor_unit, pickup_data)
...
function PickupInteraction:_update_stats(target_unit, interactor_session_id)
...
function PickupInteraction:_interact_with(target_unit, interactor_session_id)
	local pickup_system = Managers.state.extension:system("pickup_system")
...
function PickupInteraction:_picked_up(target_unit, interactor_session_id)
	local pickup_system = Managers.state.extension:system("pickup_system")
...
function PickupInteraction:_use_charge(target_unit, interactor_unit)
