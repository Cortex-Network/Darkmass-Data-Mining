...
function PullUpInteraction:start(world, interactor_unit, unit_data_component, t, is_server)
	PullUpInteraction.super.start(self, world, interactor_unit, unit_data_component, t, is_server)
end

function PullUpInteraction:interactee_condition_func(interactee_unit)
...
function PullUpInteraction:stop(world, interactor_unit, unit_data_component, t, result, is_server)
