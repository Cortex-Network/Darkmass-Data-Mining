...
function RescueInteraction:start(world, interactor_unit, unit_data_component, t, is_server)
...
function RescueInteraction:interactee_condition_func(interactee_unit)
...
function RescueInteraction:stop(world, interactor_unit, unit_data_component, t, result, interactor_is_server)
