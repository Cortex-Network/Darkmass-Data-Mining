...
function ReviveInteraction:start(world, interactor_unit, unit_data_component, t, is_server)
...
function ReviveInteraction:interactee_condition_func(interactee_unit)
...
function ReviveInteraction:stop(world, interactor_unit, unit_data_component, t, result, interactor_is_server)
