...
function ScanningInteraction:start(world, interactor_unit, unit_data_component, t, interactor_is_server)
...
function ScanningInteraction:stop(world, interactor_unit, unit_data_component, t, result, interactor_is_server)
...
function ScanningInteraction:interactee_condition_func(interactee_unit)
...
function ScanningInteraction:interactee_show_marker_func(interactor_unit, interactee_unit)
	return self:interactee_condition_func(interactee_unit) and self:interactor_condition_func(interactor_unit, interactee_unit)
end

function ScanningInteraction:interactor_condition_func(interactor_unit, interactee_unit)
	return false
end
