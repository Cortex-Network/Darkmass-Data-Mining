...
function ServoSkullActivatorInteraction:start(world, interactor_unit, unit_data_component, t, interactor_is_server)
...
function ServoSkullActivatorInteraction:stop(world, interactor_unit, unit_data_component, t, result, interactor_is_server)
