...
function ServoSkullInteraction:start(world, interactor_unit, unit_data_component, t, interactor_is_server)
...
function ServoSkullInteraction:stop(world, interactor_unit, unit_data_component, t, result, interactor_is_server)
...
function ServoSkullInteraction:interactor_condition_func(interactor_unit, interactee_unit)
...
function ServoSkullInteraction:interactee_show_marker_func(interactor_unit, interactee_unit)
