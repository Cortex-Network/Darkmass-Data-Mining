...
function SetupDecodingInteraction:start(world, interactor_unit, unit_data_component, t, interactor_is_server)
...
function SetupDecodingInteraction:stop(world, interactor_unit, unit_data_component, t, result, interactor_is_server)
...
function SetupDecodingInteraction:interactee_condition_func(interactee_unit)
...
function SetupDecodingInteraction:interactor_condition_func(interactor_unit, interactee_unit)
