...
function HuskLiquidAreaExtension:init(extension_init_context, unit, extension_init_data, game_session, game_object_id)
...
function HuskLiquidAreaExtension:update(unit, dt, t, context, listener_position_or_nil)
...
function HuskLiquidAreaExtension:_calculate_liquid_size()
...
function HuskLiquidAreaExtension:_rotation_from_nav_mesh(position)
...
function HuskLiquidAreaExtension:rpc_add_liquid(channel, go_id, real_index, offset_position, is_filled)
...
function HuskLiquidAreaExtension:rpc_set_liquid_filled(channel, go_id, real_index)
	self:_set_liquid_filled(real_index)
end

function HuskLiquidAreaExtension:rpc_set_liquid_filled_multiple(channel, go_id, real_index_array)
	for i = 1, #real_index_array do
		self:_set_liquid_filled(real_index_array[i])
	end
end

function HuskLiquidAreaExtension:_set_liquid_filled(real_index)
