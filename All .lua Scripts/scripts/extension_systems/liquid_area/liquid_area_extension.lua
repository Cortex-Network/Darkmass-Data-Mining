...
function LiquidAreaExtension:init(extension_init_context, unit, extension_init_data, game_object_data)
...
function LiquidAreaExtension:_fill_neighbors(liquid, num_directions, depth)
...
function LiquidAreaExtension:_position_and_rotation_from_nav_mesh(position, nav_world, traverse_logic)
...
function LiquidAreaExtension:_create_liquid(real_index, angle)
	local grid = self._grid
...
function LiquidAreaExtension:_set_filled(real_index)
	local flow = self._flow
...
function LiquidAreaExtension:hot_join_sync(unit, sender, channel)
...
function LiquidAreaExtension:destroy()
...
function LiquidAreaExtension:rim_nodes()
	return self._inactive_flow
end

function LiquidAreaExtension:update(unit, dt, t, context, listener_position_or_nil)
...
function LiquidAreaExtension:post_update(unit, dt, t)
	local set_filled_buffer = self._set_filled_buffer
...
function LiquidAreaExtension:_transmit_set_filled(set_filled_buffer, size)
...
function LiquidAreaExtension:_update_flow(dt)
...
function LiquidAreaExtension:_calculate_broadphase_size()
	local flow = self._flow
...
function LiquidAreaExtension:_update_collision_detection(t)
...
function LiquidAreaExtension:_is_unit_colliding(grid, unit)
	local flow = self._flow
	local unit_position = POSITION_LOOKUP[unit]
...
function LiquidAreaExtension:paint_liquid_at(position, optional_brush_size)
	local grid = self._grid
	local i, j, k = grid:ijk_from_position(position)
...
function LiquidAreaExtension:broadphase_center()
	local center = self._broadphase_center:unbox()

	return center
end

function LiquidAreaExtension:liquid_paint_id()
