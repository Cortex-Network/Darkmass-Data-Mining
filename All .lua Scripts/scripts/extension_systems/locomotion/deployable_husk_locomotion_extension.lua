...
function DeployableHuskLocomotionExtension:init(extension_init_context, unit, extension_init_data, game_session, game_object_id)
	self._unit = unit
...
function DeployableHuskLocomotionExtension:fixed_update(unit, dt, t)
end

function DeployableHuskLocomotionExtension:update(unit, dt, t)
end

function DeployableHuskLocomotionExtension:current_state()
end
