...
function ProjectileHuskLocomotionExtension:init(extension_init_context, unit, extension_init_data, game_session, game_object_id)
...
function ProjectileHuskLocomotionExtension:current_state()
	return self._current_locomotion_state
end

function ProjectileHuskLocomotionExtension:locomotion_template()
	return self._projectile_locomotion_template
end

function ProjectileHuskLocomotionExtension:mass()
	return self._mass
end

function ProjectileHuskLocomotionExtension:radius()
	return self._radius
end

function ProjectileHuskLocomotionExtension:current_speed()
	return self._current_speed
end

function ProjectileHuskLocomotionExtension:pre_update(unit, dt, t)
	self:_read_latest_snapshot(unit, dt, t)
end

function ProjectileHuskLocomotionExtension:update(unit, dt, t)
...
function ProjectileHuskLocomotionExtension:_num_snapshots_buffered(initial_received_snapshot_id, t)
...
function ProjectileHuskLocomotionExtension:_update_interpolation(unit, dt, t)
...
function ProjectileHuskLocomotionExtension:_update_interpolation_time(interpolation_data, snapshot_ring_buffer, unit, dt, t)
...
function ProjectileHuskLocomotionExtension:_step_interpolation_snapshots(interpolation_data, snapshot_ring_buffer, snapshot_t, snapshot_time, unit, t)
...
function ProjectileHuskLocomotionExtension:_switch_locomotion_state(new_loc_state, unit)
...
function ProjectileHuskLocomotionExtension:_interpolate(unit, interpolation_data, snapshot_ring_buffer, snapshot_t)
...
function ProjectileHuskLocomotionExtension:_initialize_projectile_info(unit, projectile_locomotion_template)
	local mass = nil
...
function ProjectileHuskLocomotionExtension:_initialize_interpolation_data()
...
function ProjectileHuskLocomotionExtension:_new_snapshot()
	local snapshot = {
		approximated = false,
		read_time = 0,
...
function ProjectileHuskLocomotionExtension:_read_snapshot(snapshot, t, game_object_return_data)
...
function ProjectileHuskLocomotionExtension:_fill_snapshot(snapshot, read_time, position, rotation, locomotion_state, approximated)
...
function ProjectileHuskLocomotionExtension:_read_latest_snapshot(unit, dt, t)
...
function ProjectileHuskLocomotionExtension:_start_interpolating(unit, interpolation_data, latest_received_snapshot_id, t)
...
function ProjectileHuskLocomotionExtension:_unbox_snapshot(snapshot)
...
function ProjectileHuskLocomotionExtension:_hide_pin()
