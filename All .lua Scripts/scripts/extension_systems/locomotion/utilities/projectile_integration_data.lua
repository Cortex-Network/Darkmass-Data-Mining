...
function ProjectileIntegrationData.allocate_integration_data(store_data)
...
function ProjectileIntegrationData.fill_integration_data(integration_data, owner_unit, projectile_unit, locomotion_template, radius, mass, position, rotation, direction, speed, angular_velocity, target_unit, target_position)
...
function ProjectileIntegrationData.store(integration_data)
...
function ProjectileIntegrationData.unbox(integration_data)
...
function ProjectileIntegrationData.mass_radius(locomotion_template, optional_locomotion_extension)
