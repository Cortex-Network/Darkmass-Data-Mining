...
function ProjectileLocomotion.integrate_position(physics_world, integration_data, dt, t, time_step_multiplier, dont_draw)
	...
	repeat
		...
		if min_distance < travel_distance then
			...
			if statics_radius or statics_raycast then
				...
				hits = merged_hits
			elseif not collisions_enabled or not PhysicsWorld.linear_sphere_sweep(physics_world, travel_position, new_position, radius, max_hits, "types", "both", "collision_filter", collision_filter) then
				hits = NO_HITS
			end
...
function ProjectileLocomotion.integrate_rotation(physics_world, integration_data, dt, t)
...
function ProjectileLocomotion.integrate(physics_world, integration_data, dt, t, is_server, time_step_multiplier, dont_draw)
