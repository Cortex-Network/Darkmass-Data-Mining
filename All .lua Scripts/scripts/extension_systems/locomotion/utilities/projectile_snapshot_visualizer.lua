...
function ProjectileSnapshotVisualizer.draw_snapshot(snapshot_id, position, rotation, velocity)
end
...
function ProjectileSnapshotVisualizer.draw_ring_buffer(snapshot_ring_buffer, interpolation_data, t)
