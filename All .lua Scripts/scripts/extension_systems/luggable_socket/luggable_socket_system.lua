...
function LuggableSocketSystem:init(extension_system_creation_context, ...)
...
function LuggableSocketSystem:on_add_extension(world, unit, extension_name, extension_init_data, ...)
...
function LuggableSocketSystem:destroy(...)
...
function LuggableSocketSystem:hot_join_sync(sender, channel)
...
function LuggableSocketSystem:socket_units()
	return self._socket_units
end

function LuggableSocketSystem:update_level_props_broadphase()
	local unit_to_extension_map = self._unit_to_extension_map
...
function LuggableSocketSystem:rpc_luggable_socket_hot_join(channel_id, socket_id, socket_is_level_unit, socketed_id, socketed_is_level_unit)
	local unit_spawner_manager = Managers.state.unit_spawner
...
function LuggableSocketSystem:rpc_luggable_socket_luggable(channel_id, socket_id, socket_is_level_unit, socketed_id, socketed_is_level_unit)
	local unit_spawner_manager = Managers.state.unit_spawner
	local socket_unit = unit_spawner_manager:unit(socket_id, socket_is_level_unit)
...
function LuggableSocketSystem:rpc_luggable_socket_unlock(channel_id, socket_id, socket_is_level_unit)
	local unit_spawner_manager = Managers.state.unit_spawner
	local socket_unit = unit_spawner_manager:unit(socket_id, socket_is_level_unit)
	local extension = self._unit_to_extension_map[socket_unit]
...
function LuggableSocketSystem:rpc_luggable_socket_set_visibility(channel_id, socket_id, socket_is_level_unit, value)
	local unit_spawner_manager = Managers.state.unit_spawner
	local socket_unit = unit_spawner_manager:unit(socket_id, socket_is_level_unit)
	local extension = self._unit_to_extension_map[socket_unit]
