...
function MissionObjectiveCaptureZone:start_stage(stage)
...
function MissionObjectiveCaptureZone:update_progression()
...
function MissionObjectiveCaptureZone:get_current_capture_zone()
