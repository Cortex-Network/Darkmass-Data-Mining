...
function MissionObjectiveDestination:init()
...
function MissionObjectiveDestination:start_objective(mission_objective_data, registered_units, synchronizer_unit, peer_id)
...
function MissionObjectiveDestination:start_stage(stage)
...
function MissionObjectiveDestination:update_progression()
...
function MissionObjectiveDestination:_closest_distance()
...
function MissionObjectiveDestination:_distance(start_unit, end_unit)
