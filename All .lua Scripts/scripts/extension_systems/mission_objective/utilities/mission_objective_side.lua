...
function MissionObjectiveSide:init()
	MissionObjectiveSide.super.init(self)
	self:set_updated_externally(true)
end

function MissionObjectiveSide:start_objective(mission_objective_data, units, synchronizer_unit)
...
function MissionObjectiveSide:start_stage(stage)
...
function MissionObjectiveSide:update_progression()
...
function MissionObjectiveSide:_proc_mission_objective_at_max_progression(player, proc_event)
...
function MissionObjectiveSide:_set_side_mission_type(side_mission_type)
