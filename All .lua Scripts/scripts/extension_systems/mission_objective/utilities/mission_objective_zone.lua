...
function MissionObjectiveZone:init(peer_id)
...
function MissionObjectiveZone:start_stage(stage)
...
function MissionObjectiveZone:update_progression()
...
function MissionObjectiveZone:propagate_objective_increment()
