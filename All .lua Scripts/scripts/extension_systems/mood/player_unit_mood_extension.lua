...
function PlayerUnitMoodExtension:init(extension_init_context, unit, extension_init_data, game_object_data, nil_or_game_object_id)
...
function PlayerUnitMoodExtension:destroy()
...
function PlayerUnitMoodExtension:game_object_initialized(game_session, game_object_id)
	self._game_object_id = game_object_id
	self._game_session = game_session
end

function PlayerUnitMoodExtension:hot_join_sync(unit, sender, channel)
...
function PlayerUnitMoodExtension:update(unit, dt, t)
	self:_update_active_moods(t)
	self:_update_timed_moods(t)
	self:_update_removing_moods(t)
end

function PlayerUnitMoodExtension:_update_active_moods(t)
...
function PlayerUnitMoodExtension:_update_timed_moods(t)
	local moods_data = self._moods_data
...
function PlayerUnitMoodExtension:_update_removing_moods(t)
	local moods_data = self._moods_data
...
function PlayerUnitMoodExtension:moods_data()
	return self._moods_data
end

function PlayerUnitMoodExtension:_add_mood(t, mood_type, reset_time)
	local moods_data = self._moods_data
...
function PlayerUnitMoodExtension:_remove_mood(t, mood_type)
...
function PlayerUnitMoodExtension:add_timed_mood(t, mood_type)
...
function PlayerUnitMoodExtension:rpc_trigger_timed_mood(channel_id, go_id, mood_type_id)
