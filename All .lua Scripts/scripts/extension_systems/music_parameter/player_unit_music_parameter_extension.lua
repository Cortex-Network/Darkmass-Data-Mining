...
function PlayerUnitMusicParameterExtension:init(extension_init_context, unit, extension_init_data, game_object_data_or_game_session, nil_or_game_object_id)
	self._unit = unit
...
function PlayerUnitMusicParameterExtension:destroy()
	GameSession.destroy_game_object(self._game_session, self._music_parameters_game_object_id)
end

function PlayerUnitMusicParameterExtension:game_object_initialized(game_session, game_object_id)
...
function PlayerUnitMusicParameterExtension:_check_is_boss_near(alive_monsters, alive_witches_lookup)
...
function PlayerUnitMusicParameterExtension:_update_boss_near(unit)
...
function PlayerUnitMusicParameterExtension:_update_aggroed_minions_near(unit)
...
function PlayerUnitMusicParameterExtension:_shortest_horde_distance(positions)
...
function PlayerUnitMusicParameterExtension:_update_horde_near(t)
...
function PlayerUnitMusicParameterExtension:_update_last_man_standing()
...
function PlayerUnitMusicParameterExtension:update(unit, dt, t)
	local game_session = self._game_session
	local game_object_id = self._music_parameters_game_object_id
...
function PlayerUnitMusicParameterExtension:num_aggroed_minions_near()
	return self._num_aggroed_minions_near
end

function PlayerUnitMusicParameterExtension:tension_percent()
	return self._tension_percent
end

function PlayerUnitMusicParameterExtension:vector_horde_near()
	return self._vector_horde_near
end

function PlayerUnitMusicParameterExtension:ambush_horde_near()
	return self._ambush_horde_near
end

function PlayerUnitMusicParameterExtension:last_man_standing()
	return self._last_man_standing
end

function PlayerUnitMusicParameterExtension:boss_near()
	return self._boss_near
end

function PlayerUnitMusicParameterExtension:health_percent()
	return self._health_percent
end

function PlayerUnitMusicParameterExtension:intensity_percent()
	return self._intensity_percent
end

function PlayerUnitMusicParameterExtension:locked_in_melee()
	return self._locked_in_melee
end

function PlayerUnitMusicParameterExtension:num_aggroed_minions()
