...
function BotPerceptionExtension:init(extension_init_context, unit, extension_init_data, game_object_data)
...
function BotPerceptionExtension:_init_blackboard_components(blackboard)
...
function BotPerceptionExtension:extensions_ready(world, unit)
...
function BotPerceptionExtension:on_reload()
...
function BotPerceptionExtension:enemies_in_proximity()
...
function BotPerceptionExtension:pre_update(unit, dt, t)
...
function BotPerceptionExtension:update(unit, dt, t)
...
function BotPerceptionExtension:_update_target_enemy(self_unit, self_position, perception_component, behavior_component, enemies_in_proximity, side, bot_group, dt, t)
...
function BotPerceptionExtension:_decay_threat(unit, dt)
...
function BotPerceptionExtension:add_threat(threat_unit, threat_to_add)
	local threat_config = self._threat_config
...
function BotPerceptionExtension:within_aid_range(unit, perception_component)
...
function BotPerceptionExtension:_target_valid(unit, enemy_offset)
	local unit_data_extension = ScriptUnit.extension(unit, "unit_data_system")
...
function BotPerceptionExtension:_update_target_ally(self_unit, self_position, perception_component, side, bot_group, t)
...
function BotPerceptionExtension:_update_target_level_unit(self_unit, self_position, perception_component, t)
...
function BotPerceptionExtension:_select_ally_by_utility(self_unit, self_position, perception_component, side, t)
...
function BotPerceptionExtension:_select_next_health_station(self_unit, self_position, perception_component, t)
	local unit = nil
...
function BotPerceptionExtension:_calculate_healing_item_utility(health_percent, is_wounded, is_quick_use_item)
...
function BotPerceptionExtension:_calculate_ally_need_type(self_position, self_health_utility, can_heal_other, can_give_healing_to_other, ally_unit, ally_position, target_enemy, t)
...
function BotPerceptionExtension:_player_needs_attention(self_position, player_unit, player_position, player_unit_data_extension, target_enemy, t)
...
function BotPerceptionExtension:_ally_path_allowed(self_position, self_segment_index, ally_unit, ally_position, ally_segment_index, t)
...
function BotPerceptionExtension:set_seen_by_player_unit(seen, player_unit, t)
