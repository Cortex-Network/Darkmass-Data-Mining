...
function PickupAnimationExtension:init(extension_init_context, unit)
	self._unit = unit
...
function PickupAnimationExtension:setup_from_component()
end

function PickupAnimationExtension:start_pickup_animation(destination_unit)
...
function PickupAnimationExtension:start_place_animation(destination_unit)
	local unit = self._unit
	self._start_position = Vector3Box(Unit.world_position(unit, 1))
	self._end_unit = destination_unit
...
function PickupAnimationExtension:pickup_animation_started()
	return self._pickup_animation_started
end

function PickupAnimationExtension:update(unit, dt, t)
