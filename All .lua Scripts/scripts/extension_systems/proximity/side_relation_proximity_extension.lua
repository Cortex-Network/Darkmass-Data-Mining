...
function SideRelationProximityExtension:init(extension_init_context, unit, extension_init_data, ...)
	self._unit = unit
...
function SideRelationProximityExtension:_initialize_job(logic_class)
	self._job_logic = logic_class
end

function SideRelationProximityExtension:update(unit, dt, t)
...
function SideRelationProximityExtension:is_job_canceled()
	return self._job_logic:is_job_canceled()
end

local dead_units = {}

function SideRelationProximityExtension:_update_unit_alive_check(unit, dt, t)
	local ALIVE = ALIVE
...
function SideRelationProximityExtension:_update_proximity(unit, dt, t)
...
function SideRelationProximityExtension:_update_logic(unit, dt, t)
	for relation_name, data in pairs(self._relation_data) do
		local data_logic = data.logic
		local num_logic = data.num_logic
