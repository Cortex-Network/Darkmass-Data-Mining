...
function PlayerUnitWeaponRecoilExtension:init(extension_init_context, unit, extension_init_data, ...)
...
function PlayerUnitWeaponRecoilExtension:_reset()
...
function PlayerUnitWeaponRecoilExtension:_snap_camera()
...
function PlayerUnitWeaponRecoilExtension:fixed_update(unit, dt, t)
	local recoil_component = self._recoil_component
	local recoil_control_component = self._recoil_control_component
...
function PlayerUnitWeaponRecoilExtension:_update_unsteadiness(dt, t, recoil_component, recoil_control_component, recoil_settings)
...
function PlayerUnitWeaponRecoilExtension:_update_offset(recoil_component, recoil_control_component, recoil_settings, t)
	local unsteadiness = recoil_component.unsteadiness
