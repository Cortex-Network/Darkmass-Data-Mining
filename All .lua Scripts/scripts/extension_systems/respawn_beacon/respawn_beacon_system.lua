...
function RespawnBeaconSystem:init(...)
...
function RespawnBeaconSystem:on_add_extension(world, unit, ...)
...
function RespawnBeaconSystem:on_remove_extension(unit, extension_name)
...
function RespawnBeaconSystem:make_respawn_beacon_priority(unit)
...
function RespawnBeaconSystem:remove_respawn_beacon_priority()
	if not self._is_server then
		return
	end
...
function RespawnBeaconSystem:fixed_update(context, dt, t, frame)
...
function RespawnBeaconSystem:_should_update_respawn_beacons(side_id)
...
function RespawnBeaconSystem:_should_move_hogtied_players(side_id)
...
function RespawnBeaconSystem:_move_hogtied_players(players, best_beacon)
	local extension = self._unit_to_extension_map[best_beacon]
...
function RespawnBeaconSystem:_find_nearest_beacon(side_id)
...
function RespawnBeaconSystem:_find_nearest_beacon_with_mainpath(side_id)
	local beacon_main_path_data = self._beacon_main_path_data
	local num_beacons = #beacon_main_path_data
...
function RespawnBeaconSystem:_find_nearest_beacon_no_mainpath()
