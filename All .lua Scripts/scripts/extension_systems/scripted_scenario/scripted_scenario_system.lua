...
function ScriptedScenarioSystem:init(extension_system_creation_context, ...)
...
function ScriptedScenarioSystem:destroy()
...
function ScriptedScenarioSystem:on_add_extension(world, unit, ...)
...
function ScriptedScenarioSystem:on_remove_extension(unit, extension_name)
	ScriptedScenarioSystem.super.on_remove_extension(self, unit, extension_name)
	self:_remove_directional_unit(unit)
end

function ScriptedScenarioSystem:enabled()
...
function ScriptedScenarioSystem:_handle_bot_despawns()
...
function ScriptedScenarioSystem:_handle_minion_dissolves(t)
...
function ScriptedScenarioSystem:_handle_spawning_minions(t)
...
function ScriptedScenarioSystem:_handle_spawning_units(t)
...
function ScriptedScenarioSystem:set_enabled(enable)
...
function ScriptedScenarioSystem:_handle_condition_step(scenario, conditional_step_template, player, scenario_data, step_data, t)
...
function ScriptedScenarioSystem:start_scenario(alias, name, t)
	self:stop_scenario(t)
...
function ScriptedScenarioSystem:_create_scenario(alias, name)
...
function ScriptedScenarioSystem:_start_scenario(scenario, t)
...
function ScriptedScenarioSystem:stop_scenario(t, delay, clear_queued_scenarios, ignore_cleanup_steps)
	if delay then
...
function ScriptedScenarioSystem:_stop_scenario(scenario, ignore_cleanup_steps, t)
...
function ScriptedScenarioSystem:_on_event(event_name, ...)
...
function ScriptedScenarioSystem:_start_step(scenario, step_template, player, scenario_data, step_data, t)
...
function ScriptedScenarioSystem:_stop_step(scenario, step_template, player, scenario_data, step_data, t)
...
function ScriptedScenarioSystem:_register_events(scenario, events)
...
function ScriptedScenarioSystem:_unregister_events(scenario, events)
	local tracked_events = self._tracked_events
...
function ScriptedScenarioSystem:queue_bot_removal(bot_local_id)
	local is_marked_for_deletion = false
	self._queued_bot_removals[bot_local_id] = is_marked_for_deletion
end

function ScriptedScenarioSystem:queue_bot_addition()
...
function ScriptedScenarioSystem:dissolve_unit(unit, t)
...
function ScriptedScenarioSystem:spawn_breed_ramping(breed_name, position, rotation, t, duration, side_id, optional_delay, optional_spawn_aggro_state)
...
function ScriptedScenarioSystem:nav_world()
	return self._nav_world
end

function ScriptedScenarioSystem:traverse_logic()
	return self._traverse_logic
end

function ScriptedScenarioSystem:queue_scenario(alias, name)
...
function ScriptedScenarioSystem:reset_scenario(t, delay)
	local current_scenario = self._current_scenario
...
function ScriptedScenarioSystem:_add_directional_unit(unit, extension)
...
function ScriptedScenarioSystem:_remove_directional_unit(unit)
	local identifier = Unit.get_data(unit, "directional_unit_identifier")
...
function ScriptedScenarioSystem:get_directional_unit(identifier)
	local ext = self._directional_unit_extensions[identifier]

	return ext:unit()
end

function ScriptedScenarioSystem:get_directional_unit_extension(identifier)
	return self._directional_unit_extensions[identifier]
end

function ScriptedScenarioSystem:get_spawn_group(spawn_group_name)
	return self._spawn_groups[spawn_group_name]
end

function ScriptedScenarioSystem:spawn_attached_units_in_spawn_group(spawn_group_name)
	for _, extension in pairs(self:get_spawn_group(spawn_group_name)) do
		extension:spawn_attached_unit()
	end
end

function ScriptedScenarioSystem:unspawn_attached_units_in_spawn_group(spawn_group_name)
	for _, extension in pairs(self:get_spawn_group(spawn_group_name)) do
		extension:unspawn_attached_unit()
	end
end

function ScriptedScenarioSystem:world()
	return self._world
end

function ScriptedScenarioSystem:spawn_unit_ramping(ramping_spawn_data, t, spawn_duration)
	local world = self._world
	local position = ramping_spawn_data.position:unbox()
	local rotation = ramping_spawn_data.rotation:unbox()
	local vfx_id = World.create_particles(world, RAMPING_VFX, position, rotation)
...
function ScriptedScenarioSystem:servitor_handler()
	return self._servitor_handler
end

function ScriptedScenarioSystem:get_current_scenario_name()
	return self._current_scenario_name
end

function ScriptedScenarioSystem:has_queued_scenario()
	return not table.is_empty(self._queued_scenarios)
end

function ScriptedScenarioSystem:add_unit_marker(unit, marker_type, remove_when_dead, optional_data)
...
function ScriptedScenarioSystem:_update_objective_marker()
...
function ScriptedScenarioSystem:current_scenario()
	return self._current_scenario
end

function ScriptedScenarioSystem:start_time_scale(from_scale, to_scale, transition_time, optional_revert_scale_condition_func)
	local data = {}
...
function ScriptedScenarioSystem:_update_time_scale()
...
function ScriptedScenarioSystem:reset_time_scale()
	Managers.time:set_local_scale("gameplay", 1)

	self._time_scale_data = nil
end

function ScriptedScenarioSystem:set_init_scenario(alias, name)
...
function ScriptedScenarioSystem:_handle_parallel_scenarios(t)
...
function ScriptedScenarioSystem:start_parallel_scenario(alias, name, t)
...
function ScriptedScenarioSystem:stop_parallel_scenario(alias, name, t, ignore_cleanup_steps)
	local parallel_scenarios = self._parallel_scenarios
