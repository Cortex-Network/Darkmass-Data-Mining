...
function MinionHuskShieldExtension:can_block_attack(damage_profile, attacking_unit, attacking_unit_owner_unit)
...
function MinionHuskShieldExtension:can_block_from_position(attacking_unit_position)
