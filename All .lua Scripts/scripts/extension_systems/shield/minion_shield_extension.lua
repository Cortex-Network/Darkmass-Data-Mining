...
function MinionShieldExtension:init(extension_init_context, unit, extension_init_data, game_object_data)
...
function MinionShieldExtension:_init_blackboard_components(blackboard)
...
function MinionShieldExtension:game_object_initialized(session, object_id)
	self._game_object_id = object_id
	self._game_session = session
end

function MinionShieldExtension:update(context, dt, t)
...
function MinionShieldExtension:set_blocking(is_blocking)
...
function MinionShieldExtension:is_blocking()
	local shield_component = self._shield_component

	return shield_component.is_blocking
end

function MinionShieldExtension:can_block_attack(damage_profile, attacking_unit, attacking_unit_owner_unit, hit_actor)
...
function MinionShieldExtension:can_block_from_position(attacking_unit_position)
...
function MinionShieldExtension:apply_stagger(unit, damage_profile, stagger_strength, attack_result, stagger_type, duration_scale, length_scale, attack_type)
	local is_blocking = self._shield_component.is_blocking
