...
function PlayerUnitSmartTargetingExtension:init(extension_init_context, unit, extension_init_data)
	self._unit = unit
...
function PlayerUnitSmartTargetingExtension:extensions_ready()
...
function PlayerUnitSmartTargetingExtension:fixed_update(unit, dt, t, frame)
...
function PlayerUnitSmartTargetingExtension:_targeting_parameters()
...
function PlayerUnitSmartTargetingExtension:_update_precision_target(unit, smart_targeting_template, ray_origin, forward, right, up, targeting_data)
...
function PlayerUnitSmartTargetingExtension:_update_proximity(unit, smart_targeting_template, ray_origin, forward, right, up)
...
function PlayerUnitSmartTargetingExtension:assisted_hitscan_trajectory(smart_targeting_template, weapon_template, raw_aim_rotation)
	local targeting_data = self._targeting_data
...
function PlayerUnitSmartTargetingExtension:_target_visibility_and_aim_position(target_breed, target_unit, own_position, target_node_name)
...
function PlayerUnitSmartTargetingExtension:targeting_data()
	return self._targeting_data
end

function PlayerUnitSmartTargetingExtension:smart_tag_targeting_data()
	return self._smart_tag_targeting_data
end

function PlayerUnitSmartTargetingExtension:force_update_smart_tag_targets()
