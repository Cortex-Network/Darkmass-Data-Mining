...
function PlayerUnitSpecializationExtension:init(extension_init_context, unit, extension_init_data, ...)
	self._unit = unit
...
function PlayerUnitSpecializationExtension:_init_components()
...
function PlayerUnitSpecializationExtension:extensions_ready(world, unit)
...
function PlayerUnitSpecializationExtension:game_object_initialized(game_object_id)
...
function PlayerUnitSpecializationExtension:update(unit, dt, t)
end

function PlayerUnitSpecializationExtension:fixed_update(unit, dt, t, fixed_frame, context, ...)
...
function PlayerUnitSpecializationExtension:destroy()
end

function PlayerUnitSpecializationExtension:get_specialization_name()
	return self._specialization_name
end

function PlayerUnitSpecializationExtension:get_talents()
	return self._talents
end

function PlayerUnitSpecializationExtension:has_special_rule(special_rule_name)
	local active_special_rules = self._active_special_rules

	return active_special_rules[special_rule_name]
end

function PlayerUnitSpecializationExtension:select_new_specialization(specialization_name, talents, fixed_t)
...
function PlayerUnitSpecializationExtension:remove_gameplay_features(fixed_t)
	self:_remove_gameplay_features(fixed_t)
end

function PlayerUnitSpecializationExtension:_apply_specialization_and_talents(archetype, specialization_name, talents, fixed_t)
...
function PlayerUnitSpecializationExtension:_remove_gameplay_features(fixed_t)
...
function PlayerUnitSpecializationExtension:_send_rpc_update_to_client(player, specialization_name, talents)
