...
function PlayerHuskToughnessExtension:init(extension_init_context, unit, extension_init_data, game_session, game_object_id, owner_id)
	self._unit = unit
...
function PlayerHuskToughnessExtension:toughness_damage()
...
function PlayerHuskToughnessExtension:current_toughness_percent_visual()
...
function PlayerHuskToughnessExtension:max_toughness_visual()
...
function PlayerHuskToughnessExtension:recover_toughness()
end

function PlayerHuskToughnessExtension:recover_percentage_toughness()
end

function PlayerHuskToughnessExtension:recover_max_toughness()
end
