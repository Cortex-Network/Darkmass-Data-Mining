...
function TrainingGroundsServitorHandler:init(scripted_scenario_system)
	self._unit = nil
...
function TrainingGroundsServitorHandler:update(dt, t)
...
function TrainingGroundsServitorHandler:spawn_servitor(position, rotation)
...
function TrainingGroundsServitorHandler:despawn_servitor()
	Managers.state.unit_spawner:mark_for_deletion(self._unit)
end

function TrainingGroundsServitorHandler:unit()
	return self._unit
end

function TrainingGroundsServitorHandler:update_lookat_position(optional_position)
...
function TrainingGroundsServitorHandler:_move(dt)
...
function TrainingGroundsServitorHandler:move_to_unit_relative_arc(relative_unit, relative_position, rotate_position_relative_to_unit, stop_at_arrival, lookat_unit)
...
function TrainingGroundsServitorHandler:_calculate_arc(dt)
...
function TrainingGroundsServitorHandler:move_to_unit_relative_direct(relative_unit, relative_position, relative_to_unit_rotation, stop_at_arrival)
...
function TrainingGroundsServitorHandler:_calculate_direct(dt)
...
function TrainingGroundsServitorHandler:move_idle(relative_unit, reset_lookat)
...
function TrainingGroundsServitorHandler:_calculate_idle(dt, t)
...
function TrainingGroundsServitorHandler:destroy()
end

function TrainingGroundsServitorHandler:_handle_lookat(dt)
	local lookat_data = self._lookat_data
	local velocity = self._velocity:unbox()
...
function TrainingGroundsServitorHandler:_handle_floating_z_offset(dt, t)
...
function TrainingGroundsServitorHandler:interactee_extension()
	return self._interactee_extension
end

function TrainingGroundsServitorHandler:movement_state()
