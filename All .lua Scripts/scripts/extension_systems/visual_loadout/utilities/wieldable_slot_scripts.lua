...
function WieldableSlotScripts.create(wieldable_slot_scripts_context, wieldable_slot_scripts, fx_sources, slot, item)
...
function WieldableSlotScripts.destroy(wieldable_slot_scripts)
...
function WieldableSlotScripts.extensions_ready(wieldable_slot_scripts_per_slot)
...
function WieldableSlotScripts.update(wieldable_slot_scripts, unit, dt, t)
	local num_scripts = #wieldable_slot_scripts
...
function WieldableSlotScripts.fixed_update(wieldable_slot_scripts, unit, dt, t)
	local num_scripts = #wieldable_slot_scripts
...
function WieldableSlotScripts.post_update(wieldable_slot_scripts, unit, dt, t)
	local num_scripts = #wieldable_slot_scripts
...
function WieldableSlotScripts.update_unit_position(wieldable_slot_scripts, unit, dt, t)
	local num_scripts = #wieldable_slot_scripts
...
function WieldableSlotScripts.wield(wieldable_slot_scripts)
	local num_scripts = #wieldable_slot_scripts
...
function WieldableSlotScripts.unwield(wieldable_slot_scripts)
	local num_scripts = #wieldable_slot_scripts
