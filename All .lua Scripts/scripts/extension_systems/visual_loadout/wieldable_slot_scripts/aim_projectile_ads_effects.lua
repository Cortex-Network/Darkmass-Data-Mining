...
function AimProjectileAdsEffects:init(context, slot, weapon_template, fx_sources)
...
function AimProjectileAdsEffects:_trajectory_settings(t)
	...
	local throw_parameters = projectile_locomotion_template.throw_parameters[throw_type]
	...
	_trajectory_settings.speed = throw_parameters.speed_inital
