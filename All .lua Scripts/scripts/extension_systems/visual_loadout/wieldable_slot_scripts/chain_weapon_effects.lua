...
function ChainWeaponEffects:init(context, slot, weapon_template, fx_sources)
...
function ChainWeaponEffects:destroy()
...
function ChainWeaponEffects:wield()
...
function ChainWeaponEffects:unwield()
	if not self._is_husk and self._melee_idling_looping_sound_component.is_playing then
		self._fx_extension:stop_looping_wwise_event(LOOPING_SOUND_ALIAS)
	end
...
function ChainWeaponEffects:fixed_update(unit, dt, t, frame)
end

function ChainWeaponEffects:update(unit, dt, t)
	self:_update_active()
	self:_update_base_intensity(dt, t)
	self:_update_intensity(dt, t)
end

function ChainWeaponEffects:update_first_person_mode(first_person_mode)
end

function ChainWeaponEffects:_update_active()
...
function ChainWeaponEffects:_update_base_intensity(dt, t)
...
function ChainWeaponEffects:_update_intensity(dt, t)
...
function ChainWeaponEffects:_start_vfx_loop()
...
function ChainWeaponEffects:_stop_vfx_loop(destroy)
	local current_effect_id = self._looping_effect_id
