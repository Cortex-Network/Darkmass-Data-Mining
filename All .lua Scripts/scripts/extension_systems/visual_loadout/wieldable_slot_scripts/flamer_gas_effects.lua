...
function FlamerGasEffects:fixed_update(unit, dt, t, frame)
end

function FlamerGasEffects:update_unit_position(unit, dt, t)
	self:_update_effects(dt, t)
end

function FlamerGasEffects:update_first_person_mode(first_person_mode)
	self._is_in_first_person = first_person_mode
end

function FlamerGasEffects:wield()
end

function FlamerGasEffects:unwield()
	self:_destroy_effects(false)
	table.clear(self._stoped_particles)
end

function FlamerGasEffects:destroy()
	self:_destroy_effects(false)
	table.clear(self._stoped_particles)
end

function FlamerGasEffects:_update_effects(dt, t)
...
function FlamerGasEffects:_update_impact_effects(dt, t)
	local impact_data = self._impact_data
...
function FlamerGasEffects:_update_moving_lingering_effects(dt, t)
	local world = self._world
...
function FlamerGasEffects:_destroy_effects(allow_move, rotation)
	local world = self._world
	local stream_effect_id = self._stream_effect_id
