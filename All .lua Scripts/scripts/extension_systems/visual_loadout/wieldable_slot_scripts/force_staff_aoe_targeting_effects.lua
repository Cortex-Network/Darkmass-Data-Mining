...
function ForceStaffAoeTargetingEffects:init(context, slot, weapon_template, fx_sources)
...
function ForceStaffAoeTargetingEffects:fixed_update(unit, dt, t, frame)
end

function ForceStaffAoeTargetingEffects:update(unit, dt, t)
	self:_update_targeting_effects()
end

function ForceStaffAoeTargetingEffects:update_first_person_mode(first_person_mode)
end

function ForceStaffAoeTargetingEffects:wield()
	self:_update_targeting_effects()
end

function ForceStaffAoeTargetingEffects:unwield()
	self:_destroy_effects()
end

function ForceStaffAoeTargetingEffects:destroy()
	self:_destroy_effects()
...
function ForceStaffAoeTargetingEffects:_update_targeting_effects()
...
function ForceStaffAoeTargetingEffects:_update_effect_positions(action_settings, decal_unit, effect_id, scaling_effect_id, scale_variable_index, source_id, parameter_name)
...
function ForceStaffAoeTargetingEffects:_destroy_effects()
	local world = self._world
	local wwise_world = self._wwise_world
