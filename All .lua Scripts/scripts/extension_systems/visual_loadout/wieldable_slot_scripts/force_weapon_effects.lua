...
function ForceWeaponEffects:wield()
...
function ForceWeaponEffects:unwield()
	self:_stop_sfx_loop()
...
function ForceWeaponEffects:fixed_update(unit, dt, t, frame)
end

function ForceWeaponEffects:update(unit, dt, t)
	self:_update_active()
end

function ForceWeaponEffects:update_first_person_mode(first_person_mode)
end

function ForceWeaponEffects:_update_active()
...
function ForceWeaponEffects:_start_sfx_loop()
...
function ForceWeaponEffects:_stop_sfx_loop()
	local current_playing_id = self._looping_playing_id
