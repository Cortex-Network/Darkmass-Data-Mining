...
function GrimoireEffects:init(context, slot, weapon_template, fx_sources)
...
function GrimoireEffects:fixed_update(unit, dt, t, frame)
end

function GrimoireEffects:update(unit, dt, t)
	self:_update_discard(t)
end

function GrimoireEffects:update_first_person_mode(first_person_mode)
end

function GrimoireEffects:wield()
	self:_start_idle_effects()
end

function GrimoireEffects:unwield()
	self:_stop_all_effects()
end

function GrimoireEffects:destroy()
	self:_stop_all_effects()
end

function GrimoireEffects:_stop_all_effects()
	self:_stop_idle_effects()
	self:_stop_discard_effects()
end

function GrimoireEffects:_update_discard(t)
...
function GrimoireEffects:_update_discard_finish(time_in_action, action_settings)
	local action_kind = action_settings.kind
...
function GrimoireEffects:_start_idle_effects()
...
function GrimoireEffects:_stop_discard_effects()
...
function GrimoireEffects:_stop_idle_effects()
