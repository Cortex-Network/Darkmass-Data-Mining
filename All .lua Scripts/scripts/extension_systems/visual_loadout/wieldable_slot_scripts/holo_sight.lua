...
function HoloSight:update(unit, dt, t)
...
function HoloSight:update_first_person_mode(first_person_mode)
end

function HoloSight:wield()
	self._was_aiming_down_sights = true
end

function HoloSight:unwield()
end

function HoloSight:destroy()
end
