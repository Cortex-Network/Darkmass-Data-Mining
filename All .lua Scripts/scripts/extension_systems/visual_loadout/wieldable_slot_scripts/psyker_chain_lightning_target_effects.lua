...
local PsykerChainLightningTargetEffects = class("PsykerChainLightningTargetEffects")
local Unit_world_position = Unit.world_position

function PsykerChainLightningTargetEffects:init(context, slot, weapon_template, fx_sources)
...
function PsykerChainLightningTargetEffects:fixed_update(unit, dt, t, frame)
end

function PsykerChainLightningTargetEffects:update(unit, dt, t)
...
function PsykerChainLightningTargetEffects:update_first_person_mode(first_person_mode)
end

function PsykerChainLightningTargetEffects:wield()
end

function PsykerChainLightningTargetEffects:unwield()
	self:_destroy_effects()
end

function PsykerChainLightningTargetEffects:destroy()
	self:_destroy_effects()
end

function PsykerChainLightningTargetEffects:_create_effect(unit, targeting_fx)
	local targeting_effects = self._targeting_effects
...
function PsykerChainLightningTargetEffects:_destroy_effect(unit)
	local world = self._world
	local targeting_effects = self._targeting_effects
...
function PsykerChainLightningTargetEffects:_destroy_effects()
	local world = self._world
	local targeting_effects = self._targeting_effects
...
return PsykerChainLightningTargetEffects
