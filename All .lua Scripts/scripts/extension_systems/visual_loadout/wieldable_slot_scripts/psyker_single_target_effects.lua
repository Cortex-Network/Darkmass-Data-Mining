...
function PsykerSingleTargetEffects:init(context, slot, weapon_template, fx_sources)
...
function PsykerSingleTargetEffects:fixed_update(unit, dt, t, frame)
end

function PsykerSingleTargetEffects:update(unit, dt, t)
	self:_update_targeting_effects()
end

function PsykerSingleTargetEffects:update_first_person_mode(first_person_mode)
end

function PsykerSingleTargetEffects:wield()
	self:_update_targeting_effects()
end

function PsykerSingleTargetEffects:unwield()
	self:_destroy_effects()
end

function PsykerSingleTargetEffects:destroy()
	self:_destroy_effects()
...
function PsykerSingleTargetEffects:_update_targeting_effects()
...
function PsykerSingleTargetEffects:_update_effect_positions(target_position, effect_id, source_id, parameter_name)
...
function PsykerSingleTargetEffects:_destroy_effects()
	local world = self._world
	local wwise_world = self._wwise_world
