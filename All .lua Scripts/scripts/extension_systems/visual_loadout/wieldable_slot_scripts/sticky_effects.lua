...
function StickyEffects:init(context, slot, weapon_template, fx_sources)
...
function StickyEffects:destroy()
	self:_stop_stickyness()
end

function StickyEffects:wield()
end

function StickyEffects:unwield()
	self:_stop_stickyness()
end

function StickyEffects:fixed_update(unit, dt, t, frame)
end

function StickyEffects:update(unit, dt, t)
...
function StickyEffects:update_first_person_mode(first_person_mode)
end
...
function StickyEffects:_start_stickyness(t)
...
function StickyEffects:_update_stickyness()
	local action_sweep_component = self._action_sweep_component
	local sticky_armor_type = _sticky_armor_type(action_sweep_component)
...
function StickyEffects:_stop_stickyness()
