...
function WarpChargeVentingEffects:destroy()
	self:_destroy_effects()
end

function WarpChargeVentingEffects:wield()
	self:_update_venting_effects()
end

function WarpChargeVentingEffects:unwield()
	self:_destroy_effects()
end

function WarpChargeVentingEffects:fixed_update(unit, dt, t, frame)
end

function WarpChargeVentingEffects:update(unit, dt, t)
	self:_update_venting_effects()
end

function WarpChargeVentingEffects:update_first_person_mode(first_person_mode)
	self._is_in_first_person = first_person_mode
end

function WarpChargeVentingEffects:_update_venting_effects()
...
function WarpChargeVentingEffects:_update_sfx(is_venting, action_settings)
...
function WarpChargeVentingEffects:_update_vfx(is_venting, action_settings)
...
function WarpChargeVentingEffects:_destroy_effects(is_venting, vent_source_name, additional_vent_source)
	local playing_id = self._wwise_playing_id
