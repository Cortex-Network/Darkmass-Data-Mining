...
function WeaponTemperatureEffects:destroy()
	if self._looping_sound_component.is_playing then
		self:_stop_looping_sound()
	end
end

function WeaponTemperatureEffects:fixed_update(unit, dt, t, frame)
end

function WeaponTemperatureEffects:update(unit, dt, t)
...
function WeaponTemperatureEffects:update_first_person_mode(first_person_mode)
end

function WeaponTemperatureEffects:wield()
end

function WeaponTemperatureEffects:unwield()
	if self._looping_sound_component.is_playing then
		self:_stop_looping_sound()
	end
end

function WeaponTemperatureEffects:_start_looping_sound()
...
function WeaponTemperatureEffects:_stop_looping_sound()
	if self._is_husk then
		return
	end
...
function WeaponTemperatureEffects:_update_wwise_source_parameter(override_parameter_value)
