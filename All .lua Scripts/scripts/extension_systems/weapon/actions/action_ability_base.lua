...
function ActionAbilityBase:init(action_context, action_params, action_settings)
...
function ActionAbilityBase:start(action_settings, t, time_scale, action_start_params)
...
function ActionAbilityBase:finish(reason, data, t, time_in_action)
...
function ActionAbilityBase:_use_charge()
	local action_settings = self._action_settings
