...
function ActionAimPlace:init(action_context, ...)
...
function ActionAimPlace:start(dt, t)
	self._action_component.rotation_step = 0
end

function ActionAimPlace:fixed_update(dt, t)
...
function ActionAimPlace:finish(reason, data, t, time_in_action)
