...
function ActionAimProjectile:fixed_update(dt, t, time_in_action)
...
function ActionAimProjectile:check_throw_posisition(throw_position, look_position, projectile_locomotion_template)
...
function ActionAimProjectile:finish(reason, data, t, time_in_action)
end
