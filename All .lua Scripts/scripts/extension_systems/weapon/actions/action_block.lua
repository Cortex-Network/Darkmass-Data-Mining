...
function ActionBlock:init(action_context, ...)
...
function ActionBlock:start(action_settings, t, time_scale, action_start_params)
...
function ActionBlock:fixed_update(dt, t, time_in_action)
	local weapon_lock_view_component = self._weapon_lock_view_component
...
function ActionBlock:running_action_state(t, time_in_action)
...
function ActionBlock:finish(reason, data, t, time_in_action)
