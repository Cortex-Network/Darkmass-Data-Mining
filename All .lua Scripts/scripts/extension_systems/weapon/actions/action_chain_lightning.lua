...
function ActionChainLightning:init(action_context, action_params, action_settings)
...
function ActionChainLightning:start(action_settings, t, ...)
...
function ActionChainLightning:_play_shoot_sound(is_critical_strike)
...
function ActionChainLightning:fixed_update(dt, t, time_in_action)
...
function ActionChainLightning:_validate_targets(t)
...
function ActionChainLightning:_find_new_targets(t)
...
function ActionChainLightning:_find_new_chain_targets(t, broadphase, enemy_side_names, max_angle, max_z_diff, max_jumps, radius, root_target, initial_travel_direction)
	local temp_targets = self._temp_targets
	local hit_units = self._hit_units
...
function ActionChainLightning:_deal_damage(t, time_in_action)
	local action_settings = self._action_settings
...
function ActionChainLightning:finish(reason, data, t, time_in_action)
	local fx_settings = self._action_settings.fx
...
function ActionChainLightning:running_action_state(t, time_in_action)
	local charge_template = self._weapon_extension:charge_template()
