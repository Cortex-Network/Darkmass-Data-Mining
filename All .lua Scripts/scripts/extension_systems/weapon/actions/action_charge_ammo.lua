...
function ActionChargeAmmo:start(action_settings, t, time_scale, action_start_params)
...
function ActionChargeAmmo:fixed_update(dt, t, time_in_action)
...
function ActionChargeAmmo:running_action_state(t, time_in_action)
