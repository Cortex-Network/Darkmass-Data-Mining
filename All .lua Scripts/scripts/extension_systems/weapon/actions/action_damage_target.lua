...
function ActionDamageTarget:init(action_context, action_params, action_settings)
...
function ActionDamageTarget:start(action_settings, t, time_scale, start_params)
...
function ActionDamageTarget:fixed_update(dt, t, time_in_action)
...
function ActionDamageTarget:_consume_charge_level()
...
function ActionDamageTarget:_deal_damage(charge_level)
	local action_settings = self._action_settings
	...
	ImpactEffect.play(target_unit, hit_actor, damage_dealt, damage_type, hit_zone_name, attack_result, hit_world_position, nil, attack_direction, player_unit, nil, , , damage_efficiency, damage_profile)
...
function ActionDamageTarget:finish(reason, data, t, time_in_action)
...
function ActionDamageTarget:_play_particles()
