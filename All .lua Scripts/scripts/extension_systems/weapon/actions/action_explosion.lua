...
function ActionExplosion:init(action_context, action_params, action_settings)
...
function ActionExplosion:start(action_settings, t, ...)
...
function ActionExplosion:_explode(charge_level)
...
function ActionExplosion:finish(reason, data, t, time_in_action)
