...
function ActionFlamerGas:init(action_context, action_params, action_settings)
...
function ActionFlamerGas:_setup_flame_data(action_settings)
	local fire_config = action_settings.fire_configuration
...
function ActionFlamerGas:start(action_settings, t, ...)
...
function ActionFlamerGas:_is_unit_blocking(unit, player_pos)
...
function ActionFlamerGas:_process_hit(hit, player_unit, player_pos, side_system, t, hit_units_this_frame, is_server)
...
function ActionFlamerGas:_do_raycast(i, position, rotation, max_range, num_rays_this_frame, spread_angle, player_unit, player_pos, side_system, t, hit_units_this_frame, is_server)
	local bullseye = true
...
function ActionFlamerGas:_acquire_targets(t)
...
function ActionFlamerGas:_hit_target(hit_unit, hit_pos)
...
function ActionFlamerGas:_damage_targets(dt, t)
...
function ActionFlamerGas:_damage_target(target_unit)
	local player_unit = self._player_unit
...
function ActionFlamerGas:_burn_targets(dt, t)
	local player_unit = self._player_unit
	local weapon_item = self._weapon.item
...
function ActionFlamerGas:_shoot(position, rotation, power_level, charge_level, t)
	local player_unit = self._player_unit
	local damage_config = self._flamer_gas_template.damage
	local damage_profile = damage_config.impact.damage_profile
...
function ActionFlamerGas:_acquire_suppressed_units(t)
...
function ActionFlamerGas:finish(reason, data, t, time_in_action)
...
function ActionFlamerGas:running_action_state(t, time_in_action)
	local action_settings = self._action_settings
	local fire_config = action_settings.fire_configuration
