...
function ActionFlamerGasBurst:init(action_context, action_params, action_settings)
...
function ActionFlamerGasBurst:_setup_flame_data(action_settings)
...
function ActionFlamerGasBurst:start(action_settings, t, ...)
...
function ActionFlamerGasBurst:fixed_update(dt, t, time_in_action)
...
function ActionFlamerGasBurst:_shoot(position, rotation, power_level, charge_level, t)
...
function ActionFlamerGasBurst:_is_unit_blocking(unit, player_pos)
...
function ActionFlamerGasBurst:_process_hit(hit, targets, player_unit, player_pos, side_system, dot_targets, t, is_server)
...
function ActionFlamerGasBurst:_do_raycast(i, position, rotation, max_range, num_rays_this_frame, spread_angle, targets, player_unit, player_pos, side_system, dot_targets, t, is_server)
	local bullseye = true
...
function ActionFlamerGasBurst:_acquire_targets(t)
...
function ActionFlamerGasBurst:_damage_target(target_unit)
	local player_unit = self._player_unit
	local damage_config = self._flamer_gas_template.damage
	local damage_profile = damage_config.impact.damage_profile
	local player_pos = POSITION_LOOKUP[player_unit]
...
function ActionFlamerGasBurst:_burn_target(t, target_unit)
	local player_unit = self._player_unit
	local weapon_item = self._weapon.item
...
function ActionFlamerGasBurst:_acquire_suppressed_units(t)
...
function ActionFlamerGasBurst:finish(reason, data, t, time_in_action)
