...
function ActionMeleeExplosive:init(action_context, action_params, action_settings)
...
function ActionMeleeExplosive:start(action_settings, t, ...)
...
function ActionMeleeExplosive:finish(reason, data, t, time_in_action)
...
function ActionMeleeExplosive:_explode(t)
	local action_settings = self._action_settings
...
function ActionMeleeExplosive:_process_hit(t, unit, hit_actor, hit_units, action_settings, hit_position, attack_direction, hit_zone_name_or_nil, hit_normal, action_sweep_component)
...
function ActionMeleeExplosive:_find_explosion_position_and_direction()
	local action_settings = self._action_settings
...
function ActionMeleeExplosive:_play_hit_animations(action_settings, abort_attack, armor_aborts_attack, special_active)
	local exploding_time = self._exploding_time
	local will_explode = not not exploding_time
