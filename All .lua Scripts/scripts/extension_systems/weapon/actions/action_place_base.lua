...
function ActionPlaceBase:init(action_context, ...)
...
function ActionPlaceBase:start(action_settings, t, time_scale, action_start_params)
...
function ActionPlaceBase:fixed_update(dt, t, time_in_action)
...
function ActionPlaceBase:_place_unit(action_settings, position, rotation, placed_on_unit)
	ferror("ActionPlaceBase is using base implementation of _place_unit, it shouldn't")
end

function ActionPlaceBase:_get_placement_data()
	local action_settings = self._action_settings
...
function ActionPlaceBase:_get_placement_data_from_component()
	local action_component = self._action_component
...
function ActionPlaceBase:_calculate_placement_data()
...
function ActionPlaceBase:_register_stats_and_telemetry(item_name, player_or_nil)
