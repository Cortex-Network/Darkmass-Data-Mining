...
function ActionRecall:init(action_context, action_params, action_settings)
...
function ActionRecall:start(action_settings, t, ...)
...
function ActionRecall:_restore_ability_charge(ability_type, num_charges_restored)
	local ability_extension = self._ability_extension

	ability_extension:restore_ability_charge(ability_type, num_charges_restored)
end

function ActionRecall:fixed_update(dt, t, time_in_action)
...
function ActionRecall:finish(reason, data, t, time_in_action)
	local action_settings = self._action_settings
	local ability_type = action_settings.ability_type
	local ability_extension = self._ability_extension
...
function ActionRecall:running_action_state(t, time_in_action)
	local action_settings = self._action_settings
	local ability_extension = self._ability_extension
	local ability_type = action_settings.ability_type
