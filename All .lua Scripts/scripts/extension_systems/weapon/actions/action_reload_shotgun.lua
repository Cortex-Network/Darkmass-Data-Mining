...
function ActionReloadShotgun:init(action_context, ...)
...
function ActionReloadShotgun:start(action_settings, t, time_scale, ...)
...
function ActionReloadShotgun:fixed_update(dt, t, time_in_action)
	self:_reload(time_in_action)
end

function ActionReloadShotgun:finish(reason, data, t, time_in_action)
	ActionReloadShotgun.super.finish(self, reason, data, t)
	self:_reload(time_in_action)
end

function ActionReloadShotgun:_reload(time_in_action)
	local action_reload_component = self._action_reload_component
...
function ActionReloadShotgun:running_action_state(t, time_in_action)
	local inventory_slot_component = self._inventory_slot_component
	local action_reload_component = self._action_reload_component
