...
function ActionReloadState:init(action_context, ...)
...
function ActionReloadState:start(action_settings, t, time_scale, ...)
...
function ActionReloadState:fixed_update(dt, t, time_in_action)
...
function ActionReloadState:_start_reload_state(reload_template, inventory_slot_component, action_reload_component, t)
...
function ActionReloadState:finish(reason, data, t, time_in_action)
...
function ActionReloadState:_update_functionality(reload_state, time_in_action, time_scale, dt, t)
	local inventory_slot_component = self._inventory_slot_component
...
function ActionReloadState:_calculate_next_state_transition(reload_template, inventory_slot_component, time_in_action, time_scale)
...
function ActionReloadState:_handle_state_transition(reload_template, inventory_slot_component, time_in_action, time_scale)
