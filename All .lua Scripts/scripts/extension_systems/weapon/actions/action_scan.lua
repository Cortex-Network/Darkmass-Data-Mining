...
function ActionScan:init(action_context, action_params, action_settings)
...
function ActionScan:start(action_settings, t, ...)
...
function ActionScan:fixed_update(dt, t, time_in_action)
	local scanning_compomnent = self._scanning_compomnent
...
function ActionScan:running_action_state(t, time_in_action)
...
function ActionScan:finish(reason, data, t, time_in_action)
