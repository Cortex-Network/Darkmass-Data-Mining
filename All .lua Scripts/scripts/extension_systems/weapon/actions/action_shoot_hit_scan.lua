...
function ActionShootHitScan:_shoot(position, rotation, power_level, charge_level)
	...
	if collision_tests then
		...
		local hits = HitScan.raycast(physics_world, position, direction, max_distance, nil, , rewind_ms, is_local_unit, player, is_server)
