...
function ActionShootPellets:init(action_context, action_params, action_settings)
...
function ActionShootPellets:start(...)
...
function ActionShootPellets:_shoot(position, rotation, power_level, charge_level, t)
...
function ActionShootPellets:_save_pellet_hits(hit_results, position, direction, max_distance, charge_level)
...
function ActionShootPellets:_process_hits(power_level, t)
...
function ActionShootPellets:_add_shotshell_buff(hit_unit, player_unit, damage_config, weapon_item, number_of_hit_pellets, t)
...
function ActionShootPellets:_can_play_impact_fx(hit_unit, num_impact_fx, max_hits_per_unit)
...
function ActionShootPellets:_next_fire_state(dt, t)
	local action_component = self._action_component
	local action_settings = self._action_settings
...
function ActionShootPellets:_prepare_shooting(...)
...
function ActionShootPellets:_scale_power_level_with_num_hits(shotshell_template, power_level)
