...
function ActionSmiteTargeting:init(action_context, action_params, action_settings)
...
function ActionSmiteTargeting:start(action_settings, t, time_scale, action_start_params)
...
function ActionSmiteTargeting:_calculate_charge_duration_of_target_health(action_settings)
...
function ActionSmiteTargeting:finish(reason, data, t, time_in_action, action_settings, chaining_action_params)
