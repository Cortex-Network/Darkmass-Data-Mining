...
function ActionTargetAlly:init(action_context, action_params, action_setting)
...
function ActionTargetAlly:start(action_settings, t, time_scale, action_start_params)
...
function ActionTargetAlly:fixed_update(dt, t, time_in_action)
...
function ActionTargetAlly:_find_target(time_in_action)
