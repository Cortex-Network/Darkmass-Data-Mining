...
function ActionTargetFinder:init(action_context, action_params, action_settings)
...
function ActionTargetFinder:start(action_settings, t, time_scale, action_start_params)
...
function ActionTargetFinder:fixed_update(dt, t, time_in_action)
	self._targeting_module:fixed_update(dt, t)
end

function ActionTargetFinder:finish(reason, data, t, time_in_action)
