...
function ActionThrow:init(action_context, ...)
...
function ActionThrow:start(action_settings, t, time_scale, action_start_params)
...
function ActionThrow:fixed_update(dt, t, time_in_action)
	local action_throw_component = self._action_throw_component
...
function ActionThrow:_throw_unit(existing_unit, throw_type)
