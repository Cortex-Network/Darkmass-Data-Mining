...
function ActionToggleWeaponSpecial:init(action_context, action_params, action_settings)
	ActionToggleWeaponSpecial.super.init(self, action_context, action_params, action_settings)
end

function ActionToggleWeaponSpecial:start(action_settings, t, ...)
...
function ActionToggleWeaponSpecial:fixed_update(dt, t, time_in_action)
...
function ActionToggleWeaponSpecial:finish(reason, data, t, time_in_action)
