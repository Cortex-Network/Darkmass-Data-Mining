...
function ActionUnaim:init(action_context, action_params, action_settings)
...
function ActionUnaim:start(action_settings, t, ...)
...
function ActionUnaim:finish(reason, data, t, time_in_action)
