...
function ActionUnwield:init(action_context, ...)
...
function ActionUnwield:start(action_settings, t, time_scale, action_start_params)
...
function ActionUnwield:_next_slot(used_input, action_settings)
...
function ActionUnwield:finish(reason, data, t, time_in_action)
end
