...
function ActionVentOverheat:init(action_context, action_params, action_settings)
...
function ActionVentOverheat:start(action_settings, t, time_scale, action_start_params)
...
function ActionVentOverheat:fixed_update(dt, t, time_in_action)
...
function ActionVentOverheat:_deal_damage()
...
function ActionVentOverheat:finish(reason, data, t, time_in_action)
...
function ActionVentOverheat:running_action_state(t, time_in_action)
	local current_heat = self._inventory_slot_component.overheat_current_percentage
