...
function ActionWeaponBase:init(action_context, action_params, action_settings)
...
function ActionWeaponBase:start(action_settings, t, time_scale, action_start_params)
...
function ActionWeaponBase:_use_ability_charge()
...
function ActionWeaponBase:_check_for_critical_strike()
	local critical_strike_component = self._critical_strike_component
...
function ActionWeaponBase:_increase_action_duration(additional_time)
...
function ActionWeaponBase:_add_weapon_blood(amount)
...
function ActionWeaponBase:_set_weapon_special(active, t)
...
function ActionWeaponBase:_pay_warp_charge_cost(t, charge_level)
