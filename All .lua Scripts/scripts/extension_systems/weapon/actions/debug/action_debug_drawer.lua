...
function ActionDebugDrawer:init(action_settings, weapon_action_component)
...
function ActionDebugDrawer:reset()
	self._variables = {}
	self._timeline_bars = {}
end

function ActionDebugDrawer:draw()
	...
	self:_draw_action_name(gui, bg_pos)
...
function ActionDebugDrawer:add_variable(name, source, id)
...
function ActionDebugDrawer:add_timeline_bar(name, indicators)
...
function ActionDebugDrawer:_added_background_height()
...
function ActionDebugDrawer:_draw_background(gui, added_height)
...
function ActionDebugDrawer:_draw_action_name(gui, anchor_position)
	local font_size = 18
...
function ActionDebugDrawer:_draw_chain_actions(gui, anchor_position, anchor_size)
...
function ActionDebugDrawer:_draw_timeline_indicator(gui, anchor_position, anchor_size)
	local bar_size_x = TIMELINE_SIZE_X
	local weapon_action_component = self._weapon_action_component
...
function ActionDebugDrawer:_draw_timeline_bars(gui, anchor_position, anchor_size)
	local bar_size_x = TIMELINE_SIZE_X
...
function ActionDebugDrawer:_draw_variables(gui, anchor_position)
...
function _action_timeline(weapon_action_component, action_settings)
	...
	return action_end_t - action_start_t
end
