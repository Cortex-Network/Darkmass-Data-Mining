...
function ClosestTargetingActionModule:start(action_settings, t)
...
function ClosestTargetingActionModule:fixed_update(dt, t)
...
function ClosestTargetingActionModule:finish(reason, data, t)
