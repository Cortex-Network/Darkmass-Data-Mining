...
function SmartTargetingActionModule:init(physics_world, player_unit, component, action_settings)
...
function SmartTargetingActionModule:start(action_settings, t)
...
function SmartTargetingActionModule:fixed_update(dt, t)
...
function SmartTargetingActionModule:finish(reason, data, t)
