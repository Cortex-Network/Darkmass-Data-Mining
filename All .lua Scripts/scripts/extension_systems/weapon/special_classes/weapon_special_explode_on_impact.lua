...
function WeaponSpecialExplodeOnImpact:init(context, init_data)
...
function WeaponSpecialExplodeOnImpact:update(dt, t)
...
function WeaponSpecialExplodeOnImpact:process_hit(t, weapon, action_settings, num_hit_enemies, target_is_alive, target_unit, hit_position, attack_direction, optional_origin_slot)
...
function WeaponSpecialExplodeOnImpact:on_action_start(t, num_hit_enemies)
	self._num_hit_enemies = 0
end

function WeaponSpecialExplodeOnImpact:on_action_finish(t, num_hit_enemies)
...
function WeaponSpecialExplodeOnImpact:on_exit_damage_window(t, num_hit_enemies)
	if num_hit_enemies and num_hit_enemies > 0 then
		local inventory_slot_component = self._inventory_slot_component
		inventory_slot_component.special_active = false
		inventory_slot_component.num_special_activations = 0
