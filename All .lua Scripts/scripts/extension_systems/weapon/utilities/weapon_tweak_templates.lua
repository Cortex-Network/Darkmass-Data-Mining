...
function WeaponTweakTemplates.preparse_weapon_template(weapon_template)
...
function WeaponTweakTemplates.create(lerp_values, weapon_template, override_lerp_value_or_nil)
	local templates = {}
...
function WeaponTweakTemplates.calculate_lerp_values(weapon_template, base_stats, overclocks, perks, traits, override_lerp_value)
	local weapon_tweaks = {}
	local base_template_lookup = weapon_template.__base_template_lookup
...
function WeaponTweakTemplates.extract_buffs(weapon_template)
	local buffs = {
...
function WeaponTweakTemplates.extract_trait_buffs(weapon_template, buffs, traits, debug_traits)
	local weapon_name = weapon_template.name
