...
function Weapon:init(init_data)
...
function Weapon:_init_weapon_special_implementation(weapon_template, weapon_special_context)
...
function Weapon:_init_traits(weapon_template, item, override_trait_lerp_value_or_nil, override_tweak_template_lerp_value_or_nil, weapon_progression_debug)
	...
	local debug_perks = weapon_progression_debug and weapon_progression_debug.perks
