...
function WeaponActionMovementDrawer:init(weapon_action_movement, unit_data_extension)
...
function WeaponActionMovementDrawer:update(dt, t)
...
function WeaponActionMovementDrawer:fixed_update(dt, t)
	self._fixed_t = t
end
...
function WeaponActionMovementDrawer:_draw_movement_curve(movement_curve, start_t, end_t, current_t)
