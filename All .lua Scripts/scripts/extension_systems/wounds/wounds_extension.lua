...
function WoundsExtension:init(extension_init_context, unit, extension_init_data, game_object_data_or_game_session, nil_or_game_object_id)
...
function WoundsExtension:destroy()
...
function WoundsExtension:game_object_initialized(game_session, game_object_id)
	self._game_object_id = game_object_id
	self._game_session = game_session
end

function WoundsExtension:set_unit_local()
...
function WoundsExtension:wounds_data()
	return self._wounds_data
end

function WoundsExtension:add_wounds(wounds_template, hit_world_position, hit_actor_node_index, attack_result, percent_damage_dealt, damage_type, hit_zone_name_or_nil, override_wound_shape_or_nil)
...
function WoundsExtension:rpc_minion_add_wounds(channel_id, go_id, wounds_template_id, hit_world_position, hit_actor_node_index, attack_result_id, percent_damage_dealt, damage_type_id, hit_zone_id_or_nil, override_wounds_shape_id_or_nil)
