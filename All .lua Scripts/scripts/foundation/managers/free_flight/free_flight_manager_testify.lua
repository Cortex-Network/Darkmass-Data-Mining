...
function FreeFlightManagerTestify.enter_free_flight(_, free_flight_manager)
...
function FreeFlightManagerTestify.set_free_flight_camera_position(camera_data, free_flight_manager)
...
function FreeFlightManagerTestify.free_flight_camera_follow_main_path(speed, free_flight_manager)
	free_flight_manager:toggle_follow_path()
	free_flight_manager:set_follow_path_speed(speed)
end

function FreeFlightManagerTestify.free_flight_camera_is_arrived_end_of_main_path(_, free_flight_manager)
