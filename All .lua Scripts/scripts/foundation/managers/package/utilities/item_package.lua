...
function ItemPackage.level_resource_dependency_packages(item_definitions, level_name, item_data)
...
function ItemPackage.compile_resource_dependencies(item_entry_data, resource_dependencies)
...
function ItemPackage.compile_items_dependencies(items, items_dictionary, optional_mission_template)
	local result = {}
...
function ItemPackage.compile_item_dependencies(item, items_dictionary, out_result, optional_mission_template)
...
function ItemPackage.compile_item_instance_dependencies(item, items_dictionary, out_result, optional_mission_template)
	local result = out_result or {}
...
function ItemPackage._resolve_item_packages_recursive(attachments, items_dictionary, result)
