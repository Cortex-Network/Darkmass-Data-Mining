...
function ParameterResolver.resolve_command_line()
	local args = {
		Application.argv()
	}
...
function ParameterResolver.resolve_dev_parameters()
	...
	function ParameterResolver.set_dev_parameter(param, value)
	...
	function ParameterResolver.load_config(index)
	...
	function ParameterResolver.save_config(index, mode)
	...
	function ParameterResolver.reset_defaults()
		local defaults = DefaultDevParameters
...
function ParameterResolver.resolve_game_parameters()
	...
	function ParameterResolver.resolve_dynamic_game_parameters(overrides)
