...
function GameplayInitStepFinalizeExtensions:init()
	self._skipped_first_update = false
end

function GameplayInitStepFinalizeExtensions:on_enter(parent, params)
...
function GameplayInitStepFinalizeExtensions:update(main_dt, main_t)
