...
function GameplayInitStepManagers:on_enter(parent, params)
...
function GameplayInitStepManagers:_init_unit_spawner(world, is_server, level_name, network_event_delegate)
...
function GameplayInitStepManagers:_init_player_unit_spawn(is_server, level_seed, mission_name, network_event_delegate, soft_cap_out_of_bounds_units)
...
function GameplayInitStepManagers:_init_terror_event(world, is_server, network_event_delegate, mission_name, level_name)
	local mission = MissionTemplates[mission_name]
