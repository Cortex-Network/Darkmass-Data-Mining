...
function StateExitToMainMenu:on_enter(parent, params, creation_context)
...
function StateExitToMainMenu:_start_loading()
...
function StateExitToMainMenu:_update_loading()
...
function StateExitToMainMenu:update(main_dt, main_t)
...
function StateExitToMainMenu:on_exit()
