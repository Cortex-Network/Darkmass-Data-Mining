...
function StateGameScore:_present_end_of_round_view()
	...
	Managers.ui:open_view(eor_view_name, nil, , , , view_context)
...
function StateGameScore:_continue()
	local done = true
...
function StateGameScore:update(main_dt, main_t)
...
function StateGameScore:on_exit()
