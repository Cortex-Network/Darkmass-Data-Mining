...
function StateMainMenuTestify.create_random_character(_, state_main_menu)
...
function StateMainMenuTestify.wait_for_profile_synchronization(_, state_main_menu)
