...
function StateMissionServerExit:on_enter(parent, params, creation_context)
...
function StateMissionServerExit:on_exit()
end

function StateMissionServerExit:update(dt)
