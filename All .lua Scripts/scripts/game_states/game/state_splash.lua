...
function StateSplash:on_enter(parent, params, creation_context)
...
function StateSplash:_continue_cb()
	self._continue = true
end

function StateSplash:update(main_dt, main_t)
