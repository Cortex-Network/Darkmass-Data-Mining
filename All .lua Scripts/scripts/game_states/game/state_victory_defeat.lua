...
function StateVictoryDefeat:on_enter(parent, params, creation_context)
...
function StateVictoryDefeat:update(main_dt, main_t)
...
function StateVictoryDefeat:on_exit()
	self._end_result = nil
end

function StateVictoryDefeat:end_result()
