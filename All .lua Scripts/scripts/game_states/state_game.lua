...
function StateGame:on_enter(parent, params)
...
function StateGame:_init_managers(package_manager, localization_manager, event_delegate, approve_channel_delegate)
...
function StateGame:on_reload(refreshed_resources)
...
function StateGame:current_state_name()
	return self._sm:current_state_name()
end

function StateGame:state_machine()
	return self._sm
end
