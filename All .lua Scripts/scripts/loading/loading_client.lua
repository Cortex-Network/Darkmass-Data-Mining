...
function LoadingClient:init(network_delegate, host_channel_id, loaders)
	...
	state_machine:add_transition("LocalDetermineLevelState", "mission_determined", LocalDetermineSpawnGroupState)
	...
	state_machine:add_transition("LocalDetermineSpawnGroupState", "spawn_group_set_mission", LocalLoadersState)
	...
	state_machine:add_transition("LocalWaitForMissionBriefingDoneState", "mission_briefing_done", LocalIngameState)
	...
	state_machine:add_transition("LocalIngameState", "load_mission", LocalDetermineSpawnGroupState)
...
function LoadingClient:load_mission(mission_name, level_name, circumstance_name)
	local shared_state = self._shared_state
