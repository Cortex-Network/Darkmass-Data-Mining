...
function PackageSynchronizerClient:init(peer_id, is_host, network_delegate, host_channel_id)
...
function PackageSynchronizerClient:init_item_definitions(item_definitions)
...
function PackageSynchronizerClient:item_definitions_initialized()
	return self._item_definitions and true
end

function PackageSynchronizerClient:set_mission_name(mission_name)
	self._mission_name = mission_name
end

function PackageSynchronizerClient:add_peer(peer_id)
...
function PackageSynchronizerClient:remove_peer(peer_id)
...
function PackageSynchronizerClient:add_bot(peer_id, local_player_id)
	local data = self._packages[peer_id]
...
function PackageSynchronizerClient:remove_bot(peer_id, local_player_id)
	local data = self._packages[peer_id]
...
function PackageSynchronizerClient:resolve_profile_packages(profile)
...
function PackageSynchronizerClient:_resolve_item_packages(items, profile_packages, mission)
...
function PackageSynchronizerClient:_resolve_base_units(items, profile_packages)
	local dependencies = {}
...
function PackageSynchronizerClient:_resolve_ability_packages(archetype, specialization_name, talents, profile_packages, mission)
...
function PackageSynchronizerClient:_resolve_profile_properties(items, archetype, sound_dependencies, particle_dependencies)
...
function PackageSynchronizerClient:_resolve_specialization(archetype, sound_dependencies, particle_dependencies)
...
function PackageSynchronizerClient:update(dt, hosted_synchronizer_host)
...
function PackageSynchronizerClient:_update_package_loading(template, hosted_synchronizer_host)
...
function PackageSynchronizerClient:_handle_dependency_loading(package_data, prioritize)
...
function PackageSynchronizerClient:_load_dependencies(dependencies, prioritize)
...
function PackageSynchronizerClient:_update_unload_delayer(dt)
...
function PackageSynchronizerClient:set_package_prioritization_template(template_name)
	local template = PackagePrioritizationTemplates[template_name]

	self:_set_package_prioritization(template)
end

function PackageSynchronizerClient:reevaluate_all_profiles_packages()
	local packages = self._packages
...
function PackageSynchronizerClient:chached_profile(peer_id, local_player_id)
...
function PackageSynchronizerClient:_unload_alias_dependencies(package_data)
...
function PackageSynchronizerClient:_get_loaded_packages_from_peer_packages(peer_packages, input_array)
...
function PackageSynchronizerClient:_get_loaded_packages_from_player_packages(player_packages, input_array)
	for _, package_data in pairs(player_packages) do
		self:_get_loaded_packages_from_package_data(package_data, input_array)
	end
end

function PackageSynchronizerClient:_get_loaded_packages_from_package_data(package_data, input_array)
	if package_data.state ~= LOADING_STATES.ready_to_load then
		for package_name, id in pairs(package_data.dependencies) do
...
function PackageSynchronizerClient:_handle_dependency_differences(new_package_data, package_data, package_ids)
...
function PackageSynchronizerClient:enable_peers(peer_ids)
	local packages = self._packages
...
function PackageSynchronizerClient:_make_aliases_dirty(peer_id, local_player_id)
	local packages = self._packages
...
function PackageSynchronizerClient:peer_enabled(peer_id)
	local peer_data = self._packages[peer_id]

	return peer_data.enabled
end

function PackageSynchronizerClient:alias_loaded(peer_id, local_player_id, alias)
...
function PackageSynchronizerClient:_add_to_unload_delayer(package_ids)
	local unload_delayer = self._unload_delayer
...
function PackageSynchronizerClient:rpc_package_synchronizer_enable_peers(channel_id, peer_ids)
	self:enable_peers(peer_ids)
end

function PackageSynchronizerClient:rpc_set_package_prioritization(channel_id, template_id)
...
function PackageSynchronizerClient:_set_package_prioritization(template)
...
function PackageSynchronizerClient:rpc_set_alias_version(channel_id, peer_id, local_player_id, alias_version)
...
function PackageSynchronizerClient:rpc_player_profile_packages_changed(channel_id, peer_id, local_player_id, alias_version)
	self:_set_player_alias_version(peer_id, local_player_id, alias_version)
...
function PackageSynchronizerClient:_set_player_alias_version(peer_id, local_player_id, alias_version)
...
function PackageSynchronizerClient:rpc_reevaluate_all_profile_packages(channel_id)
	self:reevaluate_all_profiles_packages()
end

function PackageSynchronizerClient:rpc_package_synchronizer_set_mission_name(channel_id, mission_name_id)
