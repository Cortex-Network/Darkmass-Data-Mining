...
function ProfileSynchronizerClient:init(event_delegate)
	self._event_delegate = event_delegate
	self._peer_profile_chunks = {}
	self._peer_profiles_json = {}
end

function ProfileSynchronizerClient:register_rpcs(channel_id)
	self._channel_id = channel_id

	self._event_delegate:register_connection_channel_events(self, channel_id, unpack(RPCS))
end

function ProfileSynchronizerClient:peer_profile_chunks_array(peer_id, local_player_id_array)
...
function ProfileSynchronizerClient:player_profile_json(peer_id, local_player_id)
...
function ProfileSynchronizerClient:destroy()
...
function ProfileSynchronizerClient:rpc_start_profile_sync(channel_id, peer_id, local_player_id)
...
function ProfileSynchronizerClient:rpc_sync_player_profile_data(channel_id, peer_id, local_player_id, profile_chunk)
	local peer_profile_chunks = self._peer_profile_chunks
...
function ProfileSynchronizerClient:rpc_profile_sync_complete(channel_id, peer_id, local_player_id)
	RPC.rpc_player_profile_synced(channel_id, peer_id, local_player_id)
end

function ProfileSynchronizerClient:rpc_profile_synced_by_all(channel_id, peer_id, local_player_id)
...
function ProfileSynchronizerClient:rpc_profile_sync_peer_disconnected(channel_id, peer_id)
