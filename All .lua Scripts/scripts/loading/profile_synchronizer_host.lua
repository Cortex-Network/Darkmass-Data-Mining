...
function ProfileSynchronizerHost:init(event_delegate)
...
function ProfileSynchronizerHost:register_rpcs(channel_id)
...
function ProfileSynchronizerHost:sync_player_profile(channel_id, peer_id, local_player_id, profile_chunks)
...
function ProfileSynchronizerHost:_update_sync_states(channel_id, sync_peer_id, sync_local_player_id)
...
function ProfileSynchronizerHost:start_initial_sync(channel_id, peer_id, local_player_ids)
...
function ProfileSynchronizerHost:completed_initial_syncs()
...
function ProfileSynchronizerHost:add_bot(local_player_id, profile)
...
function ProfileSynchronizerHost:profile_changed(peer_id, local_player_id)
...
function ProfileSynchronizerHost:override_slot(peer_id, local_player_id, slot_name, item_name)
	local player = Managers.player:player(peer_id, local_player_id)
...
function ProfileSynchronizerHost:override_singleplay_profile(peer_id, local_player_id, new_profile)
...
function ProfileSynchronizerHost:is_player_synced_to_peer(peer_id, player_peer_id, local_player_id)
	local profile_sync_states = self._profile_sync_states
...
function ProfileSynchronizerHost:peer_connected(peer_id, channel_id)
	self._connected_peers[peer_id] = channel_id
end

function ProfileSynchronizerHost:peer_disconnected(peer_id, channel_id)
	local profile_sync_states = self._profile_sync_states
...
function ProfileSynchronizerHost:update(dt)
...
function ProfileSynchronizerHost:destroy()
...
function ProfileSynchronizerHost:rpc_player_profile_synced(channel_id, profile_peer_id, profile_local_player_id)
	local peer_id = Network.peer_id(channel_id)
...
function ProfileSynchronizerHost:rpc_notify_profile_changed(channel_id, peer_id, local_player_id)
	local player = Managers.player:player(peer_id, local_player_id)
