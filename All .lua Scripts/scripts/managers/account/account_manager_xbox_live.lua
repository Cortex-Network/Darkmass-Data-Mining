...
function AccountManagerXboxLive:gamertag()
...
function AccountManagerXboxLive:refresh_communcation_restrictions()
...
function AccountManagerXboxLive:user_restriction_updated(xuid, restriction)
