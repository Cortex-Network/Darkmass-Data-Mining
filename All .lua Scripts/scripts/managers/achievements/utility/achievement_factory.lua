...
function AchievementFactory.create_family_from_triggers(description, ui_type, icon, category, triggers, optional_show_in_progress, optional_description_table, optional_unique_descriptions)
...
function AchievementFactory.create_family(description, ui_type, icon, category, TriggerType, trigger, targets, optional_show_in_progress, optional_description_table)
...
function AchievementFactory.create_unique(id, ui_type, icon, category, trigger_component, optional_hidden, optional_description_table)
