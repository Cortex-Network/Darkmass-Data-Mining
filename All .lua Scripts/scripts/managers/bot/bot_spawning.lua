...
function BotSpawning.spawn_bot_character(profile_name)
...
function BotSpawning.despawn_bot_character(local_player_id, despawn_safe)
	local is_server = Managers.state.game_session:is_server()
...
function BotSpawning.despawn_best_bot()
	local bot_synchronizer_host = Managers.bot:synchronizer_host()
