...
function BotNavTransition.check_nav_mesh(wanted_from, wanted_to, nav_world, traverse_logic, drawer)
...
function BotNavTransition.calculate_nav_tag_layer(from, to, player_jumped)
...
function BotNavTransition.resolve_waypoint_position(from, via, player_jumped, physics_world)
	local waypoint = nil
