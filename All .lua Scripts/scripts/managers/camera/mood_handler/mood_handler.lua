...
function MoodHandler:init(world, player)
	self._world = world
	self._player = player
...
function MoodHandler:update_moods(blend_list, moods_data)
...
function MoodHandler:update_active_moods(mood_data)
...
function MoodHandler:_update_sounds(added_moods, removing_moods, removed_moods, moods_data)
...
function MoodHandler:_spawn_particles(particle_name)
...
function MoodHandler:_update_particles(added_moods, removing_moods, removed_moods, moods_data)
	local world = self._world
...
function MoodHandler:_blend_list(blend_list, moods_data)
