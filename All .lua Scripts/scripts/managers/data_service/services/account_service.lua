...
function AccountService:signin()
...
function AccountService:_has_created_first_character()
	return Managers.backend.interfaces.account:get_has_created_first_character():next(function (value)
		return value == true or value == "true"
	end)
end

function AccountService:set_has_created_first_character()
...
function AccountService:set_selected_character_id(character_id)
...
function AccountService:has_completed_onboarding()
	return self._has_completed_onboarding
end

function AccountService:set_has_completed_onboarding()
...
function AccountService:pull_achievement_data(optional_account_id, optional_achievement_definitions)
...
function AccountService:get_achievements()
...
function AccountService:unlock_achievement(achievement_id)
