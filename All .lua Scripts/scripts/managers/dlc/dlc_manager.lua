...
function DLCManager:_try_check_steam_dlc(t)
...
function DLCManager:_try_evaluate_consumables(t)
	if not self._initialized then
		return
	end
...
function DLCManager:cb_get_entitlements(data)
...
function DLCManager:cb_query_backend_result(data)
...
function DLCManager:is_dlc_unlocked(dlc_name)
...
function DLCManager:update(dt, t)
...
function DLCManager:trigger_new_durable_dlc_popup(dlc_details)
	local context = {
		title_text = "loc_popup_header_new_dlc_installed",
		description_text = "loc_dlc_installed",
		description_text_params = {
...
function DLCManager:_handle_dangling_pending_dlcs()
...
function DLCManager:_change_state(state_name)
...
function DLCStates.none()
end

function DLCStates.idle(dlc_manager, dt, t)
...
function DLCStates.check_durable_licenses(dlc_manager, dt, t)
...
function DLCStates.handle_status_changes(dlc_manager, dt, t)
	local dlcs = dlc_manager._durable_dlcs
...
function DLCStates.present_rewards(dlc_manager, dt, t)
