...
function ErrorManager:report_error(error_object)
...
function ErrorManager:show_errors()
...
function ErrorManager:has_error()
	return #self._error_queue > 0
end

function ErrorManager:wanted_transition()
