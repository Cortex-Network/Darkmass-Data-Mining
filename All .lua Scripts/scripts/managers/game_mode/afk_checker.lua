...
function AFKChecker:init(is_server, settings, network_event_delegate)
...
function AFKChecker:server_update(dt, t)
...
function AFKChecker:_warning(player_id, enabled)
...
function AFKChecker:_kick(player_id)
	local player = Managers.player:player_from_unique_id(player_id)
	local peer_id = player:peer_id()
...
function AFKChecker:rpc_report_menu_activity(channel_id)
...
function AFKChecker:rpc_inactivity_warning(channel_id, enable_warning)
...
function AFKChecker:_show_warning_popup()
	local context = {
...
function AFKChecker:_hide_warning_popup()
...
function AFKChecker:client_update(dt, t)
