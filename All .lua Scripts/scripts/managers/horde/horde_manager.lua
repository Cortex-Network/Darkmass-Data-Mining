...
function HordeManager:init(nav_world, physics_world)
	self._hordes = {}
...
function HordeManager:horde(horde_type, horde_template_name, side_id, target_side_id, composition, ...)
...
function HordeManager:num_active_hordes(horde_type)
	if horde_type then
...
function HordeManager:horde_positions(horde_type)
...
function HordeManager:num_alive(horde_type)
	return self._total_alive_horde_minions[horde_type]
end

function HordeManager:update(dt, t)
