...
function ImguiBehaviorTree:init()
...
function ImguiBehaviorTree:update(dt, t)
...
function ImguiBehaviorTree:_clear_history()
...
function ImguiBehaviorTree:_save_history(running_leaf_node, behavior_tree, blackboard)
	local index = 1
...
function ImguiBehaviorTree:_update_history_slider()
...
function ImguiBehaviorTree:_update_left_panel()
...
function ImguiBehaviorTree:_draw_blackboard_values(data, config)
...
function ImguiBehaviorTree:_update_grid()
	Imgui.same_line(10)
...
function ImguiBehaviorTree:_draw_grid(position_x, position_y, width, height)
...
function ImguiBehaviorTree:_draw_behavior_tree(position_x, position_y, behavior_tree, running_hierarchy)
...
function ImguiBehaviorTree:_draw_nodes(node, running_hierarchy, x, y, formatting_config, link_out_x, link_out_y)
...
function ImguiBehaviorTree:_draw_node(node, running_hierarchy, x, y, formatting_config, link_out_x, link_out_y)
...
function ImguiBehaviorTree:_calculate_node_text_extents(class_name, node_name, condition_name, text_distance)
