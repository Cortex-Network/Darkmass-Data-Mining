...
function ImguiDevParametersGui:init(config)
	self:_parse_config(config)
	self:_setup_filter(config)
	self:_setup_widget_collections()
end

function ImguiDevParametersGui:_get_dev_param_value(param_key, get_function)
	return DevParameters[param_key]
end

function ImguiDevParametersGui:_set_dev_param_value(param_key, on_value_set, new_value, old_value)
...
function ImguiDevParametersGui:_parse_config(config)
...
function ImguiDevParametersGui:_create_widget_from_config(param_key, config, category)
...
function ImguiDevParametersGui:_setup_filter(config)
...
function ImguiDevParametersGui:_setup_widget_collections()
...
function ImguiDevParametersGui:_get_filter_by_defaults()
	return self._filter_by_defaults
end

function ImguiDevParametersGui:_set_filter_by_defaults(value)
...
function ImguiDevParametersGui:_get_filter_string()
	return self._filter_string
end

function ImguiDevParametersGui:_set_filter_string(value)
...
function ImguiDevParametersGui:on_activated()
...
function ImguiDevParametersGui:update(dt, t)
	self:_render()
	self:_update_navigation()
end

function ImguiDevParametersGui:_render()
...
function ImguiDevParametersGui:_update_navigation()
...
function ImguiDevParametersGui:_filter_tree(filter_string, filter_defaults, filter_func)
...
function ImguiDevParametersGui:_filter_list(filter_string, filter_defaults, filter_func)
