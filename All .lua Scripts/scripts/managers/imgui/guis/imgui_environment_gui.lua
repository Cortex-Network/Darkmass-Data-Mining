...
function ImguiEnvironmentGui:init()
end

function ImguiEnvironmentGui._set_header_texts(...)
...
function ImguiEnvironmentGui._set_column_widths(...)
	local num_columns = select("#", ...)
...
function ImguiEnvironmentGui:update(dt, t)
