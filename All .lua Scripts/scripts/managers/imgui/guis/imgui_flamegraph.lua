...
function ImguiFlamegraph:destroy()
...
function ImguiFlamegraph:do_cell(gui, cursor, name, record, s, w, h, x, y)
...
function ImguiFlamegraph:update()
...
function ImguiFlamegraph:clear_data()
...
function ImguiFlamegraph:reset_zoom()
	self._draw_name = "@root"
	self._draw_node = ImguiFlamegraph._root
end

function ImguiFlamegraph:profile_cb(thread, samples, vmmode)
...
function ImguiFlamegraph:toggle_recording(bool)
	if bool == nil then
...
function ImguiFlamegraph:toggle_rendering(bool)
	if bool == nil then
