...
function ImguiInputGui:init(...)
	self._input_manager = Managers.input
end

function ImguiInputGui:on_activated()
	self._input_manager:activate_tracking()
end

function ImguiInputGui:on_deactivated()
	self._input_manager:deactivate_tracking()
end

function ImguiInputGui._set_header_texts(...)
...
function ImguiInputGui._set_column_widths(...)
	local num_columns = select("#", ...)
...
function ImguiInputGui._column_entry(text, mark, mark_color)
...
function ImguiInputGui._selectable_entry(id, text, prev_selected)
...
function ImguiInputGui._prev_value_text(action, t)
	local text = ""
...
function ImguiInputGui:raw_device(device_type)
...
function ImguiInputGui:update(dt, t)
