...
function ImguiWidgetUtilities.wrap_array(array, index, step)
	local size = #array
...
function ImguiWidgetUtilities.calculate_max_text_size(texts)
	local max_width = 0
	local max_height = 0
...
function ImguiWidgetUtilities.dropdown_value_to_string(value, number_format)
...
function ImguiWidgetUtilities.filter_array(source_table, result_table, filter_string, filter_function)
...
function ImguiWidgetUtilities.filter_array_defaults(source_table, result_table, current_values, defaults)
	local filter = {}
...
function ImguiWidgetUtilities.create_unique_label(optional_name)
