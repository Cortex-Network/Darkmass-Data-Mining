...
function InputService:update(t, dt)
...
function InputService:_evaluate_filters(t, dt)
...
function InputService:reverse_lookup(action_name, device_types)
	local action_rule = self._actions[action_name]
...
function InputService:devices(device_type)
...
function InputService:get(action_name)
	local action_rule = self._actions[action_name]
