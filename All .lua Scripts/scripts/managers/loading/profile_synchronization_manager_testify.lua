...
function ProfileSynchronizationManagerTestify.equip_item(data, profile_synchronization_manager)
...
function ProfileSynchronizationManagerTestify.equip_item_backend(data, profile_synchronization_manager)
	local item = data.item
	local player = data.player
