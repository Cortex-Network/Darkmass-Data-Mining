...
function SpawnPointQueries.update_time_slice_nav_spawn_points(time_slice_data, nav_spawn_points, spawn_point_positions)
...
function SpawnPointQueries.group_from_position(nav_world, nav_spawn_points, position, optional_above, optional_below)
...
function SpawnPointQueries.occluded_positions_in_group(nav_world, nav_spawn_points, group_index, occluded_from_positions)
	local num_groups, num_sub_groups = GwNavSpawnPoints.get_count(nav_spawn_points)
...
function SpawnPointQueries.get_occluded_positions(nav_world, nav_spawn_points, from_position, side, offset_range, num_groups, optional_min_distance, optional_max_distance, optional_initial_offset, optional_only_search_forward)
...
function SpawnPointQueries.get_random_occluded_position(nav_world, nav_spawn_points, from_position, side, offset_range, num_groups, optional_min_distance, optional_max_distance, optional_initial_offset, optional_only_search_forward)
