...
function MechanismBase:init(mechanism_name, network_event_delegate, mechanism_context, optional_teams)
...
function MechanismBase:settings()
...
function MechanismBase:_proceed_to_next_state()
