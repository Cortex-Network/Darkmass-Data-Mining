...
function MinionRagdoll:cleanup_ragdolls()
...
function MinionRagdoll:update(soft_cap_out_of_bounds_units)
...
function MinionRagdoll:_update_delayed_ragdoll_push_cache()
...
function MinionRagdoll:_clear_delayed_ragdoll_push_entry(index)
	local delayed_ragdoll_push_cache = self._delayed_ragdoll_push_cache
...
function MinionRagdoll:create_ragdoll(death_data)
...
function MinionRagdoll:_remove_ragdoll(unit)
...
function MinionRagdoll:remove_ragdoll_safe(unit)
	local ragdolls = self._ragdolls
...
function MinionRagdoll:push_ragdoll(unit, attack_direction, damage_profile, hit_zone_name, herding_template_or_nil)
