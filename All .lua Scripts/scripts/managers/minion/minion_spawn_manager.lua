...
function MinionSpawnManager:init(level_seed, soft_cap_out_of_bounds_units, network_event_delegate)
...
function MinionSpawnManager:update(dt, t)
...
function MinionSpawnManager:spawn_minion(breed_name, position, rotation, side_id, optional_aggro_state, optional_target_unit, optional_spawner_unit, optional_group_id, optional_mission_objective_id, optional_attack_selection_template_name)
...
function MinionSpawnManager:queue_minion_to_spawn(breed_name, position, rotation, side_id, optional_aggro_state, optional_target_unit, optional_spawner_unit, optional_group_id, optional_mission_objective_id, optional_attack_selection_template_name)
...
function MinionSpawnManager:_update_spawn_queue()
...
function MinionSpawnManager:_initialize_inventory(unit, breed, blackboard, optional_attack_selection_template_name)
...
function MinionSpawnManager:_initialize_blackboard_components(breed, blackboard, seed, optional_spawner_unit)
...
function MinionSpawnManager:_register_minion_to_objective(unit, optional_mission_objective_id)
...
function MinionSpawnManager:unregister_unit(unit)
...
function MinionSpawnManager:despawn_all_minions()
	local spawned_minions = self._spawned_minions
...
function MinionSpawnManager:despawn(unit)
...
function MinionSpawnManager:num_spawned_minions()
