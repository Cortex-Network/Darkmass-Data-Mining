...
function ConnectionManagerTestify.register_testify_connection_events(connection_manager)
...
function ConnectionManagerTestify.unregister_testify_connection_events(connection_manager)
