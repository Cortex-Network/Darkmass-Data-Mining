...
function HordePacing:init(nav_world)
...
function HordePacing:update(dt, t, side_id, target_side_id)
...
function HordePacing:_update_horde_pacing(t, dt, side_id, target_side_id)
...
function HordePacing:_start_horde_wave(template, side_id, target_side_id)
	local current_wave = self._current_wave
...
function HordePacing:_setup_next_horde(template, optional_timer_modifier)
...
function HordePacing:add_trickle_horde(template)
	local trickle_horde = {}
...
function HordePacing:set_timer_modifier(modifier)
...
function HordePacing:set_override_required_travel_distance(required_travel_distance)
	self._override_required_travel_distance = required_travel_distance
end

function HordePacing:_trigger_pre_stinger(template, side_id)
...
function HordePacing:_trigger_stinger(template, position)
...
function HordePacing:_spawn_horde(horde_type, horde_template, composition, side_id, target_side_id, optional_main_path_offset)
