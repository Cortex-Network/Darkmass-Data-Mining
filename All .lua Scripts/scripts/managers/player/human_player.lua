...
function HumanPlayer:init(unique_id, session_id, channel_id, peer_id, local_player_id, profile, slot, account_id, viewport_name, telemetry_game_session)
...
function HumanPlayer:has_placeholder_profile()
