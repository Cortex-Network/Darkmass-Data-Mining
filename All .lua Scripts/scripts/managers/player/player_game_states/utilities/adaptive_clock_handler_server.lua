...
function AdaptiveClockHandlerServer:init(channel_id)
...
function AdaptiveClockHandlerServer:_offset()
	return self._estimated_ping * 0.5 + self._buffer
end

function AdaptiveClockHandlerServer:frame_received(frame)
...
function AdaptiveClockHandlerServer:frame_missed(frame)
end

function AdaptiveClockHandlerServer:_calibrate_rewind_ms(frame)
	local buffer_size = 5
...
function AdaptiveClockHandlerServer:rewind_ms()
