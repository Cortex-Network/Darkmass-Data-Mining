...
function PlayerInputStreamVisualizer:init(player, peer_id)
...
function PlayerInputStreamVisualizer:_bounded_index(frame)
...
function PlayerInputStreamVisualizer:_raw_index(frame)
	return (frame - 1) % BUFFER_SIZE + 1
end

function PlayerInputStreamVisualizer:_write(cache, index, value)
	cache[index] = cache[index] or value
end

function PlayerInputStreamVisualizer:frames_received(from, to)
...
function PlayerInputStreamVisualizer:step_frame(frame)
...
function PlayerInputStreamVisualizer:_store_frame_time(dt)
...
function PlayerInputStreamVisualizer:draw(dt, index, server_clock_offset)
