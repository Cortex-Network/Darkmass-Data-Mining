...
function PositionLookupManager:init(optional_num_keys)
...
function PositionLookupManager:destroy()
	ALIVE = nil
	POSITION_LOOKUP = nil
...
function PositionLookupManager:register(unit, position)
...
function PositionLookupManager:unregister(unit)
...
function PositionLookupManager:pre_update()
...
function PositionLookupManager:post_update()
end
