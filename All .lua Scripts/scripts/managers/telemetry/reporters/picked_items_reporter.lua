...
function PickedItemsReporter:init()
	self._reports = {}
end

function PickedItemsReporter:update(dt, t)
end

function PickedItemsReporter:report()
...
function PickedItemsReporter:register_event(player, item_name)
...
function PickedItemsReporter:destroy()
end
