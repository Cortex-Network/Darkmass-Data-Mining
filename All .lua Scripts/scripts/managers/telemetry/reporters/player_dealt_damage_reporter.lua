...
function PlayerDealtDamageReporter:init()
	self._reports = {}
end

function PlayerDealtDamageReporter:update(dt, t)
end

function PlayerDealtDamageReporter:report()
...
function PlayerDealtDamageReporter:register_event(player, data)
...
function PlayerDealtDamageReporter:destroy()
end
