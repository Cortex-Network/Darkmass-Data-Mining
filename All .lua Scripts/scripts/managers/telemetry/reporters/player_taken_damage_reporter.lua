...
function PlayerTakenDamageReporter:init()
	self._reports = {}
end

function PlayerTakenDamageReporter:update(dt, t)
end

function PlayerTakenDamageReporter:report()
...
function PlayerTakenDamageReporter:register_event(player, data)
...
function PlayerTakenDamageReporter:destroy()
end
