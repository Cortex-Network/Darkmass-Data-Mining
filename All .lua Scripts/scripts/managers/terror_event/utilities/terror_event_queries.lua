...
function TerrorEventQueries.num_alive_minions()
...
function TerrorEventQueries.num_alive_minions_in_level()
	local num_alive = Managers.state.minion_spawn:num_spawned_minions()

	return num_alive
end

function TerrorEventQueries.num_aggroed_minions_in_level()
