...
function UIFontManager:data_by_type(font_type)
	return self._font_definitions[font_type]
end

function UIFontManager:set_locale(locale)
...
function UIFontManager:unload_old_font_packages()
...
function UIFontManager:_setup_font_definitions(locale_fonts)
