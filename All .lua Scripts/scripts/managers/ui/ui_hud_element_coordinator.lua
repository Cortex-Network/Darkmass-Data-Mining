...
function UIHudElementCoordinator:init()
	self._saved_scenegraph_settings = {}
end

function UIHudElementCoordinator:safe_rect()
	local safe_rect_default_value = 0

	return safe_rect_default_value * 0.01
end

function UIHudElementCoordinator:update(dt, t, ui_renderer, input_service)
...
function UIHudElementCoordinator:refresh_coordinates(element, scenegraph_id)
...
function UIHudElementCoordinator:handle_scenegraph_coordinates(element, scenegraph_id, input_service, render_settings)
