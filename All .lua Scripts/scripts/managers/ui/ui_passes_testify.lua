...
function UIPassesTestify.widget_position_by_name(name, pass_data)
...
function UIPassesTestify.widget_position_by_text(text, pass_data)
...
function UIPassesTestify.widget_position_by_title_text(text, pass_data)
	local ui_content = pass_data.ui_content
