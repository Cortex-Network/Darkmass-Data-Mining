...
function UIWidget.init(name, widget_definition)
...
function UIWidget.create_definition(pass_definitions, scenegraph_id, content_overrides, optional_size, style_overrides)
	local definition = {}
...
function UIWidget.add_definition_pass(destination, pass_info)
...
function UIWidget.draw(widget, ui_renderer)
...
function UIWidget.set_visible(widget, ui_renderer, visible)
	local passes = widget.passes
