...
function VotingByNetworkImpl:init(network_event_delegate)
...
function VotingByNetworkImpl:_generate_voting_id()
...
function VotingByNetworkImpl:can_start_voting(template_name, params)
...
function VotingByNetworkImpl:start_voting(template_name, params)
...
function VotingByNetworkImpl:can_cast_vote(voting_id, option, voter_peer_id)
...
function VotingByNetworkImpl:cast_vote(voting_id, option)
...
function VotingByNetworkImpl:update(dt, t)
...
function VotingByNetworkImpl:member_list(voting_id)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:votes(voting_id)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:time_left(voting_id)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:voting_template(voting_id)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:voting_exists(voting_id)
	return self._votings[voting_id] ~= nil
end

function VotingByNetworkImpl:voting_result(voting_id)
...
function VotingByNetworkImpl:has_voted(voting_id, voter_peer_id)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:is_host(voting_id)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:_num_votings_by_template_name(template_name)
	local num = 0
...
function VotingByNetworkImpl:_delete_voting(voting_id)
	self._votings[voting_id]:delete()

	self._votings[voting_id] = nil
end

function VotingByNetworkImpl:destroy()
	local connection_manager = Managers.connection
...
function VotingByNetworkImpl:complete_vote(voting_id)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:rpc_voting_client_ready(channel_id)
...
function VotingByNetworkImpl:_rpc_request_voting(channel_id, voting_id, template_id, ...)
...
function VotingByNetworkImpl:rpc_request_voting_no_params(channel_id, voting_id, template_id)
	self:_rpc_request_voting(channel_id, voting_id, template_id)
end

function VotingByNetworkImpl:rpc_request_voting_kick_player(channel_id, voting_id, template_id, kick_peer_id)
	self:_rpc_request_voting(channel_id, voting_id, template_id, kick_peer_id)
end

function VotingByNetworkImpl:rpc_request_vote(channel_id, voting_id, option_id)
...
function VotingByNetworkImpl:rpc_voting_accepted(channel_id, voting_id, member_list, initial_votes_list, time_left)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:_rpc_start_voting(voting_id, template_id, initiator_peer, member_list, initial_votes_list, time_left, ...)
	local template_name = NetworkLookup.voting_templates[template_id]
	local template = VotingTemplates[template_name]
...
function VotingByNetworkImpl:rpc_voting_aborted(channel_id, voting_id, reason)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:rpc_voting_completed(channel_id, voting_id, result_id)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:rpc_start_voting_no_params(channel_id, voting_id, template_id, initiator_peer, member_list, initial_votes_list, time_left)
	self:_rpc_start_voting(voting_id, template_id, initiator_peer, member_list, initial_votes_list, time_left)
end

function VotingByNetworkImpl:rpc_start_voting_accept_mission(channel_id, voting_id, template_id, initiator_peer, member_list, initial_votes_list, time_left, backend_mission_id, mission_initiator_peer, mission_data_string)
...
function VotingByNetworkImpl:rpc_start_voting_mission_lobby_ready(channel_id, voting_id, template_id, initiator_peer, member_list, initial_votes_list, time_left, mission_name_id, circumstance_name_id)
...
function VotingByNetworkImpl:rpc_start_voting_kick_player(channel_id, voting_id, template_id, initiator_peer, member_list, initial_votes_list, time_left, kick_peer_id)
	self:_rpc_start_voting(voting_id, template_id, initiator_peer, member_list, initial_votes_list, time_left, kick_peer_id)
end

function VotingByNetworkImpl:rpc_start_voting_stay_in_party(channel_id, voting_id, template_id, initiator_peer, member_list, initial_votes_list, time_left, new_party_id, new_party_invite_token)
...
function VotingByNetworkImpl:rpc_register_vote(channel_id, voting_id, voter_peer_id, option_id)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:rpc_vote_denied(channel_id, voting_id, reason)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:rpc_voting_member_joined(channel_id, voting_id, peer_id)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:rpc_voting_member_left(channel_id, voting_id, peer_id)
	local voting = self._votings[voting_id]
...
function VotingByNetworkImpl:_event_network_client_connected(network_interface, peer_id, channel_id)
...
function VotingByNetworkImpl:_event_network_client_disconnected(network_interface, peer_id, channel_id)
...
function VotingByNetworkImpl:_event_network_connected_to_host(network_interface, peer_id, channel_id)
...
function VotingByNetworkImpl:_event_network_disconnected_from_host(network_interface, peer_id, channel_id)
