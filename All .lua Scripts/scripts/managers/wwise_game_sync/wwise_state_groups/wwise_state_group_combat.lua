...
function WwiseStateGroupCombat:init(wwise_world, wwise_state_group_name)
...
function WwiseStateGroupCombat:set_followed_player_unit(player_unit)
	if player_unit then
...
function WwiseStateGroupCombat:_wwise_state()
...
function WwiseStateGroupCombat:_update_health()
...
function WwiseStateGroupCombat:_update_intensity()
...
function WwiseStateGroupCombat:_update_locked_in_melee()
...
function WwiseStateGroupCombat:_update_num_aggroed_minions()
