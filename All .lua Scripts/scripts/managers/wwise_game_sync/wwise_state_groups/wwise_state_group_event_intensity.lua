...
function WwiseStateGroupEventIntensity:init(wwise_world, wwise_state_group_name)
...
function WwiseStateGroupEventIntensity:on_gameplay_post_init(level)
...
function WwiseStateGroupEventIntensity:sound_event_triggered(event)
...
function WwiseStateGroupEventIntensity:update(dt, t)
...
function WwiseStateGroupEventIntensity:on_gameplay_shutdown()
