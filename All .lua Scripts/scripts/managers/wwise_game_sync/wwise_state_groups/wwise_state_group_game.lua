...
function WwiseStateGroupGame:init(wwise_world, wwise_state_group_name)
...
function WwiseStateGroupGame:update(dt, t)
...
function WwiseStateGroupGame:_get_victory_defeat_wwise_state(end_result, wwise_state)
...
function WwiseStateGroupGame:_get_game_score_wwise_state(end_result, wwise_state)
	if end_result and end_result == "won" then
...
function WwiseStateGroupGame:_in_cinematic_mode()
