...
function WwiseStateGroupObjective:init(wwise_world, wwise_state_group_name)
...
function WwiseStateGroupObjective:on_gameplay_post_init(level)
...
function WwiseStateGroupObjective:on_gameplay_shutdown()
...
function WwiseStateGroupObjective:update(dt, t)
...
function WwiseStateGroupObjective:set_followed_player_unit(player_unit)
	if player_unit then
