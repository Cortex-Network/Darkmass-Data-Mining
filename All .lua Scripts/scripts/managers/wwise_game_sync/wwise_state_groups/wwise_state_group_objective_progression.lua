...
function WwiseStateGroupObjectiveProgression:init(wwise_world, wwise_state_group_name)
	WwiseStateGroupObjectiveProgression.super.init(self, wwise_world, wwise_state_group_name)

	self._mission_objective_system = nil
end

function WwiseStateGroupObjectiveProgression:on_gameplay_post_init(level)
...
function WwiseStateGroupObjectiveProgression:on_gameplay_shutdown()
	WwiseStateGroupObjectiveProgression.super.on_gameplay_shutdown(self)

	self._mission_objective_system = nil
end

function WwiseStateGroupObjectiveProgression:update(dt, t)
