...
function LocalPlayersSyncState:init(state_machine, shared_state)
...
function LocalPlayersSyncState:rpc_sync_local_players_reply(channel_id, local_player_id_array, slot_array)
