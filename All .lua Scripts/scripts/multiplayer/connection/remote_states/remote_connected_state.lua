...
function RemoteConnectedState:init(state_machine, shared_state)
...
function RemoteConnectedState:rpc_client_entered_connected_state(channel_id)
	local shared_state = self._shared_state
