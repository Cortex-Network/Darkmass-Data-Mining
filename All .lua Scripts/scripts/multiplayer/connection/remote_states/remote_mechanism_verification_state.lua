...
function RemoteMechanismVerificationState:init(state_machine, shared_state)
...
function RemoteMechanismVerificationState:destroy()
	local shared_state = self._shared_state

	shared_state.event_delegate:unregister_channel_events(shared_state.channel_id, unpack(RPCS))
end

function RemoteMechanismVerificationState:update(dt)
	local shared_state = self._shared_state
...
function RemoteMechanismVerificationState:rpc_check_mechanism(channel_id, jwt_ticket_part, is_last_part)
...
function RemoteMechanismVerificationState:_check_mechanism(jwt_ticket)
...
function RemoteMechanismVerificationState:_failed(...)
	self._result = false
