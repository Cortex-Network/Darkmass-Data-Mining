...
function RemotePlayersSyncState:init(state_machine, shared_state)
...
function RemotePlayersSyncState:rpc_sync_local_players(channel_id, local_player_id_array, is_human_controlled_array, account_id_array, character_id_array, player_session_id_array)
