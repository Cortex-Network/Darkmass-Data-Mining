...
function RemoteProfilesSyncState:init(state_machine, shared_state)
...
function RemoteProfilesSyncState:_request_profile(array_index, account_id, character_id)
...
function RemoteProfilesSyncState:_request_backend_profile(array_index, account_id, character_id)
...
function RemoteProfilesSyncState:rpc_ready_to_receive_local_profiles(channel_id)
