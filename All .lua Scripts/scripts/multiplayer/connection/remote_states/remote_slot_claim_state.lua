...
function RemoteSlotClaimState:init(state_machine, shared_state)
...
function RemoteSlotClaimState:rpc_claim_slot(channel_id)
	local shared_state = self._shared_state
