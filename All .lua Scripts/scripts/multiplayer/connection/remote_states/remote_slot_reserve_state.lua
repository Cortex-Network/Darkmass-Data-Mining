...
function RemoteSlotReserveState:init(state_machine, shared_state)
...
function RemoteSlotReserveState:rpc_reserve_slots(channel_id, peer_ids)
	local shared_state = self._shared_state
...
function RemoteSlotReserveState:rpc_claim_slot(channel_id)
	local shared_state = self._shared_state
