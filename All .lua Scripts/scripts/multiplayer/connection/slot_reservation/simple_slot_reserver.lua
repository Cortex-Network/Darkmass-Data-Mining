...
function SimpleSlotReserver:init(max_slots)
...
function SimpleSlotReserver:reserve_slots(reserver_peer_id, players)
	local player_ids = {}
...
function SimpleSlotReserver:reserve_slot(reserver_peer_id, peer_id)
...
function SimpleSlotReserver:claim_slot(peer_id, channel_id)
	if self._reserved_slots[peer_id] then
...
function SimpleSlotReserver:free_slots(players)
...
function SimpleSlotReserver:free_slot(peer_id, channel_id)
	local used_channel_id = self._claimed_slots[peer_id]
...
function SimpleSlotReserver:allocation_state()
	return self._occupied_slots, self._max_slots
end

function SimpleSlotReserver:is_slot_reserved(peer_id)
	return self._reserved_slots[peer_id] or false
end

function SimpleSlotReserver:is_slot_claimed(peer_id)
	return self._claimed_slots[peer_id] or false
end

function SimpleSlotReserver:_remove_owned_reservation(peer_id)
...
function SimpleSlotReserver:_remove_reservation_owner(peer_id)
