...
function PartyImmateriumHubSessionBoot:init(event_object, current_hub_session_id)
...
function PartyImmateriumHubSessionBoot:_fetch_server_details()
...
function PartyImmateriumHubSessionBoot:_start_handshaking(noAcceleratedConnection)
...
function PartyImmateriumHubSessionBoot:_create_connection()
...
function PartyImmateriumHubSessionBoot:_start_hot_joining_party_hub_server()
...
function PartyImmateriumHubSessionBoot:_failed(reason, optional_error_details)
	local is_error = true
...
function PartyImmateriumHubSessionBoot:_fail_or_retry_non_accelerated(reason)
...
function PartyImmateriumHubSessionBoot:update(dt)
...
function PartyImmateriumHubSessionBoot:result()
...
function PartyImmateriumHubSessionBoot:_clear()
...
function PartyImmateriumHubSessionBoot:destroy()
	self:_clear()
end
