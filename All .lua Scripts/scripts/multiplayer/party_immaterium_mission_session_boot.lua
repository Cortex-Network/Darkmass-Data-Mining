...
function PartyImmateriumMissionSessionBoot:init(event_object, matched_game_session_id)
...
function PartyImmateriumMissionSessionBoot:_fetch_server_details()
...
function PartyImmateriumMissionSessionBoot:_start_handshaking(noAcceleratedConnection)
...
function PartyImmateriumMissionSessionBoot:_create_connection()
...
function PartyImmateriumMissionSessionBoot:_start_reserve()
	self:_create_connection()
	self:_set_state(STATES.reserving)
end

function PartyImmateriumMissionSessionBoot:_failed(reason, optional_error_details)
	local is_error = true
...
function PartyImmateriumMissionSessionBoot:_fail_or_retry_non_accelerated(reason)
...
function PartyImmateriumMissionSessionBoot:update(dt)
...
function PartyImmateriumMissionSessionBoot:result()
...
function PartyImmateriumMissionSessionBoot:_clear()
...
function PartyImmateriumMissionSessionBoot:destroy()
	self:_clear()
end
