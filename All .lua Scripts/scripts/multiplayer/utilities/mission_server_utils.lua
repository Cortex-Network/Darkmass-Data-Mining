...
function MissionServerUtils.set_mission_mechanism(mission_data)
...
function MissionServerUtils.get_mission_result(mission_data, game_mode_result)
...
function MissionServerUtils.get_reward_modifiers()
...
function MissionServerUtils.update_stats(mission_data, team_stats, mission_result, mission_start_time)
...
function MissionServerUtils.player_state(player)
