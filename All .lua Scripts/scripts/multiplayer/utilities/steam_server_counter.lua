...
function SteamServerCounter:init(steam_client, options)
...
function SteamServerCounter:start_searching(search_type)
...
function SteamServerCounter:result()
...
function SteamServerCounter:_validate_options(options)
end

function SteamServerCounter:_process_next()
	while true do
