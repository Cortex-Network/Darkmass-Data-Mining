...
_check_network_lookup_boundaries("game_object_id", "door_control_panel_states")
_check_network_lookup_boundaries("lookup_3bit", "door_states")
_check_network_lookup_boundaries("effect_template_id", "effect_templates")
_check_network_lookup_boundaries("flow_event", "flow_events")
_check_network_lookup_boundaries("lookup_5bit", "game_object_types")
...
_check_network_lookup_boundaries("mission_objective_ui_string_id", "mission_objective_target_ui_types")
