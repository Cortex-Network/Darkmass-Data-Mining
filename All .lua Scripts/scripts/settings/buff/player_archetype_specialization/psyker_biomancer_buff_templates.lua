...
templates.psyker_biomancer_smite_on_hit = {
	...
	update_func = function (template_data, template_context, dt, t)
		...
		ImpactEffect.play(smite_target, hit_actor, damage_dealt, damage_type, hit_zone_name, attack_result, hit_world_position, nil, attack_direction, player_unit, nil, , , damage_efficiency, damage_profile)
