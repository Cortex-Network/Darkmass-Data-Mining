...
function CheckProcFunctions.on_warp_kill(params)
	if params.attack_result ~= attack_results.died then
		return false
	end
...
function CheckProcFunctions.on_ranged_close_kill(params)
	if params.attack_result ~= attack_results.died then
		return false
	end
...
function CheckProcFunctions.on_block_broken(params)
	return params.block_broken
end

function CheckProcFunctions.on_crit(params)
...
function CheckProcFunctions.on_crit_kills(params)
	return params.is_critical_strike and params.attack_result == attack_results.died
end

function CheckProcFunctions.on_ranged_hit(params)
	return params.attack_type == attack_types.ranged
end

function CheckProcFunctions.on_melee_hit(params)
	return params.attack_type == attack_types.melee
end

function CheckProcFunctions.on_melee_weapon_special_hit(params)
	return params.weapon_special and params.attack_type == attack_types.melee
end

function CheckProcFunctions.on_melee_crit_hit(params)
	return params.is_critical_strike and params.attack_type == attack_types.melee
end

function CheckProcFunctions.on_multiple_melee_hit(params, template_data, template_context)
...
function CheckProcFunctions.on_ranged_crit_hit(params)
	return params.is_critical_strike and params.attack_type == attack_types.ranged
end

function CheckProcFunctions.on_explosion_hit(params)
	return params.attack_type == attack_types.explosion
end

function CheckProcFunctions.on_heavy_hit(params)
...
function CheckProcFunctions.check_item_slot(params, template_data, template_context)
...
function CheckProcFunctions.on_melee_and_check_item_slot(params, template_data, template_context)
...
function CheckProcFunctions.on_ranged_and_check_item_slot(params, template_data, template_context)
...
function CheckProcFunctions.on_explosion_and_check_item_slot(params, template_data, template_context)
...
function CheckProcFunctions.on_continues_fire_full_auto(params, template_data, template_context)
	return params.num_shots_fired > 1
end

function CheckProcFunctions.on_continues_fire_semi_automatic(params, template_data, template_context)
