...
function dialogue_context_settings:construct(key)
...
function dialogue_context_settings.number_of_kills_callback(dialogue_context_extension, timed_counter, t)
...
function dialogue_context_settings.number_of_knocked_down_callback(dialogue_context_extension, timed_counter, t)
	if not timed_counter.has_triggered then
		timed_counter.has_triggered = true
	elseif timed_counter.time_lived - timed_counter.last_triggered_time < timed_counter.trigger_period then
		return
...
function dialogue_context_settings.number_of_player_suppressions_callback(dialogue_context_extension, timed_counter, t)
	if not timed_counter.has_triggered then
		timed_counter.has_triggered = true
	elseif timed_counter.time_lived - timed_counter.last_triggered_time < timed_counter.trigger_period then
		return
...
function dialogue_context_settings.number_of_armor_hits_callback(dialogue_context_extension, timed_counter, t)
	if not timed_counter.has_triggered then
		timed_counter.has_triggered = true
	elseif timed_counter.time_lived - timed_counter.last_triggered_time < timed_counter.trigger_period then
		return
...
function dialogue_context_settings.friendly_fire_hits_callback(dialogue_context_extension, timed_counter, t)
	if not timed_counter.has_triggered then
		timed_counter.has_triggered = true
	elseif timed_counter.time_lived - timed_counter.last_triggered_time < timed_counter.trigger_period then
		return
