...
function weapon_template.overheated_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
...
function weapon_template.action_two_charging_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
	return current_action_name == "action_charge_target"
end

function weapon_template.action_two_charged_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
	local player_unit = player.player_unit
	local unit_data_ext = ScriptUnit.extension(player_unit, "unit_data_system")
...
function weapon_template.action_one_charging_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
