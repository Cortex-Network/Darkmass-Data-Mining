...
weapon_template.crosshair_type = "none"
...
function weapon_template.action_scan_on_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
	return not current_action_name or current_action_name == "none"
end

function weapon_template.action_scan_confirm_on_screen_ui_validation(wielded_slot_id, item, current_action, current_action_name, player)
