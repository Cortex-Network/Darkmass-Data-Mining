...
local effect_template = {
	name = "cultist_shocktrooper_grenade",
	resources = resources
}

function effect_template.start(template_data, template_context)
...
function effect_template.update(template_data, template_context, dt, t)
end

function effect_template.stop(template_data, template_context)
