...
function player_character_particles.resolve_particle(particle_alias, properties, optional_external_properties)
...
function player_character_particles.find_relevant_particles(profile_properties)
