...
function player_character_sounds.resolve_sound(sound_alias, properties, optional_external_properties)
...
function player_character_sounds.find_relevant_events(profile_properties)
