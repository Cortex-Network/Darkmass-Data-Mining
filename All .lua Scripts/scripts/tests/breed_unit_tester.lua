...
function BreedUnitTester:init(package_manager, use_time_slice)
...
function BreedUnitTester:destroy()
...
function BreedUnitTester:update_time_slice_package_load()
...
function BreedUnitTester:update()
