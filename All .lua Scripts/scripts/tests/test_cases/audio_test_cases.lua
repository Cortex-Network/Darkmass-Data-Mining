...
function AudioTestCases.vo_rules_dm_forge()
	Testify:run_case(function (dt, t)
		if TestifySnippets.is_debug_stripped() then
			TestifySnippets.skip_title_and_main_menu_and_create_character_if_none()
...
function AudioTestCases.vo_rules_dm_propaganda()
	Testify:run_case(function (dt, t)
		if TestifySnippets.is_debug_stripped() then
			TestifySnippets.skip_title_and_main_menu_and_create_character_if_none()
...
function AudioTestCases.vo_rules_dm_stockpile()
	Testify:run_case(function (dt, t)
		if TestifySnippets.is_debug_stripped() then
			TestifySnippets.skip_title_and_main_menu_and_create_character_if_none()
...
function AudioTestCases.vo_rules_event_kill()
	Testify:run_case(function (dt, t)
		if TestifySnippets.is_debug_stripped() then
			TestifySnippets.skip_title_and_main_menu_and_create_character_if_none()
...
function AudioTestCases.vo_rules_fm_cargo()
	Testify:run_case(function (dt, t)
		if TestifySnippets.is_debug_stripped() then
			TestifySnippets.skip_title_and_main_menu_and_create_character_if_none()
...
function AudioTestCases.vo_rules_hm_cartel()
	Testify:run_case(function (dt, t)
		if TestifySnippets.is_debug_stripped() then
			TestifySnippets.skip_title_and_main_menu_and_create_character_if_none()
...
function AudioTestCases.vo_rules_hm_strain()
	Testify:run_case(function (dt, t)
		if TestifySnippets.is_debug_stripped() then
			TestifySnippets.skip_title_and_main_menu_and_create_character_if_none()
...
function AudioTestCases.vo_rules_km_enforcer()
	Testify:run_case(function (dt, t)
		if TestifySnippets.is_debug_stripped() then
			TestifySnippets.skip_title_and_main_menu_and_create_character_if_none()
...
function AudioTestCases.vo_rules_km_station()
	Testify:run_case(function (dt, t)
		if TestifySnippets.is_debug_stripped() then
			TestifySnippets.skip_title_and_main_menu_and_create_character_if_none()
			TestifySnippets.load_mission("km_station")
...
function AudioTestCases.vo_rules_lm_rails()
	Testify:run_case(function (dt, t)
		if TestifySnippets.is_debug_stripped() then
			TestifySnippets.skip_title_and_main_menu_and_create_character_if_none()
...
function AudioTestCases.vo_rules_smart_tag_com_wheel()
	Testify:run_case(function (dt, t)
		if TestifySnippets.is_debug_stripped() then
			TestifySnippets.skip_title_and_main_menu_and_create_character_if_none()
			TestifySnippets.load_mission("spawn_all_enemies")
