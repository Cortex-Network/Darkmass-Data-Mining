...
function CombatTestCases.run_through_mission(case_settings)
...
function CombatTestCases.spawn_all_enemies(case_settings)
	Testify:run_case(function (dt, t)
		local result = ""
...
function CombatTestCases.spawn_breed(breed_name)
	Testify:run_case(function (dt, t)
		local player_current_position = Testify:make_request("player_current_position")
		local player_spawn_position = {
			x = player_current_position.x,
...
function CombatTestCases.ensure_breed_ragdoll_actors(case_settings)
	Testify:run_case(function (dt, t)
		local result = ""
		local settings = cjson.decode(case_settings or "{}")
...
function CombatTestCases.gib_all_minions(case_settings)
	Testify:run_case(function (dt, t)
		local result = ""
		local settings = cjson.decode(case_settings or "{}")
