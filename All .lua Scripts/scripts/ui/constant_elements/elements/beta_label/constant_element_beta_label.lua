...
function ConstantElementBetaLabel:init(parent, draw_layer, start_scale)
...
function ConstantElementBetaLabel:draw(dt, t, ui_renderer, render_settings, input_service)
