...
function ConstantElementLoading:init(parent, draw_layer, start_scale)
...
function ConstantElementLoading:update(dt, t, ui_renderer, render_settings, input_service)
...
function ConstantElementLoading:_on_state_changed(new_state_name)
...
function ConstantElementLoading:_update_state_views(state_view_settings)
...
function ConstantElementLoading:_open_view_if_inactive(view_name, view_context, view_settings_override)
	local ui_manager = Managers.ui

	if not ui_manager:view_active(view_name) then
		Log.info("ConstantElementLoading", "Opening view %q", view_name)
		ui_manager:open_view(view_name, nil, , , , view_context, view_settings_override)
	end
end

function ConstantElementLoading:_close_view_if_active(view_name)
	local ui_manager = Managers.ui
...
function ConstantElementLoading:set_visible(visible, optional_visibility_parameters)
end

function ConstantElementLoading:should_update()
	return true
end

function ConstantElementLoading:should_draw()
	return false
end
