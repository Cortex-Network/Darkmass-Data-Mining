...
function HudElementCharacterNewsFeed:init(parent, draw_layer, start_scale, definitions)
...
function HudElementCharacterNewsFeed:_fetch_inventory_items()
...
function HudElementCharacterNewsFeed:event_resync_character_news_feed()
	self:_fetch_inventory_items()
end

function HudElementCharacterNewsFeed:destroy()
	if self._gear_promise then
		self._gear_promise:cancel()
...
function HudElementCharacterNewsFeed:_fetch_new_items()
...
function HudElementCharacterNewsFeed:_present_next_new_item(dt)
...
function HudElementCharacterNewsFeed:_has_item_in_inventory(gear_id)
...
function HudElementCharacterNewsFeed:update(dt, t, ui_renderer, render_settings, input_service)
