...
function HudElementCrosshair:destroy()
	local event_manager = Managers.event
...
function HudElementCrosshair:event_crosshair_hit_report(hit_weakspot, attack_result, did_damage, hit_world_position)
...
function HudElementCrosshair:_get_current_crosshair_type()
...
function HudElementCrosshair:_sync_active_crosshair()
...
function HudElementCrosshair:_crosshair_position(dt, t, ui_renderer)
	local target_x = 0
	local target_y = 0
