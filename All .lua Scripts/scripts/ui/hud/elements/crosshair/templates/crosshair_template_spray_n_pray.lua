...
function template.create_widget_defintion(template, scenegraph_id)
	...
	return UIWidget.create_definition({
		...
		{
			value = "content/ui/materials/hud/crosshairs/angle_spread",
			style_id = "left",
			pass_type = "texture",
			style = {
				vertical_alignment = "center",
...
function template.update_function(parent, ui_renderer, widget, template, dt, t)
