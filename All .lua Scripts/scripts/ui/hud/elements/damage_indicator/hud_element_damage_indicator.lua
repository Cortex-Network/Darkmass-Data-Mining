...
function HudElementDamageIndicator:init(parent, draw_layer, start_scale, definitions)
...
function HudElementDamageIndicator:destroy()
	HudElementDamageIndicator.super.destroy(self)
	Managers.event:unregister(self, "spawn_hud_damage_indicator")
end

function HudElementDamageIndicator:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
...
function HudElementDamageIndicator:_get_player_direction_angle()
...
function HudElementDamageIndicator:_spawn_indicator(angle, attack_result)
...
function HudElementDamageIndicator:_draw_indicators(dt, t, ui_renderer)
