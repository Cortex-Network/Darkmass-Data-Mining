...
function HudElementMissionObjectiveFeed:init(parent, draw_layer, start_scale, definitions)
...
function HudElementMissionObjectiveFeed:destroy()
	self:_unregister_events()
	HudElementMissionObjectiveFeed.super.destroy(self)
end

function HudElementMissionObjectiveFeed:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementMissionObjectiveFeed:_register_events()
...
function HudElementMissionObjectiveFeed:_unregister_events()
	local event_manager = Managers.event
	local events = HudElementMissionObjectiveFeedSettings.events
...
function HudElementMissionObjectiveFeed:_set_background_visibility(visible)
	self._background_visible = visible
	self._widgets_by_name.background.content.visible = visible
end

function HudElementMissionObjectiveFeed:_mission_objectives_scan(ui_renderer)
...
function HudElementMissionObjectiveFeed:_add_objective(objective, ui_renderer, locally_added)
...
function HudElementMissionObjectiveFeed:_synchronize_widget_with_hud_objective(objective_name)
...
function HudElementMissionObjectiveFeed:_update_bar_progress(hud_objective)
