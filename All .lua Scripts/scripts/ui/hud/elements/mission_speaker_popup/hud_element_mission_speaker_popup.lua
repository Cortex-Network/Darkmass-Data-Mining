...
function HudElementMissionSpeakerPopup:init(parent, draw_layer, start_scale)
...
function HudElementMissionSpeakerPopup:destroy()
	HudElementMissionSpeakerPopup.super.destroy(self)
end

function HudElementMissionSpeakerPopup:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementMissionSpeakerPopup:_update_bar_value(dt)
...
function HudElementMissionSpeakerPopup:_sync_active_speaker(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementMissionSpeakerPopup:_mission_speaker_stop()
...
function HudElementMissionSpeakerPopup:_mission_speaker_start(name_text, icon)
	if self._popup_animation_id then
		self:_stop_animation(self._popup_animation_id)
...
function HudElementMissionSpeakerPopup:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
