...
function HudElementPlayerAbilityHandler:init(parent, draw_layer, start_scale)
...
function HudElementPlayerAbilityHandler:_setup_slot_name_list()
...
function HudElementPlayerAbilityHandler:_player_scan(ui_renderer)
...
function HudElementPlayerAbilityHandler:_on_abilities_removed()
end

function HudElementPlayerAbilityHandler:_update_ability_count(new_ability_count)
...
function HudElementPlayerAbilityHandler:set_scenegraph_position(scenegraph_id, x, y, z, horizontal_alignment, vertical_alignment)
...
function HudElementPlayerAbilityHandler:_align_abilities()
	local ui_scenegraph = self._ui_scenegraph
	local instance_data_tables = self._instance_data_tables
...
function HudElementPlayerAbilityHandler:destroy()
	local instance_data_tables = self._instance_data_tables
...
function HudElementPlayerAbilityHandler:set_visible(visible, ui_renderer, use_retained_mode)
...
function HudElementPlayerAbilityHandler:on_resolution_modified()
...
function HudElementPlayerAbilityHandler:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementPlayerAbilityHandler:draw(dt, t, ui_renderer, render_settings, input_service)
