...
function HudElementPlayerWeapon:init(parent, draw_layer, start_scale, data)
...
function HudElementPlayerWeapon:destroy(ui_renderer)
	self:_unregister_events()
	self:_destroy_widgets(ui_renderer)
	HudElementPlayerWeapon.super.destroy(self)
end

function HudElementPlayerWeapon:_destroy_widgets(ui_renderer, use_retained_mode)
...
function HudElementPlayerWeapon:set_visible(visible, ui_renderer, use_retained_mode)
...
function HudElementPlayerWeapon:set_wielded(wielded)
	self._wielded = wielded
	self._updated_input_text = true
end

function HudElementPlayerWeapon:wielded()
	return self._wielded
end

function HudElementPlayerWeapon:slot_name()
	return self._slot_name
end

function HudElementPlayerWeapon:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
...
function HudElementPlayerWeapon:_apply_color_values(destination_color, target_color, include_alpha)
...
function HudElementPlayerWeapon:_set_ammo_refill_alpha(alpha)
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.background
	widget.dirty = true
end

function HudElementPlayerWeapon:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementPlayerWeapon:set_size(width, height)
	local scenegraph_id = "background"

	self:_set_scenegraph_size(scenegraph_id, width, height)
end

function HudElementPlayerWeapon:set_height_offset(height_offset)
...
function HudElementPlayerWeapon:_set_alpha(alpha_fraction)
...
function HudElementPlayerWeapon:is_weapon()
	return self._is_weapon
end

function HudElementPlayerWeapon:set_wield_anim_progress(progress, ui_renderer)
...
function HudElementPlayerWeapon:_get_style_text_height(text, text_style, ui_renderer)
...
function HudElementPlayerWeapon:set_clip_amount(current, total)
...
function HudElementPlayerWeapon:set_ammo_amount(amount, total_max_amount)
...
function HudElementPlayerWeapon:_update_input()
...
function HudElementPlayerWeapon:set_input_text(text, visible)
	local widgets_by_name = self._widgets_by_name
...
function HudElementPlayerWeapon:set_icon(icon, is_weapon)
	local widgets_by_name = self._widgets_by_name
...
function HudElementPlayerWeapon:_register_events()
...
function HudElementPlayerWeapon:_unregister_events()
	local event_manager = Managers.event
	local events = HudElementPlayerWeaponSettings.events
...
function HudElementPlayerWeapon:event_on_input_changed()
	self._updated_input_text = true
end
