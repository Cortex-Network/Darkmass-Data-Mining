...
function HudElementPlayerWeaponHandler:init(parent, draw_layer, start_scale)
...
function HudElementPlayerWeaponHandler:_weapon_scan(extensions, ui_renderer)
...
function HudElementPlayerWeaponHandler:_update_weapon_count(new_weapon_count, force_update)
...
function HudElementPlayerWeaponHandler:set_scenegraph_position(scenegraph_id, x, y, z, horizontal_alignment, vertical_alignment)
...
function HudElementPlayerWeaponHandler:_align_weapon_scenegraphs()
...
function HudElementPlayerWeaponHandler:destroy(ui_renderer)
	local player_weapons = self._player_weapons
...
function HudElementPlayerWeaponHandler:set_visible(visible, ui_renderer, use_retained_mode)
...
function HudElementPlayerWeaponHandler:on_resolution_modified()
...
function HudElementPlayerWeaponHandler:_set_wielded_slot(wielded_slot)
...
function HudElementPlayerWeaponHandler:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementPlayerWeaponHandler:draw(dt, t, ui_renderer, render_settings, input_service)
