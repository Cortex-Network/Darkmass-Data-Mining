...
function HudElementPrologueTutorialInfoBox:init(parent, draw_layer, start_scale, definitions)
...
function HudElementPrologueTutorialInfoBox:destroy()
	self:_unregister_events()
	HudElementPrologueTutorialInfoBox.super.destroy(self)
end

function HudElementPrologueTutorialInfoBox:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementPrologueTutorialInfoBox:event_player_display_prologue_tutorial_info_box(player, info_data)
...
function HudElementPrologueTutorialInfoBox:event_player_hide_prologue_tutorial_info_box(player)
	if not self._player or self._player ~= player then
		return
	end
...
function HudElementPrologueTutorialInfoBox:_validate_info_data(info_data)
...
function HudElementPrologueTutorialInfoBox:_present_new_info_box(info_data)
...
function HudElementPrologueTutorialInfoBox:_should_update_input(info_data)
...
function HudElementPrologueTutorialInfoBox:_get_input_description_text(info_data)
...
function HudElementPrologueTutorialInfoBox:_set_widget_info(info_data)
...
function HudElementPrologueTutorialInfoBox:_set_objectives_info(info_data)
...
function HudElementPrologueTutorialInfoBox:_hide_info()
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.info_widget
...
function HudElementPrologueTutorialInfoBox:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
...
function HudElementPrologueTutorialInfoBox:_register_events()
...
function HudElementPrologueTutorialInfoBox:_unregister_events()
	local event_manager = Managers.event
	local events = HudElementPrologueTutorialInfoBoxSettings.events
...
function HudElementPrologueTutorialInfoBox:_set_widget_size_from_content(description, title_text, input_description_text)
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.info_widget
...
function HudElementPrologueTutorialInfoBox:_get_first_available_slot()
...
function HudElementPrologueTutorialInfoBox:event_player_add_objective_tracker(objective)
...
function HudElementPrologueTutorialInfoBox:_create_entry(objective_id, name, max_value, index)
...
function HudElementPrologueTutorialInfoBox:event_player_update_objectives_tracker(objective_id, current_value)
...
function HudElementPrologueTutorialInfoBox:event_player_remove_objective(objective_id)
...
function HudElementPrologueTutorialInfoBox:event_player_remove_current_objectives()
...
function HudElementPrologueTutorialInfoBox:_clear_objectives()
...
function HudElementPrologueTutorialInfoBox:on_objective_completed(objective_id)
	local widget = self._entry_widgets[objective_id]

	self:_start_animation("on_complete", widget)
end

function HudElementPrologueTutorialInfoBox:_draw_entry_widgets(ui_renderer)
