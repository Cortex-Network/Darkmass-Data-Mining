...
function HudElementSmartTagging:init(parent, draw_layer, start_scale)
...
function HudElementSmartTagging:_populate_wheel(options)
...
function HudElementSmartTagging:_setup_entries(num_entries)
...
function HudElementSmartTagging:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementSmartTagging:destroy()
	self:_clear_all_smart_tag_presentations()
	self:_pop_cursor()
	HudElementSmartTagging.super.destroy(self)
end

function HudElementSmartTagging:_on_tag_start(t)
...
function HudElementSmartTagging:_on_com_wheel_start(t, input_service)
...
function HudElementSmartTagging:_trigger_smart_tag(template_name, target_unit, target_location)
...
function HudElementSmartTagging:_trigger_smart_tag_interaction(tag_id)
	local parent = self._parent
	local player_unit = parent:player_unit()
	local smart_tag_system = Managers.state.extension:system("smart_tag_system")
...
function HudElementSmartTagging:_on_com_wheel_stop(t, ui_renderer, render_settings, input_service)
	local cb = callback(self, "_on_com_wheel_stop_callback", t, ui_renderer, render_settings, input_service)

	Managers.state.game_mode:register_physics_safe_callback(cb)
end

function HudElementSmartTagging:_on_tag_stop_callback(t, ui_renderer, render_settings)
...
function HudElementSmartTagging:_on_com_wheel_stop_callback(t, ui_renderer, render_settings, input_service)
	if self.destroyed then
		return
	end
...
function HudElementSmartTagging:_get_chat_channe_by_tag(channel_tag)
...
function HudElementSmartTagging:_cb_world_markers_list_request(world_markers)
	self._world_markers_list = world_markers
end

function HudElementSmartTagging:_find_marker_by_unit(unit)
...
function HudElementSmartTagging:_handle_input(t, dt, ui_renderer, render_settings)
...
function HudElementSmartTagging:_handle_tagging(t, ui_renderer, render_settings, input_service)
...
function HudElementSmartTagging:_handle_com_wheel(t, ui_renderer, render_settings, input_service)
...
function HudElementSmartTagging:_should_draw_wheel(input_service)
	return input_service:get("smart_tag")
end

function HudElementSmartTagging:_should_draw_wheel_gamepad(input_service)
...
function HudElementSmartTagging:_handle_selected_marker(marker)
...
function HudElementSmartTagging:_handle_selected_unit(unit)
	local smart_tag_system = Managers.state.extension:system("smart_tag_system")
...
function HudElementSmartTagging:_is_marker_valid_for_tagging(player_unit, marker, distance)
...
function HudElementSmartTagging:_find_world_marker_target(ui_renderer, render_settings)
...
function HudElementSmartTagging:_check_box_overlap(x1, y1, x2, y2, px, py, radius)
...
function HudElementSmartTagging:_update_wheel_presentation(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementSmartTagging:_is_wheel_entry_hovered(t)
	local entries = self._entries
...
function HudElementSmartTagging:_update_active_progress(dt)
...
function HudElementSmartTagging:_update_widget_locations()
	local entries = self._entries
	local start_angle = 0
...
function HudElementSmartTagging:_push_cursor()
...
function HudElementSmartTagging:_pop_cursor()
...
function HudElementSmartTagging:_find_best_smart_tag_interaction(ui_renderer, render_settings, force_update_targets)
	local raycast_data = self:_find_raycast_targets(force_update_targets)
...
function HudElementSmartTagging:_handle_interaction_draw(dt, t, input_service, ui_renderer, render_settings)
...
function HudElementSmartTagging:_update_tags_interaction_hover_status()
	local active_interaction_data = self._active_interaction_data
...
function HudElementSmartTagging:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
...
function HudElementSmartTagging:_find_raycast_targets(force_update_targets)
...
function HudElementSmartTagging:_physics_world()
...
function HudElementSmartTagging:event_smart_tag_created(tag_instance, is_hotjoin_synced)
	self:_add_smart_tag_presentation(tag_instance, is_hotjoin_synced)
end

function HudElementSmartTagging:event_smart_tag_removed(tag_instance, reason)
...
function HudElementSmartTagging:event_smart_tag_reply_added(tag_instance, reply, replier_player)
	local parent = self._parent
	local player = parent:player()
...
function HudElementSmartTagging:_clear_all_smart_tag_presentations()
	local presented_smart_tags_by_tag_id = self._presented_smart_tags_by_tag_id
...
function HudElementSmartTagging:_play_tag_sound(tag_instance, event_name)
...
function HudElementSmartTagging:_add_smart_tag_presentation(tag_instance, is_hotjoin_synced)
	local presented_smart_tags_by_tag_id = self._presented_smart_tags_by_tag_id
	local tag_id = tag_instance:id()
	local target_location = tag_instance:target_location()
	local tag_template = tag_instance:template()
...
function HudElementSmartTagging:_cb_presentation_tag_spawned(tag_instance, marker_id)
	local tag_id = tag_instance:id()
...
function HudElementSmartTagging:_remove_smart_tag_presentation(tag_id)
	local presented_smart_tags_by_tag_id = self._presented_smart_tags_by_tag_id
...
function HudElementSmartTagging:_draw_active_interaction_line(dt, t, input_service, ui_renderer, render_settings)
	local active_interaction_data = self._active_interaction_data
...
function HudElementSmartTagging:_update_tag_interaction_information(active_interaction_data)
	local marker = active_interaction_data.marker
...
function HudElementSmartTagging:_update_tag_interaction_animation(dt, t)
	local active_interaction_data = self._active_interaction_data
...
function HudElementSmartTagging:_can_tag_active_interaction()
	local parent = self._parent
	local player = parent:player()
...
function HudElementSmartTagging:_can_present_tag_interaction()
	local parent = self._parent
	local player = parent:player()
