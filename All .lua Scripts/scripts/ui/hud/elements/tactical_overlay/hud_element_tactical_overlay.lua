...
function HudElementTacticalOverlay:init(parent, draw_layer, start_scale, definitions)
...
function HudElementTacticalOverlay:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementTacticalOverlay:_set_difficulty_icons(style, difficulty_value)
	local difficulty_icon_style = style.difficulty_icon
	difficulty_icon_style.amount = difficulty_value
end

function HudElementTacticalOverlay:_setup_left_panel_widgets()
	local definitions = {
...
function HudElementTacticalOverlay:_sync_mission_info()
...
function HudElementTacticalOverlay:_sync_circumstance_info()
...
function HudElementTacticalOverlay:_update_visibility(dt)
...
function HudElementTacticalOverlay:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
...
function HudElementTacticalOverlay:on_resolution_modified()
