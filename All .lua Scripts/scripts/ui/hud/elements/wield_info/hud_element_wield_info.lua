...
function HudElementWieldInfo:init(parent, draw_layer, start_scale)
...
function HudElementWieldInfo:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
...
function HudElementWieldInfo:_create_entry(input, optional_validation_function)
	local id = input.id
...
function HudElementWieldInfo:_input_by_id(id)
	local active_wield_inputs = self._active_wield_inputs
...
function HudElementWieldInfo:_remove_entry(index)
	local active_wield_inputs = self._active_wield_inputs
...
function HudElementWieldInfo:update(dt, t, ui_renderer, render_settings, input_service)
...
function HudElementWieldInfo:_validate_input_description(input_description)
...
function HudElementWieldInfo:_realign_input_entries()
	local active_wield_inputs = self._active_wield_inputs
...
function HudElementWieldInfo:_get_input_alias(alias_name)
	local service_type = "Ingame"
...
function HudElementWieldInfo:_get_input_text(alias_name)
	local service_type = "Ingame"
...
function HudElementWieldInfo:_reset_current_info()
...
function HudElementWieldInfo:event_on_input_changed()
