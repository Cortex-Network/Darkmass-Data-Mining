...
function ItemIconLoaderUI:init()
...
function ItemIconLoaderUI:load_icon(item, on_load_callback)
...
function ItemIconLoaderUI:unload_icon(id)
...
function ItemIconLoaderUI:_request_by_id(id, ignore_assert)
...
function ItemIconLoaderUI:has_request(id)
	local data = self:_request_by_id(id, true)

	return data ~= nil
end

function ItemIconLoaderUI:destroy()
end

function ItemIconLoaderUI:load_request(request)
...
function ItemIconLoaderUI:_cb_on_item_package_loaded(gear_id, package_name)
...
function ItemIconLoaderUI:_handle_request_queue()
...
function ItemIconLoaderUI:_handle_next_request_in_queue()
	self._active_request = nil
...
function ItemIconLoaderUI:update(dt, t)
