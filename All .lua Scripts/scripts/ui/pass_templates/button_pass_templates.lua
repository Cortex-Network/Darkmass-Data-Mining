...
function ButtonPassTemplates.list_button_highlight_change_function(content, style)
	local hotspot = content.hotspot
...
function ButtonPassTemplates.list_button_focused_visibility_function(content, style)
	local hotspot = content.hotspot

	return hotspot.is_hover or hotspot.is_selected or hotspot.is_focused
end

function ButtonPassTemplates.list_button_label_change_function(content, style)
	local hotspot = content.hotspot
	local default_color = hotspot.disabled and style.disabled_color or style.default_color
	local hover_color = style.hover_color
	local color = style.text_color or style.color
...
function ButtonPassTemplates.settings_button(width, height, settings_area_width, use_is_focused)
