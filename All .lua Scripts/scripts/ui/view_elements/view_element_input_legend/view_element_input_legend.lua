...
function ViewElementInputLegend:init(parent, draw_layer, start_scale)
...
function ViewElementInputLegend:add_entry(display_name, input_action, visibility_function, on_pressed_callback, side_optional, sound_overrides, use_mouse_hold)
	...
	if on_pressed_callback then
		function content.hotspot.pressed_callback()
...
function ViewElementInputLegend:_update_widget_size(widget, ui_renderer)
	local content = widget.content
...
function ViewElementInputLegend:remove_entry(id)
...
function ViewElementInputLegend:remove_all_entries()
...
function ViewElementInputLegend:update(dt, t, input_service)
...
function ViewElementInputLegend:_handle_input(dt, t, input_service)
...
function ViewElementInputLegend:_on_navigation_input_changed()
	local entries = self._entries
...
function ViewElementInputLegend:set_display_name(entry_id, display_name, suffix)
...
function ViewElementInputLegend:_get_entry_by_id(id)
	local entries = self._entries
...
function ViewElementInputLegend:_update_widget_text(entry)
...
function ViewElementInputLegend:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
