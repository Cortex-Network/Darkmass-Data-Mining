...
function ViewElementItemResultOverlay:init(parent, draw_layer, start_scale)
...
function ViewElementItemResultOverlay:_setup_default_gui()
...
function ViewElementItemResultOverlay:_setup_background_gui()
	local ui_manager = Managers.ui
	local reference_name = self._reference_name
	local timer_name = "ui"
...
function ViewElementItemResultOverlay:cb_background_shading_callback(world, shading_env, viewport, default_shading_environment_name)
...
function ViewElementItemResultOverlay:on_resolution_modified(scale)
	ViewElementItemResultOverlay.super.on_resolution_modified(self, scale)
end

function ViewElementItemResultOverlay:start(presentation_data)
...
function ViewElementItemResultOverlay:cb_start_reward_presentation()
end

function ViewElementItemResultOverlay:destroy()
...
function ViewElementItemResultOverlay:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElementItemResultOverlay:update(dt, t, input_service)
	if self._time then
...
function ViewElementItemResultOverlay:_set_background_blur(fraction)
...
function ViewElementItemResultOverlay:presentation_complete()
	return self._done
end

function ViewElementItemResultOverlay:_setup_weapon_stats()
...
function ViewElementItemResultOverlay:_update_weapon_stats_position()
	if not self._weapon_stats then
		return
	end
