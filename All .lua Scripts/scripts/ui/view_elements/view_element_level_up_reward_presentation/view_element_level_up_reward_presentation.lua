...
function ViewElementLevelUpRewardPresentation:init(parent, draw_layer, start_scale)
...
function ViewElementLevelUpRewardPresentation:_setup_default_gui()
...
function ViewElementLevelUpRewardPresentation:_setup_background_gui()
	local ui_manager = Managers.ui
	local reference_name = self._reference_name
	local timer_name = "ui"
...
function ViewElementLevelUpRewardPresentation:cb_background_shading_callback(world, shading_env, viewport, default_shading_environment_name)
...
function ViewElementLevelUpRewardPresentation:prepare_reward(reward)
	self._presentation_data = reward
end

function ViewElementLevelUpRewardPresentation:_initialize_preview_world()
...
function ViewElementLevelUpRewardPresentation:_get_spawn_position()
...
function ViewElementLevelUpRewardPresentation:on_resolution_modified(scale)
...
function ViewElementLevelUpRewardPresentation:start()
...
function ViewElementLevelUpRewardPresentation:cb_start_reward_presentation()
	self._on_enter_anim_id = nil
	self._time = 0
end

function ViewElementLevelUpRewardPresentation:destroy()
...
function ViewElementLevelUpRewardPresentation:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElementLevelUpRewardPresentation:update(dt, t, input_service)
	local world_spawner = self._world_spawner
...
function ViewElementLevelUpRewardPresentation:_set_background_blur(fraction)
...
function ViewElementLevelUpRewardPresentation:presentation_complete()
	return self._done
end
