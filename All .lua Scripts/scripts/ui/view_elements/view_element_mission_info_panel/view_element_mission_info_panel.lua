...
function ViewElementMissionInfoPanel:init(parent, draw_layer, start_scale)
...
function ViewElementMissionInfoPanel:destroy()
	self:_destroy_offscreen_renderer()
	ViewElementMissionInfoPanel.super.destroy(self)
end

function ViewElementMissionInfoPanel:update(dt, t, input_service)
...
function ViewElementMissionInfoPanel:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElementMissionInfoPanel:set_active_mission(new_mission_data, play_callback)
...
function ViewElementMissionInfoPanel:set_report_data(happening_data)
	if happening_data ~= self._happening_data then
		self._new_happening_data = happening_data
	end
end

function ViewElementMissionInfoPanel:has_handled_mouse_input()
	return self._handled_mouse_input
end

function ViewElementMissionInfoPanel:formatted_happening_time_left()
	return self._formatted_happening_time_left
end

function ViewElementMissionInfoPanel:_cb_animation_complete(state)
...
function ViewElementMissionInfoPanel:_destroy_offscreen_renderer()
...
function ViewElementMissionInfoPanel:_setup_list_grid(widgets, alignment_widgets)
...
function ViewElementMissionInfoPanel:_create_list_widgets(content, num_items, widget_list, alignment_list)
...
function ViewElementMissionInfoPanel:_clear_mission_data()
...
function ViewElementMissionInfoPanel:_draw_list_widgets(grid, widgets, ui_renderer)
...
function ViewElementMissionInfoPanel:_update_state(dt, t, input_service)
	local state = self._state
...
function ViewElementMissionInfoPanel:_update_state_none(dt, t, input_service)
...
function ViewElementMissionInfoPanel:_transition_to_state_none()
...
function ViewElementMissionInfoPanel:_update_status_report(dt, t, input_service)
	if self._clear_mission_data_flag then
		self._clear_mission_data_flag = false
...
function ViewElementMissionInfoPanel:_transition_to_state_status_report(happening_data)
...
function ViewElementMissionInfoPanel:_update_formatted_time(t)
...
function ViewElementMissionInfoPanel:_update_state_mission(dt, t, input_service)
	local new_mission_data = self._new_mission_data
...
function ViewElementMissionInfoPanel:_transition_to_state_mission_info(mission_data)
