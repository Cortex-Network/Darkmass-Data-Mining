...
blueprint_templates.risk_and_reward = {
	...
	pass_template = {
		...
		{
			value_id = "resistance_label",
			pass_type = "text",
			style_id = "resistance_label",
			value = Localize("loc_mission_board_view_resistance")
		},
		{
			style_id = "resistance",
			value_id = "resistance",
		...
		{
			value_id = "challenge_label",
			pass_type = "text",
			style_id = "challenge_label",
			value = Localize("loc_mission_board_view_challenge")
		},
		{
			style_id = "challenge",
			value_id = "challenge",
		...
		},
		{
			...
			pass_type = "text",
			style_id = "xp_label",
			value = Localize("loc_mission_board_view_experience")
		},
		{
			style_id = "tag_xp",
			value_id = "tag_xp",
		...
		},
		{
			...
			value = Localize("loc_mission_board_view_reward")
		},
		{
			style_id = "tag_reward",
			value_id = "tag_reward",
...
function blueprint_utility_functions.base_xp_calculation(resistance_level, challenge_level)
...
function blueprint_utility_functions.prepare_details_data(mission_data, map_data)
...
function blueprint_utility_functions.prepare_report_data(happening_data, time_left_callback)
	local num_elements = 0
