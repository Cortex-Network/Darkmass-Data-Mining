...
function ViewElementPlayerSocialPopup:init(parent, draw_layer, start_scale)
...
function ViewElementPlayerSocialPopup:close(on_done_callback)
...
function ViewElementPlayerSocialPopup:set_close_popup_request_callback(callback)
	self._request_close_popup = callback
end

function ViewElementPlayerSocialPopup:set_player_info(parent, player_info, portrait_data)
...
function ViewElementPlayerSocialPopup:on_navigation_input_changed(using_cursor_navigation)
	...
	elseif menu_grid:selected_grid_index() then
		menu_grid:select_grid_index(nil, , , true)
	end
end

function ViewElementPlayerSocialPopup:on_resolution_modified(scale)
...
function ViewElementPlayerSocialPopup:update(dt, t, input_service)
	local menu_grid = self._menu_grid
...
function ViewElementPlayerSocialPopup:draw(dt, t, ui_renderer, parent_render_settings, input_service)
...
function ViewElementPlayerSocialPopup:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
...
function ViewElementPlayerSocialPopup:_set_player_info(parent, player_info, portrait_data, menu_items, num_menu_items)
...
function ViewElementPlayerSocialPopup:_setup_menu_items(menu_items, num_menu_items)
...
function ViewElementPlayerSocialPopup:_create_menu_widget(menu_item_settings)
...
function ViewElementPlayerSocialPopup:_start_fade_animation(name, on_done_callback)
...
function ViewElementPlayerSocialPopup:_cb_on_animation_done(on_done_callback)
