...
function ViewElementWeaponExperiencePresentation:init(parent, draw_layer, start_scale)
...
function ViewElementWeaponExperiencePresentation:_initialize_preview_world()
...
function ViewElementWeaponExperiencePresentation:_update_viewport_resolution()
...
function ViewElementWeaponExperiencePresentation:_get_spawn_position()
...
function ViewElementWeaponExperiencePresentation:on_resolution_modified(scale)
...
function ViewElementWeaponExperiencePresentation:skip()
...
function ViewElementWeaponExperiencePresentation:start(presentation_data, duration)
...
function ViewElementWeaponExperiencePresentation:_setup_experience_presentation_data(experience_settings, starting_experience, experience_gained, presentation_duration)
...
function ViewElementWeaponExperiencePresentation:cb_start_experience_presentation()
	ExperiencePresentation.start_presentation(self._experience_data)

	self._on_enter_anim_id = nil
end

function ViewElementWeaponExperiencePresentation:canvas_size()
	return self:_scenegraph_size("canvas")
end

function ViewElementWeaponExperiencePresentation:set_pivot_offset(x, y)
	self:_set_scenegraph_position("canvas", x, y)
	self:_force_update_scenegraph()
end

function ViewElementWeaponExperiencePresentation:destroy()
...
function ViewElementWeaponExperiencePresentation:draw(dt, t, ui_renderer, render_settings, input_service)
...
function ViewElementWeaponExperiencePresentation:update(dt, t, input_service)
	local world_spawner = self._world_spawner
...
function ViewElementWeaponExperiencePresentation:_set_next_level(level)
...
function ViewElementWeaponExperiencePresentation:_set_experience_text(text)
	local widget = self._widgets_by_name.experience_text
	widget.content.text = text
end

function ViewElementWeaponExperiencePresentation:_set_bar_progress(progress)
...
function ViewElementWeaponExperiencePresentation:presentation_complete()
	local experience_data = self._experience_data
