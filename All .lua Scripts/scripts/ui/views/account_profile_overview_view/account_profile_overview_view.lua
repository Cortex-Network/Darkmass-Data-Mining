...
function AccountProfileOverwiewView:init(settings, context)
...
function AccountProfileOverwiewView:on_enter()
...
function AccountProfileOverwiewView:on_exit()
...
function AccountProfileOverwiewView:update(dt, t, input_service)
...
function AccountProfileOverwiewView:draw(dt, t, input_service, layer)
...
function AccountProfileOverwiewView:cb_received_overview_data(data)
	self:_set_account_overview_data(data)
end

function AccountProfileOverwiewView:cb_received_boons_data(data)
	self:_set_boons_data(data)
end

function AccountProfileOverwiewView:cb_received_commendations_data(data)
	self:_set_commendations_data(data)
end

function AccountProfileOverwiewView:cb_received_current_contract_data(data)
	self:_set_current_contracts_data(data)
end

function AccountProfileOverwiewView:cb_show_popup(item_data)
	self:_show_popup(item_data)
end

function AccountProfileOverwiewView:cb_set_active_popup_instance(popup_view)
	self._active_popup_view = popup_view
end

function AccountProfileOverwiewView:cb_all_commendations_button()
end

function AccountProfileOverwiewView:_add_list_item(list, item_data)
...
function AccountProfileOverwiewView:_create_offscreen_renderer()
...
function AccountProfileOverwiewView:_destroy_renderer()
...
function AccountProfileOverwiewView:_draw_list_widgets(list, input_service, ui_renderer)
...
function AccountProfileOverwiewView:_fetch_data()
...
function AccountProfileOverwiewView:_set_account_overview_data(data)
...
function AccountProfileOverwiewView:_set_boons_data(data)
...
function AccountProfileOverwiewView:_set_commendations_data(commendations_data)
...
function AccountProfileOverwiewView:_set_current_contracts_data(data)
...
function AccountProfileOverwiewView:_setup_column(name)
...
function AccountProfileOverwiewView:_show_popup(item_data)
	local context = {
		parent = self,
		icon = item_data.icon,
	...
	Managers.ui:open_view(ACCOUNT_PROFILE_POPUP_VIEW, nil, , , , context)
end

function AccountProfileOverwiewView:_format_progress(task_type, progress_current, progress_goal)
