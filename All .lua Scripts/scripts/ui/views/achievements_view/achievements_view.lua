...
function AchievementsView:init(settings, context)
...
function AchievementsView:on_enter()
...
function AchievementsView:on_exit()
...
function AchievementsView:on_resolution_modified(scale)
	AchievementsView.super.on_resolution_modified(self, scale)
	self:_update_grid_positions()
end

function AchievementsView:update(dt, t, input_service)
...
function AchievementsView:on_back_pressed()
	return not self._allow_close_hotkey
end

function AchievementsView:_on_navigation_input_changed()
...
function AchievementsView:_handle_input(input_service, dt, t)
...
function AchievementsView:_cb_summary_selected()
	self._show_summary_next_frame = true
	self._next_category_id = nil
end

function AchievementsView:_cb_category_selected(widget, config, category_id)
	self._next_category_id = category_id
end

function AchievementsView:_cb_unfold_legend_button_visibility(should_be_unfolded)
...
function AchievementsView:_cb_category_pressed(widget, config)
...
function AchievementsView:_populate_page()
...
function AchievementsView:_update_current_category()
...
function AchievementsView:_fold_or_unfold_subcategories(category_id)
	local categories = self._categories
...
function AchievementsView:_show_summary()
...
function AchievementsView:_populate_achievements_grid(achievements, group_label)
...
function AchievementsView:_populate_categories_column()
	local categories = self._categories
	local blueprints = self._definitions.blueprints
...
function AchievementsView:_setup_input_legend()
...
function AchievementsView:_setup_grids()
...
function AchievementsView:_set_achievements_and_categories(achievements)
...
function AchievementsView:_update_grid_positions()
	local grid_settings = self._definitions.grid_settings
	local grids = self._grids
