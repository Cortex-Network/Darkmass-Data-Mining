...
function CharacterAppearanceView:init(settings, context)
...
function CharacterAppearanceView:on_enter()
...
function CharacterAppearanceView:_create_offscreen_renderer()
...
function CharacterAppearanceView:_setup_input_legend()
...
function CharacterAppearanceView:_setup_button_callbacks()
...
function CharacterAppearanceView:_setup_profile_background()
...
function CharacterAppearanceView:event_register_character_spawn_point(spawn_point_unit)
...
function CharacterAppearanceView:_spawn_profile(spawn_point_unit)
...
function CharacterAppearanceView:_on_continue_pressed()
	if self._is_barber then
...
function CharacterAppearanceView:_randomize_character_appearance()
...
function CharacterAppearanceView:_update_appearance_selection()
...
function CharacterAppearanceView:_handle_continue_button_text()
...
function CharacterAppearanceView:_randomize_character_backstory()
...
function CharacterAppearanceView:_randomize_character_name()
...
function CharacterAppearanceView:_stop_character_name_input()
	if self._page_widgets then
		local input_widget = self._page_widgets[1]
		local content = input_widget.content
...
function CharacterAppearanceView:_update_character_custom_name()
...
function CharacterAppearanceView:_update_character_name()
...
function CharacterAppearanceView:_sync_profile_changes()
	local character_create = self._character_create
...
function CharacterAppearanceView:_change_page_indicator(index)
...
function CharacterAppearanceView:_update_appearance_background(added_spacing)
...
function CharacterAppearanceView:_populate_page_grid(index, entry)
...
function CharacterAppearanceView:_should_present_option(option)
...
function CharacterAppearanceView:_is_option_valid(value_table, profile_choice)
...
function CharacterAppearanceView:_is_backstory_option_valid(values)
...
function CharacterAppearanceView:_zoom_camera()
	local slot_name = nil
...
function CharacterAppearanceView:_is_camera_zoomed(camera_focus)
	return camera_focus == "slot_body_face"
end

function CharacterAppearanceView:_set_camera_height_option(camera_focus, gear_visible)
...
function CharacterAppearanceView:_draw_widgets(dt, t, input_service, ui_renderer)
...
function CharacterAppearanceView:_draw_grid(dt, t, input_service)
...
function CharacterAppearanceView:_event_profile_sync_changed(is_active)
	self:_show_loading_character(is_active)
end

function CharacterAppearanceView:_show_loading_character(is_active)
...
function CharacterAppearanceView:_show_loading_awaiting_validation(is_active)
	self._loading_overlay_visible = is_active
...
function CharacterAppearanceView:update(dt, t, input_service)
	if self.closing_view or not self._entered then
		return
	end
...
function CharacterAppearanceView:_on_entry_pressed(current_widget, option, grid_index)
...
function CharacterAppearanceView:_check_widget_choice_detail_visibility(widget)
...
function CharacterAppearanceView:_on_navigation_input_changed()
...
function CharacterAppearanceView:_update_current_navigation_position(grid_index, widget_index)
	local current_grid_index = self._navigation.grid
	local current_widget_index = self._navigation.index
	local current_widget = self._page_grids[current_grid_index] and self._page_grids[current_grid_index].widgets and self._page_grids[current_grid_index].widgets[current_widget_index]
...
function CharacterAppearanceView:_update_load_appearance_icon_priority(widget, prioritized)
...
function CharacterAppearanceView:_load_appearance_icon(widget, prioritized)
...
function CharacterAppearanceView:_update_appearance_icon()
	for i = 1, #self._page_grids do
...
function CharacterAppearanceView:_unload_appearance_icon(widget)
...
function CharacterAppearanceView:_unload_all_appearance_icons()
	for i = 1, #self._page_grids do
		local grid = self._page_grids[i]
...
function CharacterAppearanceView:_set_player_icon(widget, grid_index, rows, columns, render_target)
	local material_values = widget.style.texture.material_values
...
function CharacterAppearanceView:_create_page_indicators()
...
function CharacterAppearanceView:_on_close_pressed()
	local world = Managers.ui:world()
	local wwise_world = Managers.world:wwise_world(world)
...
function CharacterAppearanceView:on_back_pressed()
	return true
end

function CharacterAppearanceView:_destroy_renderer()
...
function CharacterAppearanceView:_destroy_background()
	if self._profile_spawner then
...
function CharacterAppearanceView:on_exit()
...
function CharacterAppearanceView:_set_selected_backstory()
...
function CharacterAppearanceView:_populate_backstory_info(settings)
...
function CharacterAppearanceView:_generate_reward_widgets(settings, start_pos, background_size)
...
function CharacterAppearanceView:_get_text_size(text, style_name)
...
function CharacterAppearanceView:_is_backstory_option_visible(option)
...
function CharacterAppearanceView:_hide_pages_widgets()
	for i = 1, #self._page_indicator_widgets do
		local widget = self._page_indicator_widgets[i]
		widget.content.visible = false
	end
...
function CharacterAppearanceView:_destroy_generated_widgets(start_index)
...
function CharacterAppearanceView:_show_default_page(page)
	for i = 1, #self._page_indicator_widgets do
		local widget = self._page_indicator_widgets[i]
...
function CharacterAppearanceView:_update_final_page_text()
...
function CharacterAppearanceView:_show_final_page(page)
	self:_create_errors_name_input()
...
function CharacterAppearanceView:_create_randomize_button()
	local service_type = DefaultViewInputSettings.service_type
	local text_margin = 0
	local button_margin = {
		40,
...
function CharacterAppearanceView:_set_character_height(scale_factor)
	self._profile_spawner:set_character_scale(scale_factor)
	self._character_create:set_height(scale_factor)
end

function CharacterAppearanceView:_get_appearance_category_options(category_entry_options)
...
function CharacterAppearanceView:_get_planet_content()
...
function CharacterAppearanceView:_get_childhood_content()
...
function CharacterAppearanceView:_get_growing_up_content()
...
function CharacterAppearanceView:_get_formative_event_content()
...
function CharacterAppearanceView:_get_backstory_content()
...
function CharacterAppearanceView:_get_appearance_content()
...
function CharacterAppearanceView:_get_personality_content()
...
function CharacterAppearanceView:_get_crime_content()
...
function CharacterAppearanceView:_open_appearance_options(index)
...
function CharacterAppearanceView:_get_pages()
	return {
		{
			name = "home_planet",
...
function CharacterAppearanceView:_check_appearance_continue_block(page_content)
...
function CharacterAppearanceView:_check_personality_continue_block(page_content)
	local options = page_content.options
...
function CharacterAppearanceView:_check_valid_personality_options(options)
...
function CharacterAppearanceView:_create_errors_name_input(errors)
...
function CharacterAppearanceView:_destroy_support_page_widgets()
	if self._page_widgets then
...
function CharacterAppearanceView:_handle_input(input_service)
...
function CharacterAppearanceView:_grid_navigation(start_direction)
...
function CharacterAppearanceView:_move_background_to_position(planet, skip_animation)
...
function CharacterAppearanceView:_setup_planets_widgets()
...
function CharacterAppearanceView:_destroy_planets_widgets()
...
function CharacterAppearanceView:on_resolution_modified()
	CharacterAppearanceView.super.on_resolution_modified(self)
	self:_align_background()
end

function CharacterAppearanceView:_align_background()
...
function CharacterAppearanceView:dialogue_system()
	if self._is_barber then
