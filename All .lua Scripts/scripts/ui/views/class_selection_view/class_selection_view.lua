...
function ClassSelectionView:_start_loading_talent_icons()
...
function ClassSelectionView:_should_load_icons()
...
function ClassSelectionView:_create_offscreen_renderer()
...
function ClassSelectionView:_destroy_offscreen_renderer()
...
function ClassSelectionView:_setup_input_legend()
...
function ClassSelectionView:_setup_background_world(level_name)
...
function ClassSelectionView:event_register_character_camera(camera_unit)
...
function ClassSelectionView:event_register_character_spawn_point(spawn_point_unit)
	self:_unregister_event("event_register_character_spawn_point")

	self._spawn_point_unit = spawn_point_unit
end

function ClassSelectionView:_enable_blur(enable)
...
function ClassSelectionView:draw(dt, t, input_service, layer)
...
function ClassSelectionView:update(dt, t, input_service)
...
function ClassSelectionView:_on_choose_pressed()
...
function ClassSelectionView:_on_continue_pressed()
	self._character_create:set_specialization(self._selected_class.name)
	self:_play_sound(UISoundEvents.character_create_confirm)
	Managers.event:trigger("event_create_new_character_continue")
end

function ClassSelectionView:_on_details_pressed()
	if self._classes_visible then
...
function ClassSelectionView:_handle_input(input_service)
...
function ClassSelectionView:_on_navigation_input_changed()
	ClassSelectionView.super._on_navigation_input_changed(self)
	self:_handle_continue_button_text()
end

function ClassSelectionView:_create_domain_option_widgets()
...
function ClassSelectionView:_on_domain_pressed(selected_domain)
...
function ClassSelectionView:_update_domain_info()
...
function ClassSelectionView:_update_choose_button_text()
	local widgets_by_name = self._widgets_by_name
...
function ClassSelectionView:_show_classes_widgets(show, force_domain)
	local widgets_by_name = self._widgets_by_name
...
function ClassSelectionView:_destroy_class_option_widgets()
...
function ClassSelectionView:_create_class_option_widgets()
...
function ClassSelectionView:_on_class_pressed(class_name)
...
function ClassSelectionView:_destroy_domain_option_widgets()
...
function ClassSelectionView:_destroy_class_abilities_info()
...
function ClassSelectionView:_show_class_details(show)
	local widgets_by_name = self._widgets_by_name
...
function ClassSelectionView:_create_class_abilities_info()
...
function ClassSelectionView:on_choose_pressed()
	self:_on_choose_pressed()
end

function ClassSelectionView:archetype_options()
	return self._domain_options
end

function ClassSelectionView:on_domain_pressed(target_option)
	self:_on_domain_pressed(target_option)
end

function ClassSelectionView:_cb_on_open_options_pressed()
	Managers.ui:open_view("options_view")
end

function ClassSelectionView:_handle_continue_button_text()
	local widgets_by_name = self._widgets_by_name
