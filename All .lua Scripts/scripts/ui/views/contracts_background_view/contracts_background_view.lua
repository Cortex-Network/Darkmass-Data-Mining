...
function ContractsBackgroundView:init(settings, context)
	self._wallet_type = "marks"

	ContractsBackgroundView.super.init(self, Definitions, settings, context)
end

function ContractsBackgroundView:on_enter()
...
function ContractsBackgroundView:update_wallets()
	ContractsBackgroundView.super._update_wallets(self)
end

function ContractsBackgroundView:on_exit()
