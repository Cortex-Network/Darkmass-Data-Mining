...
function ContractsView:init(settings, context)
...
function ContractsView:on_enter()
...
function ContractsView:on_exit()
...
function ContractsView:_on_navigation_input_changed()
...
function ContractsView:on_resolution_modified(scale)
	ContractsView.super.on_resolution_modified(self, scale)
	self:_update_task_grid_position()
end

function ContractsView:update(dt, t, input_service)
...
function ContractsView:_handle_input(input_service, dt, t)
...
function ContractsView:cb_on_close_pressed()
	local view_name = self.view_name

	Managers.ui:close_view(view_name)
end

function ContractsView:cb_reroll_task_confirmed(task_id, wallet)
...
function ContractsView:_cb_reroll_task_pressed(task_info)
...
function ContractsView:_display_task_info(task_widget, task_info)
...
function ContractsView:_hide_task_info()
...
function ContractsView:_destroy_renderer()
	if self._offscreen_renderer then
...
function ContractsView:_setup_task_grid_layout()
...
function ContractsView:_fetch_task_list()
	local player = self:_player()
	local character_id = player:character_id()
...
function ContractsView:_replace_contract(task_id, data)
	self._contract_data = data
	self._update_tasks_list = true
end

function ContractsView:_set_contract_info(contract_data)
...
function ContractsView:_populate_task_list(tasks)
	local task_list = {}
	...
	task_grid:present_grid_layout(task_list, self._definitions.widget_blueprints, select_widget_function, nil, , , on_present_callback)

	return num_completed_tasks
end

function ContractsView:_update_contract_time_left(t)
...
function ContractsView:_update_reroll_button_text(using_gamepad)
...
function ContractsView:_fetch_wallet(type)
...
function ContractsView:_update_wallets()
...
function ContractsView:_display_confirmation_popup(task_id, wallet)
	local reroll_cost = self._contract_data.rerollCost
