...
function CraftingFuseView:init(settings, context)
...
function CraftingFuseView:on_enter()
...
function CraftingFuseView:_register_button_callbacks()
...
function CraftingFuseView:_generate_arrows()
...
function CraftingFuseView:can_exit()
	return self._can_exit
end

function CraftingFuseView:on_back_pressed(force_close)
...
function CraftingFuseView:_fetch_inventory_traits()
...
function CraftingFuseView:update(dt, t, input_service)
...
function CraftingFuseView:draw(dt, t, input_service, layer)
...
function CraftingFuseView:on_exit()
...
function CraftingFuseView:_destroy_item_grid()
...
function CraftingFuseView:_destroy_menu_tabs()
...
function CraftingFuseView:_setup_item_grid()
...
function CraftingFuseView:_update_item_grid_position()
	if not self._inventory_traits_grid then
		return
	end
...
function CraftingFuseView:_setup_menu_tabs()
	local id = "tab_menu"
	local layer = 10
...
function CraftingFuseView:cb_switch_tab(index)
...
function CraftingFuseView:_present_layout_by_trait_level(trait_rarity)
	local traits = {}
...
function CraftingFuseView:cb_on_grid_entry_left_pressed(widget, element)
...
function CraftingFuseView:_add_all_trait_to_fuse(elements)
	for i = 1, #elements do
...
function CraftingFuseView:_reset_state()
	for i = 1, #self._trait_slots do
		local trait_slot = self._trait_slots[i]
		local widget_name = "fuse_" .. i
		local widget = self._widgets_by_name[widget_name]
...
function CraftingFuseView:_remove_all_trait_from_fuse()
	self:_reset_state()
end

function CraftingFuseView:_update_tab_bar_position()
...
function CraftingFuseView:_show_fuse_button()
...
function CraftingFuseView:_fuse_action()
...
function CraftingFuseView:_set_trait_tooltip(trait_widget, direction)
	self:_remove_trait_tooltip()
...
function CraftingFuseView:_set_tooltip_position(parent_widget, direction)
...
function CraftingFuseView:_remove_trait_tooltip()
...
function CraftingFuseView:_handle_input(input_service)
