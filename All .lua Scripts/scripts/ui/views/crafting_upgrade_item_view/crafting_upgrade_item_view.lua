...
function CraftingUpgradeItemView:init(settings, context)
...
function CraftingUpgradeItemView:on_enter()
...
function CraftingUpgradeItemView:_update_weapon_stats_position(scenegraph_id, weapon_stats)
...
function CraftingUpgradeItemView:on_resolution_modified(scale)
...
function CraftingUpgradeItemView:on_back_pressed()
...
function CraftingUpgradeItemView:_present_item_upgrade(item)
...
function CraftingUpgradeItemView:cb_on_main_button_pressed(recipe)
...
function CraftingUpgradeItemView:_on_navigation_input_changed()
...
function CraftingUpgradeItemView:_setup_crafting_recipe(reference_name, scenegraph_id)
	local layer = 10
...
function CraftingUpgradeItemView:_setup_weapon_stats(reference_name, scenegraph_id)
	local layer = 10
...
function CraftingUpgradeItemView:can_afford(amount, currency)
	return self._parent:can_afford(amount, currency)
end

function CraftingUpgradeItemView:can_craft()
	if self._craft_promise then
...
function CraftingUpgradeItemView:dialogue_system()
