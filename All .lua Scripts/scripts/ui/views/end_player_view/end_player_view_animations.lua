...
function animations.carousel_state_slide_cards_to_the_left(parent, state_data, card_widgets, current_card, t)
...
function animations.carousel_state_expand_current_card(parent, state_data, card_widgets, current_card, t)
	local color_utils_color_lerp = _color_utils_color_lerp
...
function animations.carousel_state_fade_in_card_content(parent, state_data, card_widgets, current_card, t)
	local card_widget = card_widgets[current_card]
...
function animations.carousel_state_show_card_content(parent, state_data, card_widgets, current_card, t)
...
function animations.wallet_change_function(content, style, animation, dt)
...
function animations.experience_gain_change_function(content, style)
