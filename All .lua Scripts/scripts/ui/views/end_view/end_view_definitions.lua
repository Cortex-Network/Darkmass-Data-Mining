...
local widget_definitions = {
	...
	}, "vote_text", nil, , ViewStyles.stay_in_party_vote)
}
...
local game_mode_condition_widget_definitions = {
	victory = {
		static = {
			...
			}, "corner_top_left", nil, , ViewStyles.page_corner_decoration),
			...
			}, "corner_top_right", nil, , ViewStyles.page_corner_decoration),
			...
			}, "screen", nil, , ViewStyles.page_bottom_decoration),
			...
			}, "bottom_center", nil, , ViewStyles.page_bottom_center_decoration),
			...
			}, "corner_bottom_left", nil, , ViewStyles.page_corner_decoration),
			...
			}, "corner_bottom_right", nil, , ViewStyles.page_corner_decoration)
		},
		dynamic = {
			...
			}, "title_text", nil, , ViewStyles.mission_header_victory),
			player_panel = UIWidget.create_definition(player_panel_pass_template, "panel", nil, , ViewStyles.player_panel_victory)
		}
	},
	defeat = {
		static = {
		...
		dynamic = {
			...
			}, "title_text", nil, , ViewStyles.mission_header_defeat),
			player_panel = UIWidget.create_definition(player_panel_pass_template, "panel", nil, , ViewStyles.player_panel_defeat)
		}
	}
}
