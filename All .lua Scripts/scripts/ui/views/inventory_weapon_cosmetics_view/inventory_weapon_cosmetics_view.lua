...
function InventoryWeaponCosmeticsView:init(settings, context)
...
function InventoryWeaponCosmeticsView:_setup_forward_gui()
...
function InventoryWeaponCosmeticsView:_destroy_forward_gui()
...
function InventoryWeaponCosmeticsView:on_exit()
	self:_destroy_forward_gui()
	InventoryWeaponCosmeticsView.super.on_exit(self)
end

function InventoryWeaponCosmeticsView:on_enter()
...
function InventoryWeaponCosmeticsView:_register_button_callbacks()
...
function InventoryWeaponCosmeticsView:_update_equip_button_state()
...
function InventoryWeaponCosmeticsView:present_grid_layout(layout, optional_on_present_callback)
...
function InventoryWeaponCosmeticsView:_setup_weapon_stats()
end

function InventoryWeaponCosmeticsView:_setup_sort_options()
end

function InventoryWeaponCosmeticsView:_setup_weapon_preview()
...
function InventoryWeaponCosmeticsView:_setup_menu_tabs(content)
...
function InventoryWeaponCosmeticsView:_update_tab_bar_position()
...
function InventoryWeaponCosmeticsView:_setup_input_legend()
...
function InventoryWeaponCosmeticsView:_fetch_inventory_items(slot_name, item_type, get_item_filters_function, get_empty_item_function, generate_visual_item_function, filter_on_weapon_template)
...
function InventoryWeaponCosmeticsView:_select_starting_item_by_slot_name(slot_name, optional_start_index)
...
function InventoryWeaponCosmeticsView:_item_valid_by_current_profile(item)
...
function InventoryWeaponCosmeticsView:selected_item_name_in_slot(slot_name)
...
function InventoryWeaponCosmeticsView:equipped_item_name_in_slot(slot_name)
	if slot_name == "slot_trinket_1" then
...
function InventoryWeaponCosmeticsView:cb_on_equip_pressed()
...
function InventoryWeaponCosmeticsView:_cb_on_close_pressed()
	Managers.ui:close_view("inventory_weapon_cosmetics_view")
end

function InventoryWeaponCosmeticsView:_preview_element(element)
...
function InventoryWeaponCosmeticsView:_preview_item(item)
...
function InventoryWeaponCosmeticsView:on_back_pressed()
	Managers.ui:close_view("inventory_weapon_cosmetics_view")
end

function InventoryWeaponCosmeticsView:_set_weapon_zoom(fraction)
	self._weapon_zoom_fraction = fraction
end

function InventoryWeaponCosmeticsView:_cb_on_ui_visibility_toggled(id)
...
function InventoryWeaponCosmeticsView:_handle_input(input_service)
...
function InventoryWeaponCosmeticsView:update(dt, t, input_service)
	self:_update_equip_button_state()

	return InventoryWeaponCosmeticsView.super.update(self, dt, t, input_service)
end

function InventoryWeaponCosmeticsView:draw(dt, t, input_service, layer)
...
function InventoryWeaponCosmeticsView:_draw_render_target()
	local ui_forward_renderer = self._ui_forward_renderer
...
function InventoryWeaponCosmeticsView:_draw_widgets(dt, t, input_service, ui_renderer, render_settings)
...
function InventoryWeaponCosmeticsView:cb_switch_tab(index)
...
function InventoryWeaponCosmeticsView:on_resolution_modified(scale)
