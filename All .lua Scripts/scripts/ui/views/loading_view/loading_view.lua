...
function LoadingView:init(settings, context)
...
function LoadingView:draw(dt, t, input_service, layer)
	LoadingView.super.draw(self, dt, t, input_service, layer)
	Managers.ui:render_loading_icon()
end

function LoadingView:can_exit()
	return self._can_exit
end

function LoadingView:on_exit()
	LoadingView.super.on_exit(self)
end

function LoadingView:event_on_input_changed()
	self:_update_input_display()
end

function LoadingView:_update_input_display()
	local text = "loc_next"
...
function LoadingView:_widget_text_length(widget_id)
...
function LoadingView:_handle_input(input_service)
	if input_service:get("next") then
		self:_cycle_next_hint()
	end
end

function LoadingView:_cycle_next_hint()
...
function LoadingView:_set_hint_text_opacity(opacity)
	local widget = self._widgets_by_name.hint_text
	widget.alpha_multiplier = opacity
end

function LoadingView:_update_next_hint()
...
function LoadingView:_set_hint_text(text)
	local widget = self._widgets_by_name.hint_text
	widget.content.text = self:_localize(text)
end

function LoadingView:_set_overlay_opacity(opacity)
	local widget = self._widgets_by_name.overlay
	widget.alpha_multiplier = opacity
end

function LoadingView:update(dt, t, input_service)
