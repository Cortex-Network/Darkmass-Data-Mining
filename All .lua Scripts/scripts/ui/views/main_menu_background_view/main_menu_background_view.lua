...
function MainMenuBackgroundView:on_enter()
	...
	Managers.ui:open_view("main_menu_view", nil, , , , self._context)
end
...
function MainMenuBackgroundView:event_register_main_menu_camera(camera_unit)
...
function MainMenuBackgroundView:event_register_main_menu_new_character_dummy(dummy_unit)
...
function MainMenuBackgroundView:event_register_main_menu_spawn_point(spawn_point_unit)
...
function MainMenuBackgroundView:event_main_menu_load_profile(profile, prioritized)
...
function MainMenuBackgroundView:_spawn_profile(profile)
...
function MainMenuBackgroundView:_show_dummy_unit()
	if self._profile_spawner then
...
function MainMenuBackgroundView:_set_profile_in_loading_queue(profile, prioritized)
	if prioritized then
		table.insert(self._loading_profile_queue, 1, profile)
	else
...
function MainMenuBackgroundView:_load_profile(profile)
...
function MainMenuBackgroundView:_unload_profile(profile)
...
function MainMenuBackgroundView:can_exit()
	return self._can_exit
end

function MainMenuBackgroundView:on_exit()
	if self._profile_spawner then
		self._profile_spawner:destroy()
...
function MainMenuBackgroundView:_handle_background_blur()
...
function MainMenuBackgroundView:update(dt, t, input_service)
	local world_spawner = self._world_spawner
