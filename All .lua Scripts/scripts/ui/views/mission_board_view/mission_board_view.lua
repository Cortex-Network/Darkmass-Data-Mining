...
function MissionBoardView:init(settings)
...
function MissionBoardView:on_enter()
...
function MissionBoardView:on_exit()
...
function MissionBoardView:update(dt, t, input_service)
...
function MissionBoardView:_handle_input(input_service, dt, t)
...
function MissionBoardView:_update_can_start_mission()
...
function MissionBoardView:_set_info_text(level, text)
...
function MissionBoardView:_set_gamepad_cursor(widget)
...
function MissionBoardView:_set_selected_quickplay(move_gamepad_cursor)
...
function MissionBoardView:_set_selected_mission(mission, move_gamepad_cursor)
...
function MissionBoardView:draw(dt, t, input_service, layer)
...
function MissionBoardView:_begin_render_offscreen(dt, input_service)
...
function MissionBoardView:_end_render_offscreen()
	if not MissionBoardViewSettings.resource_renderer_enabled then
		return
	end
...
function MissionBoardView:_destroy_mission_widget(widget)
	local content = widget.content
...
function MissionBoardView:_join_mission_data()
...
function MissionBoardView:_get_free_position(preferred_index)
...
function MissionBoardView:_populate_mission_widget(widget, mission, position, is_medium_widget)
	local mission_template = MissionTemplates[mission.map]
...
function MissionBoardView:on_resolution_modified(scale)
...
function MissionBoardView:event_register_camera(camera_unit)
...
function MissionBoardView:_update_fetch_missions(t)
...
function MissionBoardView:_fetch_success(data)
...
function MissionBoardView:_fetch_failure(error_message)
...
function MissionBoardView:_update_happening(t)
...
function MissionBoardView:_callback_close_view()
	Managers.ui:close_view(self.view_name)
end

function MissionBoardView:_callback_start_selected_mission()
...
function MissionBoardView:_callback_toggle_game_settings_visibility()
...
function MissionBoardView:_callback_on_danger_changed()
	self._quickplay_difficulty = self._widgets_by_name.difficulty_stepper.content.danger
end

function MissionBoardView:_callback_mission_widget_exit_done(widget)
