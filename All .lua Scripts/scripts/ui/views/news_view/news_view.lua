...
function NewsView:init(settings, context)
...
function NewsView:_add_viewed_slide(slide_to_add)
...
function NewsView:_save_viewed_slides()
...
function NewsView:on_exit()
	self:_save_viewed_slides()
	self:_destroy_renderer()
	NewsView.super.on_exit(self)
end

function NewsView:_destroy_renderer()
...
function NewsView:_create_offscreen_renderer()
...
function NewsView:_create_grid_widgets(content)
	local grid_widgets = {}
...
function NewsView:_create_slide_page_circles()
...
function NewsView:_setup_grid(widgets, alignment_list)
...
function NewsView:_clean_current_slide()
...
function NewsView:_change_slide(new_value)
...
function NewsView:_draw_widgets(dt, t, input_service, ui_renderer)
	local slide_left_image = self._slide_left_image
...
function NewsView:draw(dt, t, input_service, layer)
...
function NewsView:update(dt, t, input_service, layer)
	self._grid:update(dt, t, input_service)

	return NewsView.super.update(self, dt, t, input_service, layer)
end

function NewsView:_setup_buttons_interactions()
...
function NewsView:_get_animation_widgets()
	local widgets = {
...
function NewsView:_animate_slide_out(next_slide)
...
function NewsView:_animate_slide_in()
	local widgets = self:_get_animation_widgets()

	self:_start_animation("on_enter", widgets, nil, callback(self, "_enable_interactions", false))
end

function NewsView:_set_slide_indicator_focus(index)
	local slide_page_circles = self._slide_page_circles
...
function NewsView:_enable_interactions(is_disabled)
...
function NewsView:_on_navigation_input_changed()
...
function NewsView:_handle_input(input_service, dt, t)
