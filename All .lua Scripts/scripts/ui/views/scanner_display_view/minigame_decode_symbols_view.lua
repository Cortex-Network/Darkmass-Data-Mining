...
function MinigameDecodeSymbolsView:init(context)
	self._minigame_extension = context.minigame_extension
	self._grid_widgets = {}
end

function MinigameDecodeSymbolsView:destroy()
	self._timer_start = nil
end

local system_name = "dialogue_system"

function MinigameDecodeSymbolsView:dialogue_system()
...
function MinigameDecodeSymbolsView:draw_widgets(dt, t, input_service, ui_renderer)
...
function MinigameDecodeSymbolsView:_draw_cursor(widgets_by_name, decode_start_time)
...
function MinigameDecodeSymbolsView:_draw_targets(widgets_by_name, decode_start_time)
	local minigame_extension = self._minigame_extension
	local minigame = minigame_extension:minigame(MinigameSettings.types.decode_symbols)
...
function MinigameDecodeSymbolsView:_get_cursor_position_from_time(decode_start_time, time)
