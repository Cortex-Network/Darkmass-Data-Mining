...
function MinigameScanView:init(context)
...
function MinigameScanView:dialogue_system()
...
function MinigameScanView:destroy()
end
...
function MinigameScanView:update(dt, t, widgets_by_name)
...
function MinigameScanView:draw_widgets(dt, t, input_service, ui_renderer)
	self:_draw_skulls(ui_renderer)
	self:_draw_segments(ui_renderer)
end

function MinigameScanView:_draw_skulls(ui_renderer)
...
function MinigameScanView:_draw_segments(ui_renderer)
...
function MinigameScanView:_create_skull_widgets()
	self:_create_wallet_widgets("scanner_scan_skull", "skull_", "skull", self._skull_widgets)
end

function MinigameScanView:_create_cog_widgets()
	self:_create_wallet_widgets("scanner_scan_cog", "cog_", "cog", self._cog_widgets)
end

function MinigameScanView:_create_wallet_widgets(material_name, widget_name_prefix, style_id, widgets)
