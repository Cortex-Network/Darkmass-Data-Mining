...
function SocialMenuNotificationsView:init(settings, context)
...
function SocialMenuNotificationsView:on_enter()
	SocialMenuNotificationsView.super.on_enter(self)
	self:_populate_data()
end

function SocialMenuNotificationsView:update(dt, t, input_service)
	if self._grid then
...
function SocialMenuNotificationsView:draw(dt, t, input_service, layer)
	SocialMenuNotificationsView.super.draw(self, dt, t, input_service, layer)
end

function SocialMenuNotificationsView:cb_remove_notification(notification)
end

function SocialMenuNotificationsView:_draw_widgets(dt, t, input_service, ui_renderer)
...
function SocialMenuNotificationsView:_populate_data()
	self:_set_dummy_data(5)
	self:_setup_notifications_grid()
end

function SocialMenuNotificationsView:_setup_notifications_grid()
...
function SocialMenuNotificationsView:_create_notification_widgets()
...
function SocialMenuNotificationsView:_clear_widgets(widgets)
	if widgets then
		for i = 1, #widgets do
...
function SocialMenuNotificationsView:_update_notification_widgets(dt, input_service)
...
function SocialMenuNotificationsView:_draw_grid_widgets(dt, t, input_service, ui_renderer)
...
function SocialMenuNotificationsView:_generate_random_notification(order, last_used_time_stamp)
	local notification_types = self._definitions.notification_types
...
function SocialMenuNotificationsView:_set_dummy_data(num_items)
