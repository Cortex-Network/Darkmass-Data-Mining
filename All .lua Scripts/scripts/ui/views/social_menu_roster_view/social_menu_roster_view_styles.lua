...
function change_functions.party_visibility(content, style)
...
function change_functions.party_inverted_visibility(content, style)
	local content_key = style.content_key
...
function change_functions.flickering_windows(content, style, animations, dt)
	local content_key = style.content_key
...
function change_functions.player_plaque_background(content, style)
