...
function SystemView:init(settings)
	SystemView.super.init(self, Definitions, settings)
end

function SystemView:on_enter()
...
function SystemView:_setup_widgets()
...
function SystemView:_setup_input_legend()
...
function SystemView:cb_on_close_pressed()
	local view_name = self.view_name

	Managers.ui:close_view(view_name)
end

function SystemView:_setup_content_grid_scrollbar()
...
function SystemView:_on_entry_pressed_cb(widget, entry)
...
function SystemView:_setup_content_widgets(content, scenegraph_id, callback_name)
...
function SystemView:draw(dt, t, input_service, layer)
...
function SystemView:_draw_widgets(dt, t, input_service, ui_renderer)
	local widgets_by_name = self._widgets_by_name
	local scrollbar_widget = widgets_by_name.scrollbar
...
function SystemView:_setup_grid(widgets, alignment_list)
	local ui_scenegraph = self._ui_scenegraph
...
function SystemView:on_resolution_modified()
...
function SystemView:_on_navigation_input_changed()
...
function SystemView:_setup_background_gui()
...
function SystemView:_setup_default_gui()
	local ui_manager = Managers.ui
	local class_name = self.__class_name
	local timer_name = "ui"
...
function SystemView:cb_shading_callback(world, shading_env, viewport, default_shading_environment_name)
...
function SystemView:_destroy_background()
...
function SystemView:_destroy_default_gui()
