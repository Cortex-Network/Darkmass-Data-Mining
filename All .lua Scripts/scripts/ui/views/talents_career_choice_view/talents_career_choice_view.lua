...
function TalentsCareerChoiceView:init(settings, context)
...
function TalentsCareerChoiceView:on_enter()
...
function TalentsCareerChoiceView:on_exit()
	TalentsCareerChoiceView.super.on_exit(self)
	self:_destroy_renderer()
end

function TalentsCareerChoiceView:on_back_pressed()
...
function TalentsCareerChoiceView:set_can_exit(value, apply_next_frame)
...
function TalentsCareerChoiceView:update(dt, t, input_service)
...
function TalentsCareerChoiceView:draw(dt, t, input_service, ui_layer)
	self:_draw_grid_widgets(dt, t, input_service, ui_layer)
end

function TalentsCareerChoiceView:cb_banner_button_pressed(banner_index)
	local career_banners = self._career_banners
...
function TalentsCareerChoiceView:cb_confirm_choice_button_pressed()
...
function TalentsCareerChoiceView:_handle_input(input_service, dt, t)
...
function TalentsCareerChoiceView:_on_navigation_input_changed()
...
function TalentsCareerChoiceView:_draw_grid_widgets(dt, t, input_service, ui_layer)
...
function TalentsCareerChoiceView:_handle_career_choice(specialization)
...
function TalentsCareerChoiceView:_set_banner_state(banner_index, state)
...
function TalentsCareerChoiceView:_play_banner_animation(banner_index, animation_params)
...
function TalentsCareerChoiceView:_create_offscreen_renderer()
...
function TalentsCareerChoiceView:_destroy_renderer()
...
function TalentsCareerChoiceView:_setup_archetype_data()
	local player = self._preview_player
...
function TalentsCareerChoiceView:_setup_details_list(column, archetype_talents, specialization, banner)
