...
function TalentsView:init(settings, context)
...
function TalentsView:update(dt, t, input_service)
...
function TalentsView:draw(dt, t, input_service, layer)
	if self._init_done then
		TalentsView.super.draw(self, dt, t, input_service, layer)
	end
end

function TalentsView:on_resolution_modified(scale)
...
function TalentsView:cb_widget_clicked(widget, group_index, is_right_button)
...
function TalentsView:_on_navigation_input_changed()
...
function TalentsView:_setup_talent_presentation()
...
function TalentsView:_update_focused_talent(force_update)
...
function TalentsView:_move_camera(camera_settings)
...
function TalentsView:_update_talent_details(dt)
...
function TalentsView:_update_equip_button(dt)
	local talent_widget = self._focused_talent_widget
	local talent_widget_content = talent_widget and talent_widget.content
...
function TalentsView:_select_widget_in_group(group, selected_widget)
...
function TalentsView:_update_profile_talents()
	local player = self._preview_player
	local selected_talents = self._selected_talents
...
function TalentsView:_setup_grid()
...
function TalentsView:_populate_data(profile, selected_talents)
...
function TalentsView:_populate_archetype_data(archetype, specialization)
...
function TalentsView:_set_level_bar(player_level)
...
function TalentsView:_populate_talents_data(character_id, archetype, specialization, talents, selected_talents, player_level)
...
function TalentsView:_create_talent_widget(name, talent_index, talent, group_definition, group_settings, callback_group_index, is_locked, is_selected_talent)
