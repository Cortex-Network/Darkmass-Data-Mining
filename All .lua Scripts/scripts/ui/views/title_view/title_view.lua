...
function TitleView:init(settings, context)
...
function TitleView:_setup_background_world()
...
function TitleView:event_register_title_screen_camera(camera_unit)
...
function TitleView:event_state_title_reset()
...
function TitleView:_apply_title_text()
...
function TitleView:_on_navigation_input_changed()
	TitleView.super._on_navigation_input_changed(self)
	self:_apply_title_text()
end

function TitleView:update(dt, t, input_service)
...
function TitleView:_on_ignore_pressed()
...
function TitleView:_continue(ignore_sound, optional_input_device)
...
function TitleView:_update_viewport_resolution()
