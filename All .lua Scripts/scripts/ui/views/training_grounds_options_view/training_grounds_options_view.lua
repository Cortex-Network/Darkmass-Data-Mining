...
function TrainingGroundsOptionsView:init(settings, context)
...
function TrainingGroundsOptionsView:on_enter()
...
function TrainingGroundsOptionsView:_register_button_callbacks()
...
function TrainingGroundsOptionsView:_load_reward_item_icons()
...
function TrainingGroundsOptionsView:_on_navigation_input_changed()
	self:_set_play_button_text()
end

function TrainingGroundsOptionsView:_set_play_button_text()
...
function TrainingGroundsOptionsView:_start_training_grounds(mechanism_context)
...
function TrainingGroundsOptionsView:on_exit()
	TrainingGroundsOptionsView.super.on_exit(self)
end

function TrainingGroundsOptionsView:_setup_info()
	local widgets_by_name = self._widgets_by_name
...
function TrainingGroundsOptionsView:_resize_background(new_size)
...
function TrainingGroundsOptionsView:_unload_reward_item_icons()
	for i = 1, #self._icons_load_ids do
		Managers.ui:unload_item_icon(self._icons_load_ids[i])
	end
end

function TrainingGroundsOptionsView:destroy()
