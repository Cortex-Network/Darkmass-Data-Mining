...
function VideoView:init(settings, context)
...
function VideoView:_unload_packages()
...
function VideoView:_package_load_callback(package_name)
	self._packages_loaded[package_name] = true
end

function VideoView:_load_template(template)
...
function VideoView:_set_background_visibility(visible)
	self._widgets_by_name.background.content.visible = visible
end

function VideoView:on_exit()
	local template_name = self._context.template
	local template = VideoViewSettings.templates[template_name]
...
function VideoView:_update_input()
	if IS_XBS then
...
function VideoView:update(dt, t, input_service)
...
function VideoView:can_exit()
	return self._can_exit
end

function VideoView:_destroy_current_video()
...
function VideoView:_setup_video(video_name, loop_video)
...
function VideoView:_update_subtitles(dt, t)
...
function VideoView:dialogue_system_subtitle()
...
function VideoView:_setup_background_world()
...
function VideoView:dialogue_system()
...
function VideoView:_remove_subtitles()
	local subtitles = self._subtitles
