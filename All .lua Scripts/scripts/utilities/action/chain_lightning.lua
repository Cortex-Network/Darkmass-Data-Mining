...
function ChainLightning.calculate_max_targets(max_targets_settings, depth, use_random)
...
function ChainLightning:jump(t, source_target, hit_units, broadphase, enemy_side_names, initial_travel_direction, radius, max_angle, max_z_diff, on_add_func, jump_validation_func)
...
function ChainLightning.is_valid_target(physics_world, source_unit, target_unit, query_position, travel_direction, max_angle, max_z_diff, jump_validation_func)
