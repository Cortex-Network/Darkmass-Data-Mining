...
function SweepStickyness.is_sticking_to_unit(action_sweep_component)
...
function SweepStickyness.stick_to_position(action_sweep_component)
	local stick_to_unit = action_sweep_component.sweep_aborted_unit
...
function SweepStickyness.num_damage_instances_this_frame(hit_stickyness_settings, start_t, t)
...
function SweepStickyness.unit_which_aborted_sweep(action_sweep_component)
