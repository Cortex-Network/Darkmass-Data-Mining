...
function AimAssist.increase_ramp_multiplier(t, aim_assist_ramp_component, ramp_settings)
...
function AimAssist.reset_ramp_multiplier(aim_assist_ramp_component)
	aim_assist_ramp_component.multiplier = 0
	aim_assist_ramp_component.decay_end_time = 0
end

function AimAssist.update_ramp_multiplier(dt, t, aim_assist_ramp_component)
...
function AimAssist.apply_aim_assist(main_t, main_dt, input, targeting_data, aim_assist_ramp_component, weapon_action_component, look_yaw, look_pitch, position)
