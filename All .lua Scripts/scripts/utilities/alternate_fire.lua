...
function AlternateFire.movement_speed_modifier(alternate_fire_component, weapon_template, t, weapon_extension)
	if not alternate_fire_component.is_active then
		return 1
	end
...
function AlternateFire.modify_movement_curve(weapon_extension, base_value)
...
function AlternateFire.camera_variables(weapon_template)
	if not weapon_template then
		return nil, , 
	end
...
function AlternateFire.debug_set_alternate_fire(alternate_fire_component, active)
