...
function HitMass.target_hit_mass(attacker_unit, target_unit, use_reduced_hit_mass)
	local hit_mass = nil
...
function HitMass.consume_hit_mass(attacker_unit, target_unit, hit_mass_budget_attack, hit_mass_budget_impact, use_reduced_hit_mass)
