...
function ImpactEffect.play(attacked_unit, hit_actor_or_nil, damage, damage_type, hit_zone_name, attack_result, hit_position, hit_normal, attack_direction, attacking_unit, impact_fx_data_or_nil, attack_was_stopped, attack_type, damage_efficiency, damage_profile)
...
function ImpactEffect.save_surface_effect(effects_data, unit_index, hit_index, fire_position, attacked_unit, hit_actor_or_nil, hit_position, hit_normal)
...
function ImpactEffect.play_surface_effect(physics_world, attacking_unit, hit_position, hit_normal, hit_direction, damage_type, hit_type, impact_fx_data)
...
function ImpactEffect.play_shotshell_surface_effect(physics_world, attacking_unit, unit_to_index_lookup, num_hits_per_unit, impact_data, damage_type, hit_type, impact_fx_data)
	local will_be_predicted = not not impact_fx_data.will_be_predicted
	local source_parameters = impact_fx_data.source_parameters or EMPTY_TABLE
	local fx_system = Managers.state.extension:system("fx_system")
...
function ImpactEffect.surface_impact_fx(physics_world, attacking_unit, hit_position, hit_normal, hit_direction, damage_type, hit_type)
...
function ImpactEffect.shotshell_surface_impact_fx(physics_world, fire_position, attacking_unit, hit_positions, hit_normals, damage_type, hit_type)
