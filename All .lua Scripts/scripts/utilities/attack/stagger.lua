...
function Stagger.apply_stagger(unit, damage_profile, damage_profile_lerp_values, target_settings, attacking_unit, power_level, charge_level, is_critical_strike, is_backstab, is_flanking, hit_weakspot, dropoff_scalar, attack_direction, attack_type, attack_result, herding_template_or_nil, hit_shield)
	...
	return applied_stagger
end

function Stagger.can_stagger(unit)
...
function Stagger.force_stagger(unit, stagger_type, attack_direction, duration, length_scale, immune_time)
	local t = Managers.time:time("gameplay")
