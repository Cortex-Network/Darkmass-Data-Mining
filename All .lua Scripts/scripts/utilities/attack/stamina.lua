...
function Stamina.drain(unit, amount, t)
...
function Stamina.add_stamina(unit, amount)
	local unit_data_ext = ScriptUnit.extension(unit, "unit_data_system")
	local stamina_write_component = unit_data_ext:write_component("stamina")
	local specialization = unit_data_ext:specialization()
	local specialization_stamina_template = specialization.stamina
...
function Stamina.add_stamina_percent(unit, percent_amount)
	local unit_data_ext = ScriptUnit.extension(unit, "unit_data_system")
	local stamina_write_component = unit_data_ext:write_component("stamina")
	local specialization = unit_data_ext:specialization()
	local specialization_stamina_template = specialization.stamina
...
function Stamina.update(t, dt, stamina_write_component, specialization_stamina_template, unit, fixed_frame)
...
function Stamina.current_and_max_value(unit, stamina_read_component, specialization_stamina_template)
	local buff_extension = ScriptUnit.has_extension(unit, "buff_system")
