...
function BreedResourceDependencies.generate(breeds, item_definitions)
...
function BreedResourceDependencies._resolve_recursive(data, item_definitions, resource_packages)
