...
function Flamer.start_aiming_fx(t, unit, vfx, sfx, wwise_world, world, data)
...
function Flamer.start_shooting_fx(t, unit, vfx, sfx, wwise_world, world, data)
	local from_unit = data.from_unit
	local from_node = data.from_node
	local start_position = _get_start_position(from_unit, from_node)
...
function Flamer.update_shooting_fx(t, unit, vfx, sfx, wwise_world, world, physics_world, aim_position, control_point_1, control_point_2, data)
	local from_unit = data.from_unit
	local from_node = data.from_node
	local start_position = _get_start_position(from_unit, from_node)
...
function Flamer.stop_fx(unit, vfx, sfx, wwise_world, world, data)
	if sfx then
