...
function Luggable.drop_luggable(t, unit, inventory_component, visual_loadout_extension, enable_physics)
...
function Luggable.enable_physics(first_person_component, locomotion_component, existing_unit)
...
function Luggable.equip_to_player_unit(player_unit, luggable_unit, t)
...
function Luggable.link_to_player_unit(world, player_unit, luggable_unit, item)
...
function Luggable.unlink_from_player_unit(world, luggable_unit)
