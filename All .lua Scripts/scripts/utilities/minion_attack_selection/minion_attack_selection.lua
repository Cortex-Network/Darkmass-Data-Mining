...
function MinionAttackSelection.generate(attack_selection_template_name, initial_random_seed)
...
function MinionAttackSelection._select_and_remove_random_attack(random_seed, entries, num_entries, selected_attack_names, used_weapon_slot_names)
...
function MinionAttackSelection.match_template_by_tag(attack_selection_templates, tag)
