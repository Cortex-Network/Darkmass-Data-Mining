...
function MinionPerception.attempt_alert(perception_extension, enemy_unit)
...
function MinionPerception.attempt_aggro(perception_extension)
	local use_action_controlled_alert = perception_extension:use_action_controlled_alert()
...
function MinionPerception.aggro_state(enemy_unit)
...
function MinionPerception.set_target_lock(unit, perception_component, should_lock)
...
function MinionPerception.target_unit(game_session, game_object_id)
...
function MinionPerception.evaluate_multi_target_switch(unit, scratchpad, t, multi_target_config, is_target_locked)
...
function MinionPerception.switched_multi_target_unit(scratchpad, t, multi_target_config)
...
function MinionPerception.line_of_sight_positions(unit, target_unit, from_node, to_node, from_offsets_or_nil)
