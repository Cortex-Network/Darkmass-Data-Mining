...
function MinionTargetSelection.targeted_by_monster_weight(target_selection_weights, target_unit, attacker_unit)
...
function MinionTargetSelection.disabled_weight(target_selection_weights, target_unit, target_breed)
...
function MinionTargetSelection.stickiness_weight(target_selection_weights, is_new_target, perception_component, t)
...
function MinionTargetSelection.distance_weight(target_selection_weights, distance_sq, attacker_breed, optional_use_quadratic_falloff)
...
function MinionTargetSelection.coherency_weight(target_selection_weights, target_unit)
...
function MinionTargetSelection.threat_weight(target_selection_weights, target_unit, threat_units)
...
function MinionTargetSelection.occupied_slots_weight(target_selection_weights, target_unit, target_breed, is_new_target, optional_inverse_radius)
...
function MinionTargetSelection.attack_not_allowed_weight(target_selection_weights, target_unit, target_breed, attack_type)
...
function MinionTargetSelection.line_of_sight_weight(target_selection_weights, target_unit, line_of_sight_lookup)
...
function MinionTargetSelection.combat_vector_main_aggro_weight(target_selection_weights, target_unit)
...
function MinionTargetSelection.archetype_weight(target_selection_weights, target_unit, target_breed)
	if Breed.is_player(target_breed) then
...
function MinionTargetSelection.weight_multiplier(target_unit)
	local multiplier = 1
...
function MinionTargetSelection.knocked_down_weight(target_selection_weights, target_unit_data_extension, target_breed)
...
function MinionTargetSelection.ledge_hanging_weight(target_selection_weights, target_unit_data_extension, target_breed)
...
function MinionTargetSelection.detection_radius(breed)
