...
function MinionVisualLoadout.attachment_unit_and_node_from_node_name(item, fx_source_name, optional_lookup_fx_sources)
...
function MinionVisualLoadout.resolve(inventory_template, optional_zone_id, optional_used_weapon_slot_names, breed_name, inventory_seed)
