...
function NavQueries.position_on_mesh(nav_world, position, above, below, traverse_logic)
...
function NavQueries.position_on_mesh_with_outside_position(nav_world, traverse_logic, position, above, below, lateral, distance_from_nav_mesh)
	above = above or DEFAULT_NAV_ABOVE
	below = below or DEFAULT_NAV_BELOW
...
function NavQueries.ray_can_go(nav_world, position_start, position_end, traverse_logic, above, below)
...
function NavQueries.movement_check(nav_world, physics_world, position, velocity, traverse_logic)
...
function NavQueries.position_near_nav_position(nav_position, check_direction, nav_world, traverse_logic)
