...
function Orientation.look_delta(main_dt, input, sensitivity, mouse_scale, look_delta_context)
...
function Orientation.clamp_from_origin(current_rad, delta_rad, origin_rad, constraint_rad)
