...
function Pocketable.drop_pocketable(t, is_server, player_unit, inventory_component, visual_loadout_extension)
...
function Pocketable.equip_pocketable(t, is_server, player_unit, pickup_unit, inventory_item)
...
function _drop_pickup(item_name, spawn_pos, spawn_rot)
	...
	local spawned_unit, _ = pickup_system:spawn_pickup(swap_pickup_name, spawn_pos, spawn_rot, nil, , disable_time)
