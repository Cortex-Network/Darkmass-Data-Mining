...
function Recoil.set_shooting(recoil_control_component, shooting)
	if shooting ~= recoil_control_component.shooting then
		recoil_control_component.shooting = shooting
	end
end

function Recoil.first_person_offset(recoil_template, read_recoil_component, movement_state_component)
...
function Recoil.weapon_offset(recoil_template, read_recoil_component, movement_state_component)
	local movement_state_settings = Recoil.recoil_movement_state_settings(recoil_template, movement_state_component)
...
function Recoil.recoil_movement_state_settings(recoil_template, movement_state_component)
...
function Recoil.add_recoil(t, recoil_template, read_recoil_component, recoil_control_component, movement_state_component, fp_rotation, unit)
	if not recoil_template then
		return
	end
...
function Recoil.aim_assist_multiplier(recoil_template, recoil_control_component, recoil_component, movement_state_component)
	if not recoil_template then
		return
	end
...
function Recoil.apply_weapon_recoil_rotation(recoil_template, recoil_component, movement_state_component, current_rotation)
