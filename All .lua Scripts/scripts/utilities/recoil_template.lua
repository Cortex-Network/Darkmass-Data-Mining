...
function RecoilTemplate.generate_offset_range(num_shots, offset_pitch, offset_yaw, lerp_distance, scale_values)
	local offset_range = {}
...
function RecoilTemplate.create_scale(scale_values)
	local scale_list = {
		pitch = {},
		yaw = {}
	}
