...
function Spread.add_immediate_spread(t, spread_template, spread_control_component, movement_state_component, spread_type, optional_num_hits)
...
function Spread.add_immediate_spread_from_shooting(t, spread_template, spread_control_component, movement_state_component, shooting_status_component, spread_type)
	if not spread_template then
		return
	end
...
function Spread.target_style_spread(current_rotation, num_shots_fired, num_shots_in_attack, num_spread_circles, bullseye, spread_pitch, spread_yaw, scatter_range, no_random, roll_offset, seed)
