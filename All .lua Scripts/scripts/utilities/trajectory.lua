...
function Trajectory.angle_to_hit_moving_target(from_position, target_position, projectile_speed, target_velocity, gravity, acceptable_accuracy, use_greatest_angle)
	local angle = nil
	local EPSILON = 0.01
...
function Trajectory.get_trajectory_velocity(from_position, target_position, gravity, projectile_speed, angle)
...
function Trajectory.check_trajectory_collisions(physics_world, from_position, target_position, gravity, projectile_speed, angle, sections, collision_filter, time_in_flight, ignored_unit_collisions, debug_draw_trajectory)
...
function Trajectory.ballistic_raycast(physics_world, collision_filter, original_position, velocity, angle, z_gravity, optional_max_steps, optional_max_time)
