...
function ColorUtilities.color_lerp(source, target, p, out, ignore_alpha)
...
function ColorUtilities.color_copy(source, target, ignore_alpha)
	if not ignore_alpha then
		target[1] = source[1]
	end
...
function ColorUtilities.hsl2rgb(h, s, l)
	local r, g, b = nil
