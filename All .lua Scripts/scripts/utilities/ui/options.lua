...
function OptionsUtilities.create_percent_slider_template(params)
...
function OptionsUtilities.create_value_slider_template(params)
...
function OptionsUtilities.keybind_value_to_string(value)
	if not value then
		return
	end
