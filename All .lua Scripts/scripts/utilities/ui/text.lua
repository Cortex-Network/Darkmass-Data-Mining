...
function TextUtilities.localize_to_title_case(localization_key, optional_localization_context)
	local localized_text = Localize(localization_key, optional_localization_context ~= nil, optional_localization_context)
...
function TextUtilities.localize_with_button_hint(action, localization_key, optional_localization_context, optional_service_type, optional_pattern, include_input_type)
...
function TextUtilities.format_time_span_long_form_localized(num_seconds)
...
function TextUtilities.convert_to_roman_numerals(value)
...
function TextUtilities.formatted_character_name(character_name, level)
...
function TextUtilities.format_localized_talent_strings_with_values(localized_string, format_values)
...
function TextUtilities.format_currency(value)
