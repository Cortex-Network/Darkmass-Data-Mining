...
function WeaponStats:init(item)
	self._item = item
	self._ranged = {}
	self._melee = {}
	local weapon_template = WeaponTemplate.weapon_template_from_item(item)
	local weapon_tweak_templates, damage_profile_lerp_values, explosion_template_lerp_values, buffs = Weapon._init_traits(nil, weapon_template, item, nil, , {})
...
function WeaponStats:calculate_stats(weapon_template, weapon_tweak_templates, damage_profile_lerp_values)
...
function WeaponStats:construct_placeholder_item(weapon_template, use_max_traits)
...
function WeaponStats:is_ranged_weapon()
	return self._is_ranged_weapon
end

function WeaponStats:uses_overheat()
	return self._uses_overheat
end

function WeaponStats:_is_weapon_template_ranged(weapon_template)
...
function WeaponStats:get_all_ranged()
	local weapons = {}
...
function WeaponStats:get_all_melee()
	local weapons = {}
...
function WeaponStats:get_compare_stats_limits(weapon_template)
	...
	for name, compare_weapon_template in pairs(templates_to_compare) do
		...
		local weapon_tweak_templates, damage_profile_lerp_values, explosion_template_lerp_values, buffs = Weapon._init_traits(nil, compare_weapon_template, min_item, nil, , {})
		...
		weapon_tweak_templates, damage_profile_lerp_values, explosion_template_lerp_values, buffs = Weapon._init_traits(nil, compare_weapon_template, max_item, nil, , {})
...
function WeaponStats:get_attributes()
	return {}
end

function WeaponStats:get_compairing_stats()
...
function WeaponStats:calculate_traits(buffs)
...
function WeaponStats:get_main_stats()
	return {
		dps = self._dps,
